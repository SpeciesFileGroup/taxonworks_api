...
stream.next();return"error"}return{startState:function(){return{label:!1,commandMode:0}},token:function(stream,state){var style=tokenBase(stream,state);if(state.label)return"tag";return style}}});CodeMirror.defineMIME("text/x-mumps","mumps")});