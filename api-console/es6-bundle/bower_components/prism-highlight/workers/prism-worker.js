'use strict';/* global self, Prism, importScripts */self.document={currentScript:null,getElementsByTagName:function(){return[]}};let errored=/* eat */!1;try{importScripts("../../prism/prism.js","../../prism/plugins/autolinker/prism-autolinker.min.js","prism-modes.js")}catch(e){errored=!0;self.postMessage({payload:"error",message:"Unable to import Prism library."})}function getLanguagePath(lang){return Prism.plugins.mods.path+"prism-"+lang+".min.js"}/**
