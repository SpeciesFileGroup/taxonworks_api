import{r as Js}from"./swagger-ui-dist-DtjOS617.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();function xr(e){const n=Object.create(null);for(const t of e.split(","))n[t]=1;return t=>t in n}const D={},_n=[],Oe=()=>{},Hi=()=>!1,Pt=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Tr=e=>e.startsWith("onUpdate:"),ee=Object.assign,vr=(e,n)=>{const t=e.indexOf(n);t>-1&&e.splice(t,1)},Zs=Object.prototype.hasOwnProperty,M=(e,n)=>Zs.call(e,n),R=Array.isArray,xn=e=>tt(e)==="[object Map]",Wi=e=>tt(e)==="[object Set]",Qr=e=>tt(e)==="[object Date]",N=e=>typeof e=="function",Y=e=>typeof e=="string",Ne=e=>typeof e=="symbol",U=e=>e!==null&&typeof e=="object",Xi=e=>(U(e)||N(e))&&N(e.then)&&N(e.catch),Yi=Object.prototype.toString,tt=e=>Yi.call(e),Qs=e=>tt(e).slice(8,-1),zi=e=>tt(e)==="[object Object]",jr=e=>Y(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,$n=xr(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Rt=e=>{const n=Object.create(null);return(t=>n[t]||(n[t]=e(t)))},ea=/-\w/g,Ue=Rt(e=>e.replace(ea,n=>n.slice(1).toUpperCase())),na=/\B([A-Z])/g,nn=Rt(e=>e.replace(na,"-$1").toLowerCase()),Ji=Rt(e=>e.charAt(0).toUpperCase()+e.slice(1)),Bt=Rt(e=>e?`on${Ji(e)}`:""),he=(e,n)=>!Object.is(e,n),mt=(e,...n)=>{for(let t=0;t<e.length;t++)e[t](...n)},Zi=(e,n,t,r=!1)=>{Object.defineProperty(e,n,{configurable:!0,enumerable:!1,writable:r,value:t})},wr=e=>{const n=parseFloat(e);return isNaN(n)?e:n};let ei;const qt=()=>ei||(ei=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Ar(e){if(R(e)){const n={};for(let t=0;t<e.length;t++){const r=e[t],i=Y(r)?oa(r):Ar(r);if(i)for(const o in i)n[o]=i[o]}return n}else if(Y(e)||U(e))return e}const ta=/;(?![^(]*\))/g,ra=/:([^]+)/,ia=/\/\*[^]*?\*\//g;function oa(e){const n={};return e.replace(ia,"").split(ta).forEach(t=>{if(t){const r=t.split(ra);r.length>1&&(n[r[0].trim()]=r[1].trim())}}),n}function Kn(e){let n="";if(Y(e))n=e;else if(R(e))for(let t=0;t<e.length;t++){const r=Kn(e[t]);r&&(n+=r+" ")}else if(U(e))for(const t in e)e[t]&&(n+=t+" ");return n.trim()}const sa="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",aa=xr(sa);function Qi(e){return!!e||e===""}function pa(e,n){if(e.length!==n.length)return!1;let t=!0;for(let r=0;t&&r<e.length;r++)t=Sr(e[r],n[r]);return t}function Sr(e,n){if(e===n)return!0;let t=Qr(e),r=Qr(n);if(t||r)return t&&r?e.getTime()===n.getTime():!1;if(t=Ne(e),r=Ne(n),t||r)return e===n;if(t=R(e),r=R(n),t||r)return t&&r?pa(e,n):!1;if(t=U(e),r=U(n),t||r){if(!t||!r)return!1;const i=Object.keys(e).length,o=Object.keys(n).length;if(i!==o)return!1;for(const s in e){const a=e.hasOwnProperty(s),p=n.hasOwnProperty(s);if(a&&!p||!a&&p||!Sr(e[s],n[s]))return!1}}return String(e)===String(n)}const eo=e=>!!(e&&e.__v_isRef===!0),Hn=e=>Y(e)?e:e==null?"":R(e)||U(e)&&(e.toString===Yi||!N(e.toString))?eo(e)?Hn(e.value):JSON.stringify(e,no,2):String(e),no=(e,n)=>eo(n)?no(e,n.value):xn(n)?{[`Map(${n.size})`]:[...n.entries()].reduce((t,[r,i],o)=>(t[Vt(r,o)+" =>"]=i,t),{})}:Wi(n)?{[`Set(${n.size})`]:[...n.values()].map(t=>Vt(t))}:Ne(n)?Vt(n):U(n)&&!R(n)&&!zi(n)?String(n):n,Vt=(e,n="")=>{var t;return Ne(e)?`Symbol(${(t=e.description)!=null?t:n})`:e};let ye;class ca{constructor(n=!1){this.detached=n,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=ye,!n&&ye&&(this.index=(ye.scopes||(ye.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].pause();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].resume();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].resume()}}run(n){if(this._active){const t=ye;try{return ye=this,n()}finally{ye=t}}}on(){++this._on===1&&(this.prevScope=ye,ye=this)}off(){this._on>0&&--this._on===0&&(ye=this.prevScope,this.prevScope=void 0)}stop(n){if(this._active){this._active=!1;let t,r;for(t=0,r=this.effects.length;t<r;t++)this.effects[t].stop();for(this.effects.length=0,t=0,r=this.cleanups.length;t<r;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,r=this.scopes.length;t<r;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!n){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function la(){return ye}let K;const Kt=new WeakSet;class to{constructor(n){this.fn=n,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ye&&ye.active&&ye.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Kt.has(this)&&(Kt.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||io(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,ni(this),oo(this);const n=K,t=je;K=this,je=!0;try{return this.fn()}finally{so(this),K=n,je=t,this.flags&=-3}}stop(){if(this.flags&1){for(let n=this.deps;n;n=n.nextDep)Er(n);this.deps=this.depsTail=void 0,ni(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Kt.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){ir(this)&&this.run()}get dirty(){return ir(this)}}let ro=0,Dn,Gn;function io(e,n=!1){if(e.flags|=8,n){e.next=Gn,Gn=e;return}e.next=Dn,Dn=e}function Ir(){ro++}function Cr(){if(--ro>0)return;if(Gn){let n=Gn;for(Gn=void 0;n;){const t=n.next;n.next=void 0,n.flags&=-9,n=t}}let e;for(;Dn;){let n=Dn;for(Dn=void 0;n;){const t=n.next;if(n.next=void 0,n.flags&=-9,n.flags&1)try{n.trigger()}catch(r){e||(e=r)}n=t}}if(e)throw e}function oo(e){for(let n=e.deps;n;n=n.nextDep)n.version=-1,n.prevActiveLink=n.dep.activeLink,n.dep.activeLink=n}function so(e){let n,t=e.depsTail,r=t;for(;r;){const i=r.prevDep;r.version===-1?(r===t&&(t=i),Er(r),da(r)):n=r,r.dep.activeLink=r.prevActiveLink,r.prevActiveLink=void 0,r=i}e.deps=n,e.depsTail=t}function ir(e){for(let n=e.deps;n;n=n.nextDep)if(n.dep.version!==n.version||n.dep.computed&&(ao(n.dep.computed)||n.dep.version!==n.version))return!0;return!!e._dirty}function ao(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Wn)||(e.globalVersion=Wn,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!ir(e))))return;e.flags|=2;const n=e.dep,t=K,r=je;K=e,je=!0;try{oo(e);const i=e.fn(e._value);(n.version===0||he(i,e._value))&&(e.flags|=128,e._value=i,n.version++)}catch(i){throw n.version++,i}finally{K=t,je=r,so(e),e.flags&=-3}}function Er(e,n=!1){const{dep:t,prevSub:r,nextSub:i}=e;if(r&&(r.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=r,e.nextSub=void 0),t.subs===e&&(t.subs=r,!r&&t.computed)){t.computed.flags&=-5;for(let o=t.computed.deps;o;o=o.nextDep)Er(o,!0)}!n&&!--t.sc&&t.map&&t.map.delete(t.key)}function da(e){const{prevDep:n,nextDep:t}=e;n&&(n.nextDep=t,e.prevDep=void 0),t&&(t.prevDep=n,e.nextDep=void 0)}let je=!0;const po=[];function Be(){po.push(je),je=!1}function Ve(){const e=po.pop();je=e===void 0?!0:e}function ni(e){const{cleanup:n}=e;if(e.cleanup=void 0,n){const t=K;K=void 0;try{n()}finally{K=t}}}let Wn=0;class ua{constructor(n,t){this.sub=n,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Ot{constructor(n){this.computed=n,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(n){if(!K||!je||K===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==K)t=this.activeLink=new ua(K,this),K.deps?(t.prevDep=K.depsTail,K.depsTail.nextDep=t,K.depsTail=t):K.deps=K.depsTail=t,co(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const r=t.nextDep;r.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=r),t.prevDep=K.depsTail,t.nextDep=void 0,K.depsTail.nextDep=t,K.depsTail=t,K.deps===t&&(K.deps=r)}return t}trigger(n){this.version++,Wn++,this.notify(n)}notify(n){Ir();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{Cr()}}}function co(e){if(e.dep.sc++,e.sub.flags&4){const n=e.dep.computed;if(n&&!e.dep.subs){n.flags|=20;for(let r=n.deps;r;r=r.nextDep)co(r)}const t=e.dep.subs;t!==e&&(e.prevSub=t,t&&(t.nextSub=e)),e.dep.subs=e}}const or=new WeakMap,cn=Symbol(""),sr=Symbol(""),Xn=Symbol("");function ne(e,n,t){if(je&&K){let r=or.get(e);r||or.set(e,r=new Map);let i=r.get(t);i||(r.set(t,i=new Ot),i.map=r,i.key=t),i.track()}}function Me(e,n,t,r,i,o){const s=or.get(e);if(!s){Wn++;return}const a=p=>{p&&p.trigger()};if(Ir(),n==="clear")s.forEach(a);else{const p=R(e),d=p&&jr(t);if(p&&t==="length"){const l=Number(r);s.forEach((u,h)=>{(h==="length"||h===Xn||!Ne(h)&&h>=l)&&a(u)})}else switch((t!==void 0||s.has(void 0))&&a(s.get(t)),d&&a(s.get(Xn)),n){case"add":p?d&&a(s.get("length")):(a(s.get(cn)),xn(e)&&a(s.get(sr)));break;case"delete":p||(a(s.get(cn)),xn(e)&&a(s.get(sr)));break;case"set":xn(e)&&a(s.get(cn));break}}Cr()}function un(e){const n=G(e);return n===e?n:(ne(n,"iterate",Xn),ve(e)?n:n.map(we))}function kt(e){return ne(e=G(e),"iterate",Xn),e}function ze(e,n){return Ke(e)?jn(ln(e)?we(n):n):we(n)}const ma={__proto__:null,[Symbol.iterator](){return Ht(this,Symbol.iterator,e=>ze(this,e))},concat(...e){return un(this).concat(...e.map(n=>R(n)?un(n):n))},entries(){return Ht(this,"entries",e=>(e[1]=ze(this,e[1]),e))},every(e,n){return $e(this,"every",e,n,void 0,arguments)},filter(e,n){return $e(this,"filter",e,n,t=>t.map(r=>ze(this,r)),arguments)},find(e,n){return $e(this,"find",e,n,t=>ze(this,t),arguments)},findIndex(e,n){return $e(this,"findIndex",e,n,void 0,arguments)},findLast(e,n){return $e(this,"findLast",e,n,t=>ze(this,t),arguments)},findLastIndex(e,n){return $e(this,"findLastIndex",e,n,void 0,arguments)},forEach(e,n){return $e(this,"forEach",e,n,void 0,arguments)},includes(...e){return Wt(this,"includes",e)},indexOf(...e){return Wt(this,"indexOf",e)},join(e){return un(this).join(e)},lastIndexOf(...e){return Wt(this,"lastIndexOf",e)},map(e,n){return $e(this,"map",e,n,void 0,arguments)},pop(){return qn(this,"pop")},push(...e){return qn(this,"push",e)},reduce(e,...n){return ti(this,"reduce",e,n)},reduceRight(e,...n){return ti(this,"reduceRight",e,n)},shift(){return qn(this,"shift")},some(e,n){return $e(this,"some",e,n,void 0,arguments)},splice(...e){return qn(this,"splice",e)},toReversed(){return un(this).toReversed()},toSorted(e){return un(this).toSorted(e)},toSpliced(...e){return un(this).toSpliced(...e)},unshift(...e){return qn(this,"unshift",e)},values(){return Ht(this,"values",e=>ze(this,e))}};function Ht(e,n,t){const r=kt(e),i=r[n]();return r!==e&&!ve(e)&&(i._next=i.next,i.next=()=>{const o=i._next();return o.done||(o.value=t(o.value)),o}),i}const ya=Array.prototype;function $e(e,n,t,r,i,o){const s=kt(e),a=s!==e&&!ve(e),p=s[n];if(p!==ya[n]){const u=p.apply(e,o);return a?we(u):u}let d=t;s!==e&&(a?d=function(u,h){return t.call(this,ze(e,u),h,e)}:t.length>2&&(d=function(u,h){return t.call(this,u,h,e)}));const l=p.call(s,d,r);return a&&i?i(l):l}function ti(e,n,t,r){const i=kt(e);let o=t;return i!==e&&(ve(e)?t.length>3&&(o=function(s,a,p){return t.call(this,s,a,p,e)}):o=function(s,a,p){return t.call(this,s,ze(e,a),p,e)}),i[n](o,...r)}function Wt(e,n,t){const r=G(e);ne(r,"iterate",Xn);const i=r[n](...t);return(i===-1||i===!1)&&Or(t[0])?(t[0]=G(t[0]),r[n](...t)):i}function qn(e,n,t=[]){Be(),Ir();const r=G(e)[n].apply(e,t);return Cr(),Ve(),r}const ha=xr("__proto__,__v_isRef,__isVue"),lo=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Ne));function fa(e){Ne(e)||(e=String(e));const n=G(this);return ne(n,"has",e),n.hasOwnProperty(e)}class uo{constructor(n=!1,t=!1){this._isReadonly=n,this._isShallow=t}get(n,t,r){if(t==="__v_skip")return n.__v_skip;const i=this._isReadonly,o=this._isShallow;if(t==="__v_isReactive")return!i;if(t==="__v_isReadonly")return i;if(t==="__v_isShallow")return o;if(t==="__v_raw")return r===(i?o?Sa:fo:o?ho:yo).get(n)||Object.getPrototypeOf(n)===Object.getPrototypeOf(r)?n:void 0;const s=R(n);if(!i){let p;if(s&&(p=ma[t]))return p;if(t==="hasOwnProperty")return fa}const a=Reflect.get(n,t,re(n)?n:r);if((Ne(t)?lo.has(t):ha(t))||(i||ne(n,"get",t),o))return a;if(re(a)){const p=s&&jr(t)?a:a.value;return i&&U(p)?pr(p):p}return U(a)?i?pr(a):Rr(a):a}}class mo extends uo{constructor(n=!1){super(!1,n)}set(n,t,r,i){let o=n[t];const s=R(n)&&jr(t);if(!this._isShallow){const d=Ke(o);if(!ve(r)&&!Ke(r)&&(o=G(o),r=G(r)),!s&&re(o)&&!re(r))return d||(o.value=r),!0}const a=s?Number(t)<n.length:M(n,t),p=Reflect.set(n,t,r,re(n)?n:i);return n===G(i)&&(a?he(r,o)&&Me(n,"set",t,r):Me(n,"add",t,r)),p}deleteProperty(n,t){const r=M(n,t);n[t];const i=Reflect.deleteProperty(n,t);return i&&r&&Me(n,"delete",t,void 0),i}has(n,t){const r=Reflect.has(n,t);return(!Ne(t)||!lo.has(t))&&ne(n,"has",t),r}ownKeys(n){return ne(n,"iterate",R(n)?"length":cn),Reflect.ownKeys(n)}}class ga extends uo{constructor(n=!1){super(!0,n)}set(n,t){return!0}deleteProperty(n,t){return!0}}const ba=new mo,_a=new ga,xa=new mo(!0);const ar=e=>e,lt=e=>Reflect.getPrototypeOf(e);function Ta(e,n,t){return function(...r){const i=this.__v_raw,o=G(i),s=xn(o),a=e==="entries"||e===Symbol.iterator&&s,p=e==="keys"&&s,d=i[e](...r),l=t?ar:n?jn:we;return!n&&ne(o,"iterate",p?sr:cn),ee(Object.create(d),{next(){const{value:u,done:h}=d.next();return h?{value:u,done:h}:{value:a?[l(u[0]),l(u[1])]:l(u),done:h}}})}}function dt(e){return function(...n){return e==="delete"?!1:e==="clear"?void 0:this}}function va(e,n){const t={get(i){const o=this.__v_raw,s=G(o),a=G(i);e||(he(i,a)&&ne(s,"get",i),ne(s,"get",a));const{has:p}=lt(s),d=n?ar:e?jn:we;if(p.call(s,i))return d(o.get(i));if(p.call(s,a))return d(o.get(a));o!==s&&o.get(i)},get size(){const i=this.__v_raw;return!e&&ne(G(i),"iterate",cn),i.size},has(i){const o=this.__v_raw,s=G(o),a=G(i);return e||(he(i,a)&&ne(s,"has",i),ne(s,"has",a)),i===a?o.has(i):o.has(i)||o.has(a)},forEach(i,o){const s=this,a=s.__v_raw,p=G(a),d=n?ar:e?jn:we;return!e&&ne(p,"iterate",cn),a.forEach((l,u)=>i.call(o,d(l),d(u),s))}};return ee(t,e?{add:dt("add"),set:dt("set"),delete:dt("delete"),clear:dt("clear")}:{add(i){!n&&!ve(i)&&!Ke(i)&&(i=G(i));const o=G(this);return lt(o).has.call(o,i)||(o.add(i),Me(o,"add",i,i)),this},set(i,o){!n&&!ve(o)&&!Ke(o)&&(o=G(o));const s=G(this),{has:a,get:p}=lt(s);let d=a.call(s,i);d||(i=G(i),d=a.call(s,i));const l=p.call(s,i);return s.set(i,o),d?he(o,l)&&Me(s,"set",i,o):Me(s,"add",i,o),this},delete(i){const o=G(this),{has:s,get:a}=lt(o);let p=s.call(o,i);p||(i=G(i),p=s.call(o,i)),a&&a.call(o,i);const d=o.delete(i);return p&&Me(o,"delete",i,void 0),d},clear(){const i=G(this),o=i.size!==0,s=i.clear();return o&&Me(i,"clear",void 0,void 0),s}}),["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=Ta(i,e,n)}),t}function Pr(e,n){const t=va(e,n);return(r,i,o)=>i==="__v_isReactive"?!e:i==="__v_isReadonly"?e:i==="__v_raw"?r:Reflect.get(M(t,i)&&i in r?t:r,i,o)}const ja={get:Pr(!1,!1)},wa={get:Pr(!1,!0)},Aa={get:Pr(!0,!1)};const yo=new WeakMap,ho=new WeakMap,fo=new WeakMap,Sa=new WeakMap;function Ia(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Ca(e){return e.__v_skip||!Object.isExtensible(e)?0:Ia(Qs(e))}function Rr(e){return Ke(e)?e:qr(e,!1,ba,ja,yo)}function Ea(e){return qr(e,!1,xa,wa,ho)}function pr(e){return qr(e,!0,_a,Aa,fo)}function qr(e,n,t,r,i){if(!U(e)||e.__v_raw&&!(n&&e.__v_isReactive))return e;const o=Ca(e);if(o===0)return e;const s=i.get(e);if(s)return s;const a=new Proxy(e,o===2?r:t);return i.set(e,a),a}function ln(e){return Ke(e)?ln(e.__v_raw):!!(e&&e.__v_isReactive)}function Ke(e){return!!(e&&e.__v_isReadonly)}function ve(e){return!!(e&&e.__v_isShallow)}function Or(e){return e?!!e.__v_raw:!1}function G(e){const n=e&&e.__v_raw;return n?G(n):e}function Pa(e){return!M(e,"__v_skip")&&Object.isExtensible(e)&&Zi(e,"__v_skip",!0),e}const we=e=>U(e)?Rr(e):e,jn=e=>U(e)?pr(e):e;function re(e){return e?e.__v_isRef===!0:!1}function wn(e){return Ra(e,!1)}function Ra(e,n){return re(e)?e:new qa(e,n)}class qa{constructor(n,t){this.dep=new Ot,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?n:G(n),this._value=t?n:we(n),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(n){const t=this._rawValue,r=this.__v_isShallow||ve(n)||Ke(n);n=r?n:G(n),he(n,t)&&(this._rawValue=n,this._value=r?n:we(n),this.dep.trigger())}}function kn(e){return re(e)?e.value:e}const Oa={get:(e,n,t)=>n==="__v_raw"?e:kn(Reflect.get(e,n,t)),set:(e,n,t,r)=>{const i=e[n];return re(i)&&!re(t)?(i.value=t,!0):Reflect.set(e,n,t,r)}};function go(e){return ln(e)?e:new Proxy(e,Oa)}class ka{constructor(n){this.__v_isRef=!0,this._value=void 0;const t=this.dep=new Ot,{get:r,set:i}=n(t.track.bind(t),t.trigger.bind(t));this._get=r,this._set=i}get value(){return this._value=this._get()}set value(n){this._set(n)}}function Na(e){return new ka(e)}class Fa{constructor(n,t,r){this.fn=n,this.setter=t,this._value=void 0,this.dep=new Ot(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Wn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=r}notify(){if(this.flags|=16,!(this.flags&8)&&K!==this)return io(this,!0),!0}get value(){const n=this.dep.track();return ao(this),n&&(n.version=this.dep.version),this._value}set value(n){this.setter&&this.setter(n)}}function $a(e,n,t=!1){let r,i;return N(e)?r=e:(r=e.get,i=e.set),new Fa(r,i,t)}const ut={},bt=new WeakMap;let pn;function Da(e,n=!1,t=pn){if(t){let r=bt.get(t);r||bt.set(t,r=[]),r.push(e)}}function Ga(e,n,t=D){const{immediate:r,deep:i,once:o,scheduler:s,augmentJob:a,call:p}=t,d=q=>i?q:ve(q)||i===!1||i===0?Le(q,1):Le(q);let l,u,h,f,S=!1,v=!1;if(re(e)?(u=()=>e.value,S=ve(e)):ln(e)?(u=()=>d(e),S=!0):R(e)?(v=!0,S=e.some(q=>ln(q)||ve(q)),u=()=>e.map(q=>{if(re(q))return q.value;if(ln(q))return d(q);if(N(q))return p?p(q,2):q()})):N(e)?n?u=p?()=>p(e,2):e:u=()=>{if(h){Be();try{h()}finally{Ve()}}const q=pn;pn=l;try{return p?p(e,3,[f]):e(f)}finally{pn=q}}:u=Oe,n&&i){const q=u,z=i===!0?1/0:i;u=()=>Le(q(),z)}const k=la(),F=()=>{l.stop(),k&&k.active&&vr(k.effects,l)};if(o&&n){const q=n;n=(...z)=>{q(...z),F()}}let I=v?new Array(e.length).fill(ut):ut;const H=q=>{if(!(!(l.flags&1)||!l.dirty&&!q))if(n){const z=l.run();if(i||S||(v?z.some((Xe,Ae)=>he(Xe,I[Ae])):he(z,I))){h&&h();const Xe=pn;pn=l;try{const Ae=[z,I===ut?void 0:v&&I[0]===ut?[]:I,f];I=z,p?p(n,3,Ae):n(...Ae)}finally{pn=Xe}}}else l.run()};return a&&a(H),l=new to(u),l.scheduler=s?()=>s(H,!1):H,f=q=>Da(q,!1,l),h=l.onStop=()=>{const q=bt.get(l);if(q){if(p)p(q,4);else for(const z of q)z();bt.delete(l)}},n?r?H(!0):I=l.run():s?s(H.bind(null,!0),!0):l.run(),F.pause=l.pause.bind(l),F.resume=l.resume.bind(l),F.stop=F,F}function Le(e,n=1/0,t){if(n<=0||!U(e)||e.__v_skip||(t=t||new Map,(t.get(e)||0)>=n))return e;if(t.set(e,n),n--,re(e))Le(e.value,n,t);else if(R(e))for(let r=0;r<e.length;r++)Le(e[r],n,t);else if(Wi(e)||xn(e))e.forEach(r=>{Le(r,n,t)});else if(zi(e)){for(const r in e)Le(e[r],n,t);for(const r of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,r)&&Le(e[r],n,t)}return e}function rt(e,n,t,r){try{return r?e(...r):e()}catch(i){Nt(i,n,t)}}function Fe(e,n,t,r){if(N(e)){const i=rt(e,n,t,r);return i&&Xi(i)&&i.catch(o=>{Nt(o,n,t)}),i}if(R(e)){const i=[];for(let o=0;o<e.length;o++)i.push(Fe(e[o],n,t,r));return i}}function Nt(e,n,t,r=!0){const i=n?n.vnode:null,{errorHandler:o,throwUnhandledErrorInProduction:s}=n&&n.appContext.config||D;if(n){let a=n.parent;const p=n.proxy,d=`https://vuejs.org/error-reference/#runtime-${t}`;for(;a;){const l=a.ec;if(l){for(let u=0;u<l.length;u++)if(l[u](e,p,d)===!1)return}a=a.parent}if(o){Be(),rt(o,null,10,[e,p,d]),Ve();return}}Ma(e,t,i,r,s)}function Ma(e,n,t,r=!0,i=!1){if(i)throw e;console.error(e)}const ae=[];let Re=-1;const Tn=[];let Je=null,yn=0;const bo=Promise.resolve();let _t=null;function La(e){const n=_t||bo;return e?n.then(this?e.bind(this):e):n}function Ua(e){let n=Re+1,t=ae.length;for(;n<t;){const r=n+t>>>1,i=ae[r],o=Yn(i);o<e||o===e&&i.flags&2?n=r+1:t=r}return n}function kr(e){if(!(e.flags&1)){const n=Yn(e),t=ae[ae.length-1];!t||!(e.flags&2)&&n>=Yn(t)?ae.push(e):ae.splice(Ua(n),0,e),e.flags|=1,_o()}}function _o(){_t||(_t=bo.then(To))}function Ba(e){R(e)?Tn.push(...e):Je&&e.id===-1?Je.splice(yn+1,0,e):e.flags&1||(Tn.push(e),e.flags|=1),_o()}function ri(e,n,t=Re+1){for(;t<ae.length;t++){const r=ae[t];if(r&&r.flags&2){if(e&&r.id!==e.uid)continue;ae.splice(t,1),t--,r.flags&4&&(r.flags&=-2),r(),r.flags&4||(r.flags&=-2)}}}function xo(e){if(Tn.length){const n=[...new Set(Tn)].sort((t,r)=>Yn(t)-Yn(r));if(Tn.length=0,Je){Je.push(...n);return}for(Je=n,yn=0;yn<Je.length;yn++){const t=Je[yn];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}Je=null,yn=0}}const Yn=e=>e.id==null?e.flags&2?-1:1/0:e.id;function To(e){try{for(Re=0;Re<ae.length;Re++){const n=ae[Re];n&&!(n.flags&8)&&(n.flags&4&&(n.flags&=-2),rt(n,n.i,n.i?15:14),n.flags&4||(n.flags&=-2))}}finally{for(;Re<ae.length;Re++){const n=ae[Re];n&&(n.flags&=-2)}Re=-1,ae.length=0,xo(),_t=null,(ae.length||Tn.length)&&To()}}let Te=null,vo=null;function xt(e){const n=Te;return Te=e,vo=e&&e.type.__scopeId||null,n}function Va(e,n=Te,t){if(!n||e._n)return e;const r=(...i)=>{r._d&&mi(-1);const o=xt(n);let s;try{s=e(...i)}finally{xt(o),r._d&&mi(1)}return s};return r._n=!0,r._c=!0,r._d=!0,r}function Ka(e,n){if(Te===null)return e;const t=Gt(Te),r=e.dirs||(e.dirs=[]);for(let i=0;i<n.length;i++){let[o,s,a,p=D]=n[i];o&&(N(o)&&(o={mounted:o,updated:o}),o.deep&&Le(s),r.push({dir:o,instance:t,value:s,oldValue:void 0,arg:a,modifiers:p}))}return e}function sn(e,n,t,r){const i=e.dirs,o=n&&n.dirs;for(let s=0;s<i.length;s++){const a=i[s];o&&(a.oldValue=o[s].value);let p=a.dir[r];p&&(Be(),Fe(p,t,8,[e.el,a,e,n]),Ve())}}function Ha(e,n){if(pe){let t=pe.provides;const r=pe.parent&&pe.parent.provides;r===t&&(t=pe.provides=Object.create(r)),t[e]=n}}function yt(e,n,t=!1){const r=ns();if(r||vn){let i=vn?vn._context.provides:r?r.parent==null||r.ce?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return t&&N(n)?n.call(r&&r.proxy):n}}const Wa=Symbol.for("v-scx"),Xa=()=>yt(Wa);function Ya(e,n){return Nr(e,null,{flush:"sync"})}function Mn(e,n,t){return Nr(e,n,t)}function Nr(e,n,t=D){const{immediate:r,deep:i,flush:o,once:s}=t,a=ee({},t),p=n&&r||!n&&o!=="post";let d;if(Jn){if(o==="sync"){const f=Xa();d=f.__watcherHandles||(f.__watcherHandles=[])}else if(!p){const f=()=>{};return f.stop=Oe,f.resume=Oe,f.pause=Oe,f}}const l=pe;a.call=(f,S,v)=>Fe(f,l,S,v);let u=!1;o==="post"?a.scheduler=f=>{me(f,l&&l.suspense)}:o!=="sync"&&(u=!0,a.scheduler=(f,S)=>{S?f():kr(f)}),a.augmentJob=f=>{n&&(f.flags|=4),u&&(f.flags|=2,l&&(f.id=l.uid,f.i=l))};const h=Ga(e,n,a);return Jn&&(d?d.push(h):p&&h()),h}function za(e,n,t){const r=this.proxy,i=Y(e)?e.includes(".")?jo(r,e):()=>r[e]:e.bind(r,r);let o;N(n)?o=n:(o=n.handler,t=n);const s=it(this),a=Nr(i,o.bind(r),t);return s(),a}function jo(e,n){const t=n.split(".");return()=>{let r=e;for(let i=0;i<t.length&&r;i++)r=r[t[i]];return r}}const Ja=Symbol("_vte"),Za=e=>e.__isTeleport,Qa=Symbol("_leaveCb");function Fr(e,n){e.shapeFlag&6&&e.component?(e.transition=n,Fr(e.component.subTree,n)):e.shapeFlag&128?(e.ssContent.transition=n.clone(e.ssContent),e.ssFallback.transition=n.clone(e.ssFallback)):e.transition=n}function wo(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function ii(e,n){let t;return!!((t=Object.getOwnPropertyDescriptor(e,n))&&!t.configurable)}const Tt=new WeakMap;function Ln(e,n,t,r,i=!1){if(R(e)){e.forEach((v,k)=>Ln(v,n&&(R(n)?n[k]:n),t,r,i));return}if(Un(r)&&!i){r.shapeFlag&512&&r.type.__asyncResolved&&r.component.subTree.component&&Ln(e,n,t,r.component.subTree);return}const o=r.shapeFlag&4?Gt(r.component):r.el,s=i?null:o,{i:a,r:p}=e,d=n&&n.r,l=a.refs===D?a.refs={}:a.refs,u=a.setupState,h=G(u),f=u===D?Hi:v=>ii(l,v)?!1:M(h,v),S=(v,k)=>!(k&&ii(l,k));if(d!=null&&d!==p){if(oi(n),Y(d))l[d]=null,f(d)&&(u[d]=null);else if(re(d)){const v=n;S(d,v.k)&&(d.value=null),v.k&&(l[v.k]=null)}}if(N(p))rt(p,a,12,[s,l]);else{const v=Y(p),k=re(p);if(v||k){const F=()=>{if(e.f){const I=v?f(p)?u[p]:l[p]:S()||!e.k?p.value:l[e.k];if(i)R(I)&&vr(I,o);else if(R(I))I.includes(o)||I.push(o);else if(v)l[p]=[o],f(p)&&(u[p]=l[p]);else{const H=[o];S(p,e.k)&&(p.value=H),e.k&&(l[e.k]=H)}}else v?(l[p]=s,f(p)&&(u[p]=s)):k&&(S(p,e.k)&&(p.value=s),e.k&&(l[e.k]=s))};if(s){const I=()=>{F(),Tt.delete(e)};I.id=-1,Tt.set(e,I),me(I,t)}else oi(e),F()}}}function oi(e){const n=Tt.get(e);n&&(n.flags|=8,Tt.delete(e))}qt().requestIdleCallback;qt().cancelIdleCallback;const Un=e=>!!e.type.__asyncLoader,Ao=e=>e.type.__isKeepAlive;function ep(e,n){So(e,"a",n)}function np(e,n){So(e,"da",n)}function So(e,n,t=pe){const r=e.__wdc||(e.__wdc=()=>{let i=t;for(;i;){if(i.isDeactivated)return;i=i.parent}return e()});if(Ft(n,r,t),t){let i=t.parent;for(;i&&i.parent;)Ao(i.parent.vnode)&&tp(r,n,t,i),i=i.parent}}function tp(e,n,t,r){const i=Ft(n,e,r,!0);Co(()=>{vr(r[n],i)},t)}function Ft(e,n,t=pe,r=!1){if(t){const i=t[e]||(t[e]=[]),o=n.__weh||(n.__weh=(...s)=>{Be();const a=it(t),p=Fe(n,t,e,s);return a(),Ve(),p});return r?i.unshift(o):i.push(o),o}}const We=e=>(n,t=pe)=>{(!Jn||e==="sp")&&Ft(e,(...r)=>n(...r),t)},rp=We("bm"),$r=We("m"),ip=We("bu"),op=We("u"),Io=We("bum"),Co=We("um"),sp=We("sp"),ap=We("rtg"),pp=We("rtc");function cp(e,n=pe){Ft("ec",e,n)}const lp=Symbol.for("v-ndc");function Eo(e,n,t,r){let i;const o=t,s=R(e);if(s||Y(e)){const a=s&&ln(e);let p=!1,d=!1;a&&(p=!ve(e),d=Ke(e),e=kt(e)),i=new Array(e.length);for(let l=0,u=e.length;l<u;l++)i[l]=n(p?d?jn(we(e[l])):we(e[l]):e[l],l,void 0,o)}else if(typeof e=="number"){i=new Array(e);for(let a=0;a<e;a++)i[a]=n(a+1,a,void 0,o)}else if(U(e))if(e[Symbol.iterator])i=Array.from(e,(a,p)=>n(a,p,void 0,o));else{const a=Object.keys(e);i=new Array(a.length);for(let p=0,d=a.length;p<d;p++){const l=a[p];i[p]=n(e[l],l,p,o)}}else i=[];return i}const cr=e=>e?ts(e)?Gt(e):cr(e.parent):null,Bn=ee(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>cr(e.parent),$root:e=>cr(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Ro(e),$forceUpdate:e=>e.f||(e.f=()=>{kr(e.update)}),$nextTick:e=>e.n||(e.n=La.bind(e.proxy)),$watch:e=>za.bind(e)}),Xt=(e,n)=>e!==D&&!e.__isScriptSetup&&M(e,n),dp={get({_:e},n){if(n==="__v_skip")return!0;const{ctx:t,setupState:r,data:i,props:o,accessCache:s,type:a,appContext:p}=e;if(n[0]!=="$"){const h=s[n];if(h!==void 0)switch(h){case 1:return r[n];case 2:return i[n];case 4:return t[n];case 3:return o[n]}else{if(Xt(r,n))return s[n]=1,r[n];if(i!==D&&M(i,n))return s[n]=2,i[n];if(M(o,n))return s[n]=3,o[n];if(t!==D&&M(t,n))return s[n]=4,t[n];lr&&(s[n]=0)}}const d=Bn[n];let l,u;if(d)return n==="$attrs"&&ne(e.attrs,"get",""),d(e);if((l=a.__cssModules)&&(l=l[n]))return l;if(t!==D&&M(t,n))return s[n]=4,t[n];if(u=p.config.globalProperties,M(u,n))return u[n]},set({_:e},n,t){const{data:r,setupState:i,ctx:o}=e;return Xt(i,n)?(i[n]=t,!0):r!==D&&M(r,n)?(r[n]=t,!0):M(e.props,n)||n[0]==="$"&&n.slice(1)in e?!1:(o[n]=t,!0)},has({_:{data:e,setupState:n,accessCache:t,ctx:r,appContext:i,props:o,type:s}},a){let p;return!!(t[a]||e!==D&&a[0]!=="$"&&M(e,a)||Xt(n,a)||M(o,a)||M(r,a)||M(Bn,a)||M(i.config.globalProperties,a)||(p=s.__cssModules)&&p[a])},defineProperty(e,n,t){return t.get!=null?e._.accessCache[n]=0:M(t,"value")&&this.set(e,n,t.value,null),Reflect.defineProperty(e,n,t)}};function vt(e){return R(e)?e.reduce((n,t)=>(n[t]=null,n),{}):e}function up(e,n){return!e||!n?e||n:R(e)&&R(n)?e.concat(n):ee({},vt(e),vt(n))}let lr=!0;function mp(e){const n=Ro(e),t=e.proxy,r=e.ctx;lr=!1,n.beforeCreate&&si(n.beforeCreate,e,"bc");const{data:i,computed:o,methods:s,watch:a,provide:p,inject:d,created:l,beforeMount:u,mounted:h,beforeUpdate:f,updated:S,activated:v,deactivated:k,beforeDestroy:F,beforeUnmount:I,destroyed:H,unmounted:q,render:z,renderTracked:Xe,renderTriggered:Ae,errorCaptured:Ye,serverPrefetch:ot,expose:tn,inheritAttrs:Cn,components:st,directives:at,filters:Lt}=n;if(d&&yp(d,r,null),s)for(const W in s){const B=s[W];N(B)&&(r[W]=B.bind(t))}if(i){const W=i.call(t,t);U(W)&&(e.data=Rr(W))}if(lr=!0,o)for(const W in o){const B=o[W],rn=N(B)?B.bind(t,t):N(B.get)?B.get.bind(t,t):Oe,pt=!N(B)&&N(B.set)?B.set.bind(t):Oe,on=is({get:rn,set:pt});Object.defineProperty(r,W,{enumerable:!0,configurable:!0,get:()=>on.value,set:Se=>on.value=Se})}if(a)for(const W in a)Po(a[W],r,t,W);if(p){const W=N(p)?p.call(t):p;Reflect.ownKeys(W).forEach(B=>{Ha(B,W[B])})}l&&si(l,e,"c");function oe(W,B){R(B)?B.forEach(rn=>W(rn.bind(t))):B&&W(B.bind(t))}if(oe(rp,u),oe($r,h),oe(ip,f),oe(op,S),oe(ep,v),oe(np,k),oe(cp,Ye),oe(pp,Xe),oe(ap,Ae),oe(Io,I),oe(Co,q),oe(sp,ot),R(tn))if(tn.length){const W=e.exposed||(e.exposed={});tn.forEach(B=>{Object.defineProperty(W,B,{get:()=>t[B],set:rn=>t[B]=rn,enumerable:!0})})}else e.exposed||(e.exposed={});z&&e.render===Oe&&(e.render=z),Cn!=null&&(e.inheritAttrs=Cn),st&&(e.components=st),at&&(e.directives=at),ot&&wo(e)}function yp(e,n,t=Oe){R(e)&&(e=dr(e));for(const r in e){const i=e[r];let o;U(i)?"default"in i?o=yt(i.from||r,i.default,!0):o=yt(i.from||r):o=yt(i),re(o)?Object.defineProperty(n,r,{enumerable:!0,configurable:!0,get:()=>o.value,set:s=>o.value=s}):n[r]=o}}function si(e,n,t){Fe(R(e)?e.map(r=>r.bind(n.proxy)):e.bind(n.proxy),n,t)}function Po(e,n,t,r){let i=r.includes(".")?jo(t,r):()=>t[r];if(Y(e)){const o=n[e];N(o)&&Mn(i,o)}else if(N(e))Mn(i,e.bind(t));else if(U(e))if(R(e))e.forEach(o=>Po(o,n,t,r));else{const o=N(e.handler)?e.handler.bind(t):n[e.handler];N(o)&&Mn(i,o,e)}}function Ro(e){const n=e.type,{mixins:t,extends:r}=n,{mixins:i,optionsCache:o,config:{optionMergeStrategies:s}}=e.appContext,a=o.get(n);let p;return a?p=a:!i.length&&!t&&!r?p=n:(p={},i.length&&i.forEach(d=>jt(p,d,s,!0)),jt(p,n,s)),U(n)&&o.set(n,p),p}function jt(e,n,t,r=!1){const{mixins:i,extends:o}=n;o&&jt(e,o,t,!0),i&&i.forEach(s=>jt(e,s,t,!0));for(const s in n)if(!(r&&s==="expose")){const a=hp[s]||t&&t[s];e[s]=a?a(e[s],n[s]):n[s]}return e}const hp={data:ai,props:pi,emits:pi,methods:Nn,computed:Nn,beforeCreate:se,created:se,beforeMount:se,mounted:se,beforeUpdate:se,updated:se,beforeDestroy:se,beforeUnmount:se,destroyed:se,unmounted:se,activated:se,deactivated:se,errorCaptured:se,serverPrefetch:se,components:Nn,directives:Nn,watch:gp,provide:ai,inject:fp};function ai(e,n){return n?e?function(){return ee(N(e)?e.call(this,this):e,N(n)?n.call(this,this):n)}:n:e}function fp(e,n){return Nn(dr(e),dr(n))}function dr(e){if(R(e)){const n={};for(let t=0;t<e.length;t++)n[e[t]]=e[t];return n}return e}function se(e,n){return e?[...new Set([].concat(e,n))]:n}function Nn(e,n){return e?ee(Object.create(null),e,n):n}function pi(e,n){return e?R(e)&&R(n)?[...new Set([...e,...n])]:ee(Object.create(null),vt(e),vt(n??{})):n}function gp(e,n){if(!e)return n;if(!n)return e;const t=ee(Object.create(null),e);for(const r in n)t[r]=se(e[r],n[r]);return t}function qo(){return{app:null,config:{isNativeTag:Hi,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let bp=0;function _p(e,n){return function(r,i=null){N(r)||(r=ee({},r)),i!=null&&!U(i)&&(i=null);const o=qo(),s=new WeakSet,a=[];let p=!1;const d=o.app={_uid:bp++,_component:r,_props:i,_container:null,_context:o,_instance:null,version:zp,get config(){return o.config},set config(l){},use(l,...u){return s.has(l)||(l&&N(l.install)?(s.add(l),l.install(d,...u)):N(l)&&(s.add(l),l(d,...u))),d},mixin(l){return o.mixins.includes(l)||o.mixins.push(l),d},component(l,u){return u?(o.components[l]=u,d):o.components[l]},directive(l,u){return u?(o.directives[l]=u,d):o.directives[l]},mount(l,u,h){if(!p){const f=d._ceVNode||le(r,i);return f.appContext=o,h===!0?h="svg":h===!1&&(h=void 0),e(f,l,h),p=!0,d._container=l,l.__vue_app__=d,Gt(f.component)}},onUnmount(l){a.push(l)},unmount(){p&&(Fe(a,d._instance,16),e(null,d._container),delete d._container.__vue_app__)},provide(l,u){return o.provides[l]=u,d},runWithContext(l){const u=vn;vn=d;try{return l()}finally{vn=u}}};return d}}let vn=null;function xp(e,n,t=D){const r=ns(),i=Ue(n),o=nn(n),s=Oo(e,i),a=Na((p,d)=>{let l,u=D,h;return Ya(()=>{const f=e[i];he(l,f)&&(l=f,d())}),{get(){return p(),t.get?t.get(l):l},set(f){const S=t.set?t.set(f):f;if(!he(S,l)&&!(u!==D&&he(f,u)))return;const v=r.vnode.props;v&&(n in v||i in v||o in v)&&(`onUpdate:${n}`in v||`onUpdate:${i}`in v||`onUpdate:${o}`in v)||(l=f,d()),r.emit(`update:${n}`,S),he(f,S)&&he(f,u)&&!he(S,h)&&d(),u=f,h=S}}});return a[Symbol.iterator]=()=>{let p=0;return{next(){return p<2?{value:p++?s||D:a,done:!1}:{done:!0}}}},a}const Oo=(e,n)=>n==="modelValue"||n==="model-value"?e.modelModifiers:e[`${n}Modifiers`]||e[`${Ue(n)}Modifiers`]||e[`${nn(n)}Modifiers`];function Tp(e,n,...t){if(e.isUnmounted)return;const r=e.vnode.props||D;let i=t;const o=n.startsWith("update:"),s=o&&Oo(r,n.slice(7));s&&(s.trim&&(i=t.map(l=>Y(l)?l.trim():l)),s.number&&(i=t.map(wr)));let a,p=r[a=Bt(n)]||r[a=Bt(Ue(n))];!p&&o&&(p=r[a=Bt(nn(n))]),p&&Fe(p,e,6,i);const d=r[a+"Once"];if(d){if(!e.emitted)e.emitted={};else if(e.emitted[a])return;e.emitted[a]=!0,Fe(d,e,6,i)}}const vp=new WeakMap;function ko(e,n,t=!1){const r=t?vp:n.emitsCache,i=r.get(e);if(i!==void 0)return i;const o=e.emits;let s={},a=!1;if(!N(e)){const p=d=>{const l=ko(d,n,!0);l&&(a=!0,ee(s,l))};!t&&n.mixins.length&&n.mixins.forEach(p),e.extends&&p(e.extends),e.mixins&&e.mixins.forEach(p)}return!o&&!a?(U(e)&&r.set(e,null),null):(R(o)?o.forEach(p=>s[p]=null):ee(s,o),U(e)&&r.set(e,s),s)}function $t(e,n){return!e||!Pt(n)?!1:(n=n.slice(2).replace(/Once$/,""),M(e,n[0].toLowerCase()+n.slice(1))||M(e,nn(n))||M(e,n))}function ci(e){const{type:n,vnode:t,proxy:r,withProxy:i,propsOptions:[o],slots:s,attrs:a,emit:p,render:d,renderCache:l,props:u,data:h,setupState:f,ctx:S,inheritAttrs:v}=e,k=xt(e);let F,I;try{if(t.shapeFlag&4){const q=i||r,z=q;F=qe(d.call(z,q,l,u,f,h,S)),I=a}else{const q=n;F=qe(q.length>1?q(u,{attrs:a,slots:s,emit:p}):q(u,null)),I=n.props?a:jp(a)}}catch(q){Vn.length=0,Nt(q,e,1),F=le(Qe)}let H=F;if(I&&v!==!1){const q=Object.keys(I),{shapeFlag:z}=H;q.length&&z&7&&(o&&q.some(Tr)&&(I=wp(I,o)),H=An(H,I,!1,!0))}return t.dirs&&(H=An(H,null,!1,!0),H.dirs=H.dirs?H.dirs.concat(t.dirs):t.dirs),t.transition&&Fr(H,t.transition),F=H,xt(k),F}const jp=e=>{let n;for(const t in e)(t==="class"||t==="style"||Pt(t))&&((n||(n={}))[t]=e[t]);return n},wp=(e,n)=>{const t={};for(const r in e)(!Tr(r)||!(r.slice(9)in n))&&(t[r]=e[r]);return t};function Ap(e,n,t){const{props:r,children:i,component:o}=e,{props:s,children:a,patchFlag:p}=n,d=o.emitsOptions;if(n.dirs||n.transition)return!0;if(t&&p>=0){if(p&1024)return!0;if(p&16)return r?li(r,s,d):!!s;if(p&8){const l=n.dynamicProps;for(let u=0;u<l.length;u++){const h=l[u];if(No(s,r,h)&&!$t(d,h))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:r===s?!1:r?s?li(r,s,d):!0:!!s;return!1}function li(e,n,t){const r=Object.keys(n);if(r.length!==Object.keys(e).length)return!0;for(let i=0;i<r.length;i++){const o=r[i];if(No(n,e,o)&&!$t(t,o))return!0}return!1}function No(e,n,t){const r=e[t],i=n[t];return t==="style"&&U(r)&&U(i)?!Sr(r,i):r!==i}function Sp({vnode:e,parent:n},t){for(;n;){const r=n.subTree;if(r.suspense&&r.suspense.activeBranch===e&&(r.el=e.el),r===e)(e=n.vnode).el=t,n=n.parent;else break}}const Fo={},$o=()=>Object.create(Fo),Do=e=>Object.getPrototypeOf(e)===Fo;function Ip(e,n,t,r=!1){const i={},o=$o();e.propsDefaults=Object.create(null),Go(e,n,i,o);for(const s in e.propsOptions[0])s in i||(i[s]=void 0);t?e.props=r?i:Ea(i):e.type.props?e.props=i:e.props=o,e.attrs=o}function Cp(e,n,t,r){const{props:i,attrs:o,vnode:{patchFlag:s}}=e,a=G(i),[p]=e.propsOptions;let d=!1;if((r||s>0)&&!(s&16)){if(s&8){const l=e.vnode.dynamicProps;for(let u=0;u<l.length;u++){let h=l[u];if($t(e.emitsOptions,h))continue;const f=n[h];if(p)if(M(o,h))f!==o[h]&&(o[h]=f,d=!0);else{const S=Ue(h);i[S]=ur(p,a,S,f,e,!1)}else f!==o[h]&&(o[h]=f,d=!0)}}}else{Go(e,n,i,o)&&(d=!0);let l;for(const u in a)(!n||!M(n,u)&&((l=nn(u))===u||!M(n,l)))&&(p?t&&(t[u]!==void 0||t[l]!==void 0)&&(i[u]=ur(p,a,u,void 0,e,!0)):delete i[u]);if(o!==a)for(const u in o)(!n||!M(n,u))&&(delete o[u],d=!0)}d&&Me(e.attrs,"set","")}function Go(e,n,t,r){const[i,o]=e.propsOptions;let s=!1,a;if(n)for(let p in n){if($n(p))continue;const d=n[p];let l;i&&M(i,l=Ue(p))?!o||!o.includes(l)?t[l]=d:(a||(a={}))[l]=d:$t(e.emitsOptions,p)||(!(p in r)||d!==r[p])&&(r[p]=d,s=!0)}if(o){const p=G(t),d=a||D;for(let l=0;l<o.length;l++){const u=o[l];t[u]=ur(i,p,u,d[u],e,!M(d,u))}}return s}function ur(e,n,t,r,i,o){const s=e[t];if(s!=null){const a=M(s,"default");if(a&&r===void 0){const p=s.default;if(s.type!==Function&&!s.skipFactory&&N(p)){const{propsDefaults:d}=i;if(t in d)r=d[t];else{const l=it(i);r=d[t]=p.call(null,n),l()}}else r=p;i.ce&&i.ce._setProp(t,r)}s[0]&&(o&&!a?r=!1:s[1]&&(r===""||r===nn(t))&&(r=!0))}return r}const Ep=new WeakMap;function Mo(e,n,t=!1){const r=t?Ep:n.propsCache,i=r.get(e);if(i)return i;const o=e.props,s={},a=[];let p=!1;if(!N(e)){const l=u=>{p=!0;const[h,f]=Mo(u,n,!0);ee(s,h),f&&a.push(...f)};!t&&n.mixins.length&&n.mixins.forEach(l),e.extends&&l(e.extends),e.mixins&&e.mixins.forEach(l)}if(!o&&!p)return U(e)&&r.set(e,_n),_n;if(R(o))for(let l=0;l<o.length;l++){const u=Ue(o[l]);di(u)&&(s[u]=D)}else if(o)for(const l in o){const u=Ue(l);if(di(u)){const h=o[l],f=s[u]=R(h)||N(h)?{type:h}:ee({},h),S=f.type;let v=!1,k=!0;if(R(S))for(let F=0;F<S.length;++F){const I=S[F],H=N(I)&&I.name;if(H==="Boolean"){v=!0;break}else H==="String"&&(k=!1)}else v=N(S)&&S.name==="Boolean";f[0]=v,f[1]=k,(v||M(f,"default"))&&a.push(u)}}const d=[s,a];return U(e)&&r.set(e,d),d}function di(e){return e[0]!=="$"&&!$n(e)}const Dr=e=>e==="_"||e==="_ctx"||e==="$stable",Gr=e=>R(e)?e.map(qe):[qe(e)],Pp=(e,n,t)=>{if(n._n)return n;const r=Va((...i)=>Gr(n(...i)),t);return r._c=!1,r},Lo=(e,n,t)=>{const r=e._ctx;for(const i in e){if(Dr(i))continue;const o=e[i];if(N(o))n[i]=Pp(i,o,r);else if(o!=null){const s=Gr(o);n[i]=()=>s}}},Uo=(e,n)=>{const t=Gr(n);e.slots.default=()=>t},Bo=(e,n,t)=>{for(const r in n)(t||!Dr(r))&&(e[r]=n[r])},Rp=(e,n,t)=>{const r=e.slots=$o();if(e.vnode.shapeFlag&32){const i=n._;i?(Bo(r,n,t),t&&Zi(r,"_",i,!0)):Lo(n,r)}else n&&Uo(e,n)},qp=(e,n,t)=>{const{vnode:r,slots:i}=e;let o=!0,s=D;if(r.shapeFlag&32){const a=n._;a?t&&a===1?o=!1:Bo(i,n,t):(o=!n.$stable,Lo(n,i)),s=n}else n&&(Uo(e,n),s={default:1});if(o)for(const a in i)!Dr(a)&&s[a]==null&&delete i[a]},me=$p;function Op(e){return kp(e)}function kp(e,n){const t=qt();t.__VUE__=!0;const{insert:r,remove:i,patchProp:o,createElement:s,createText:a,createComment:p,setText:d,setElementText:l,parentNode:u,nextSibling:h,setScopeId:f=Oe,insertStaticContent:S}=e,v=(c,m,y,x=null,g=null,b=null,w=void 0,j=null,T=!!m.dynamicChildren)=>{if(c===m)return;c&&!On(c,m)&&(x=ct(c),Se(c,g,b,!0),c=null),m.patchFlag===-2&&(T=!1,m.dynamicChildren=null);const{type:_,ref:P,shapeFlag:A}=m;switch(_){case Dt:k(c,m,y,x);break;case Qe:F(c,m,y,x);break;case ht:c==null&&I(m,y,x,w);break;case xe:st(c,m,y,x,g,b,w,j,T);break;default:A&1?z(c,m,y,x,g,b,w,j,T):A&6?at(c,m,y,x,g,b,w,j,T):(A&64||A&128)&&_.process(c,m,y,x,g,b,w,j,T,Pn)}P!=null&&g?Ln(P,c&&c.ref,b,m||c,!m):P==null&&c&&c.ref!=null&&Ln(c.ref,null,b,c,!0)},k=(c,m,y,x)=>{if(c==null)r(m.el=a(m.children),y,x);else{const g=m.el=c.el;m.children!==c.children&&d(g,m.children)}},F=(c,m,y,x)=>{c==null?r(m.el=p(m.children||""),y,x):m.el=c.el},I=(c,m,y,x)=>{[c.el,c.anchor]=S(c.children,m,y,x,c.el,c.anchor)},H=({el:c,anchor:m},y,x)=>{let g;for(;c&&c!==m;)g=h(c),r(c,y,x),c=g;r(m,y,x)},q=({el:c,anchor:m})=>{let y;for(;c&&c!==m;)y=h(c),i(c),c=y;i(m)},z=(c,m,y,x,g,b,w,j,T)=>{if(m.type==="svg"?w="svg":m.type==="math"&&(w="mathml"),c==null)Xe(m,y,x,g,b,w,j,T);else{const _=c.el&&c.el._isVueCE?c.el:null;try{_&&_._beginPatch(),ot(c,m,g,b,w,j,T)}finally{_&&_._endPatch()}}},Xe=(c,m,y,x,g,b,w,j)=>{let T,_;const{props:P,shapeFlag:A,transition:E,dirs:O}=c;if(T=c.el=s(c.type,b,P&&P.is,P),A&8?l(T,c.children):A&16&&Ye(c.children,T,null,x,g,Yt(c,b),w,j),O&&sn(c,null,x,"created"),Ae(T,c,c.scopeId,w,x),P){for(const V in P)V!=="value"&&!$n(V)&&o(T,V,null,P[V],b,x);"value"in P&&o(T,"value",null,P.value,b),(_=P.onVnodeBeforeMount)&&Pe(_,x,c)}O&&sn(c,null,x,"beforeMount");const $=Np(g,E);$&&E.beforeEnter(T),r(T,m,y),((_=P&&P.onVnodeMounted)||$||O)&&me(()=>{_&&Pe(_,x,c),$&&E.enter(T),O&&sn(c,null,x,"mounted")},g)},Ae=(c,m,y,x,g)=>{if(y&&f(c,y),x)for(let b=0;b<x.length;b++)f(c,x[b]);if(g){let b=g.subTree;if(m===b||Wo(b.type)&&(b.ssContent===m||b.ssFallback===m)){const w=g.vnode;Ae(c,w,w.scopeId,w.slotScopeIds,g.parent)}}},Ye=(c,m,y,x,g,b,w,j,T=0)=>{for(let _=T;_<c.length;_++){const P=c[_]=j?Ge(c[_]):qe(c[_]);v(null,P,m,y,x,g,b,w,j)}},ot=(c,m,y,x,g,b,w)=>{const j=m.el=c.el;let{patchFlag:T,dynamicChildren:_,dirs:P}=m;T|=c.patchFlag&16;const A=c.props||D,E=m.props||D;let O;if(y&&an(y,!1),(O=E.onVnodeBeforeUpdate)&&Pe(O,y,m,c),P&&sn(m,c,y,"beforeUpdate"),y&&an(y,!0),(A.innerHTML&&E.innerHTML==null||A.textContent&&E.textContent==null)&&l(j,""),_?tn(c.dynamicChildren,_,j,y,x,Yt(m,g),b):w||B(c,m,j,null,y,x,Yt(m,g),b,!1),T>0){if(T&16)Cn(j,A,E,y,g);else if(T&2&&A.class!==E.class&&o(j,"class",null,E.class,g),T&4&&o(j,"style",A.style,E.style,g),T&8){const $=m.dynamicProps;for(let V=0;V<$.length;V++){const L=$[V],de=A[L],ue=E[L];(ue!==de||L==="value")&&o(j,L,de,ue,g,y)}}T&1&&c.children!==m.children&&l(j,m.children)}else!w&&_==null&&Cn(j,A,E,y,g);((O=E.onVnodeUpdated)||P)&&me(()=>{O&&Pe(O,y,m,c),P&&sn(m,c,y,"updated")},x)},tn=(c,m,y,x,g,b,w)=>{for(let j=0;j<m.length;j++){const T=c[j],_=m[j],P=T.el&&(T.type===xe||!On(T,_)||T.shapeFlag&198)?u(T.el):y;v(T,_,P,null,x,g,b,w,!0)}},Cn=(c,m,y,x,g)=>{if(m!==y){if(m!==D)for(const b in m)!$n(b)&&!(b in y)&&o(c,b,m[b],null,g,x);for(const b in y){if($n(b))continue;const w=y[b],j=m[b];w!==j&&b!=="value"&&o(c,b,j,w,g,x)}"value"in y&&o(c,"value",m.value,y.value,g)}},st=(c,m,y,x,g,b,w,j,T)=>{const _=m.el=c?c.el:a(""),P=m.anchor=c?c.anchor:a("");let{patchFlag:A,dynamicChildren:E,slotScopeIds:O}=m;O&&(j=j?j.concat(O):O),c==null?(r(_,y,x),r(P,y,x),Ye(m.children||[],y,P,g,b,w,j,T)):A>0&&A&64&&E&&c.dynamicChildren&&c.dynamicChildren.length===E.length?(tn(c.dynamicChildren,E,y,g,b,w,j),(m.key!=null||g&&m===g.subTree)&&Vo(c,m,!0)):B(c,m,y,P,g,b,w,j,T)},at=(c,m,y,x,g,b,w,j,T)=>{m.slotScopeIds=j,c==null?m.shapeFlag&512?g.ctx.activate(m,y,x,w,T):Lt(m,y,x,g,b,w,T):Wr(c,m,T)},Lt=(c,m,y,x,g,b,w)=>{const j=c.component=Vp(c,x,g);if(Ao(c)&&(j.ctx.renderer=Pn),Kp(j,!1,w),j.asyncDep){if(g&&g.registerDep(j,oe,w),!c.el){const T=j.subTree=le(Qe);F(null,T,m,y),c.placeholder=T.el}}else oe(j,c,m,y,g,b,w)},Wr=(c,m,y)=>{const x=m.component=c.component;if(Ap(c,m,y))if(x.asyncDep&&!x.asyncResolved){W(x,m,y);return}else x.next=m,x.update();else m.el=c.el,x.vnode=m},oe=(c,m,y,x,g,b,w)=>{const j=()=>{if(c.isMounted){let{next:A,bu:E,u:O,parent:$,vnode:V}=c;{const Ce=Ko(c);if(Ce){A&&(A.el=V.el,W(c,A,w)),Ce.asyncDep.then(()=>{me(()=>{c.isUnmounted||_()},g)});return}}let L=A,de;an(c,!1),A?(A.el=V.el,W(c,A,w)):A=V,E&&mt(E),(de=A.props&&A.props.onVnodeBeforeUpdate)&&Pe(de,$,A,V),an(c,!0);const ue=ci(c),Ie=c.subTree;c.subTree=ue,v(Ie,ue,u(Ie.el),ct(Ie),c,g,b),A.el=ue.el,L===null&&Sp(c,ue.el),O&&me(O,g),(de=A.props&&A.props.onVnodeUpdated)&&me(()=>Pe(de,$,A,V),g)}else{let A;const{el:E,props:O}=m,{bm:$,m:V,parent:L,root:de,type:ue}=c,Ie=Un(m);an(c,!1),$&&mt($),!Ie&&(A=O&&O.onVnodeBeforeMount)&&Pe(A,L,m),an(c,!0);{de.ce&&de.ce._hasShadowRoot()&&de.ce._injectChildStyle(ue);const Ce=c.subTree=ci(c);v(null,Ce,y,x,c,g,b),m.el=Ce.el}if(V&&me(V,g),!Ie&&(A=O&&O.onVnodeMounted)){const Ce=m;me(()=>Pe(A,L,Ce),g)}(m.shapeFlag&256||L&&Un(L.vnode)&&L.vnode.shapeFlag&256)&&c.a&&me(c.a,g),c.isMounted=!0,m=y=x=null}};c.scope.on();const T=c.effect=new to(j);c.scope.off();const _=c.update=T.run.bind(T),P=c.job=T.runIfDirty.bind(T);P.i=c,P.id=c.uid,T.scheduler=()=>kr(P),an(c,!0),_()},W=(c,m,y)=>{m.component=c;const x=c.vnode.props;c.vnode=m,c.next=null,Cp(c,m.props,x,y),qp(c,m.children,y),Be(),ri(c),Ve()},B=(c,m,y,x,g,b,w,j,T=!1)=>{const _=c&&c.children,P=c?c.shapeFlag:0,A=m.children,{patchFlag:E,shapeFlag:O}=m;if(E>0){if(E&128){pt(_,A,y,x,g,b,w,j,T);return}else if(E&256){rn(_,A,y,x,g,b,w,j,T);return}}O&8?(P&16&&En(_,g,b),A!==_&&l(y,A)):P&16?O&16?pt(_,A,y,x,g,b,w,j,T):En(_,g,b,!0):(P&8&&l(y,""),O&16&&Ye(A,y,x,g,b,w,j,T))},rn=(c,m,y,x,g,b,w,j,T)=>{c=c||_n,m=m||_n;const _=c.length,P=m.length,A=Math.min(_,P);let E;for(E=0;E<A;E++){const O=m[E]=T?Ge(m[E]):qe(m[E]);v(c[E],O,y,null,g,b,w,j,T)}_>P?En(c,g,b,!0,!1,A):Ye(m,y,x,g,b,w,j,T,A)},pt=(c,m,y,x,g,b,w,j,T)=>{let _=0;const P=m.length;let A=c.length-1,E=P-1;for(;_<=A&&_<=E;){const O=c[_],$=m[_]=T?Ge(m[_]):qe(m[_]);if(On(O,$))v(O,$,y,null,g,b,w,j,T);else break;_++}for(;_<=A&&_<=E;){const O=c[A],$=m[E]=T?Ge(m[E]):qe(m[E]);if(On(O,$))v(O,$,y,null,g,b,w,j,T);else break;A--,E--}if(_>A){if(_<=E){const O=E+1,$=O<P?m[O].el:x;for(;_<=E;)v(null,m[_]=T?Ge(m[_]):qe(m[_]),y,$,g,b,w,j,T),_++}}else if(_>E)for(;_<=A;)Se(c[_],g,b,!0),_++;else{const O=_,$=_,V=new Map;for(_=$;_<=E;_++){const be=m[_]=T?Ge(m[_]):qe(m[_]);be.key!=null&&V.set(be.key,_)}let L,de=0;const ue=E-$+1;let Ie=!1,Ce=0;const Rn=new Array(ue);for(_=0;_<ue;_++)Rn[_]=0;for(_=O;_<=A;_++){const be=c[_];if(de>=ue){Se(be,g,b,!0);continue}let Ee;if(be.key!=null)Ee=V.get(be.key);else for(L=$;L<=E;L++)if(Rn[L-$]===0&&On(be,m[L])){Ee=L;break}Ee===void 0?Se(be,g,b,!0):(Rn[Ee-$]=_+1,Ee>=Ce?Ce=Ee:Ie=!0,v(be,m[Ee],y,null,g,b,w,j,T),de++)}const zr=Ie?Fp(Rn):_n;for(L=zr.length-1,_=ue-1;_>=0;_--){const be=$+_,Ee=m[be],Jr=m[be+1],Zr=be+1<P?Jr.el||Ho(Jr):x;Rn[_]===0?v(null,Ee,y,Zr,g,b,w,j,T):Ie&&(L<0||_!==zr[L]?on(Ee,y,Zr,2):L--)}}},on=(c,m,y,x,g=null)=>{const{el:b,type:w,transition:j,children:T,shapeFlag:_}=c;if(_&6){on(c.component.subTree,m,y,x);return}if(_&128){c.suspense.move(m,y,x);return}if(_&64){w.move(c,m,y,Pn);return}if(w===xe){r(b,m,y);for(let A=0;A<T.length;A++)on(T[A],m,y,x);r(c.anchor,m,y);return}if(w===ht){H(c,m,y);return}if(x!==2&&_&1&&j)if(x===0)j.beforeEnter(b),r(b,m,y),me(()=>j.enter(b),g);else{const{leave:A,delayLeave:E,afterLeave:O}=j,$=()=>{c.ctx.isUnmounted?i(b):r(b,m,y)},V=()=>{b._isLeaving&&b[Qa](!0),A(b,()=>{$(),O&&O()})};E?E(b,$,V):V()}else r(b,m,y)},Se=(c,m,y,x=!1,g=!1)=>{const{type:b,props:w,ref:j,children:T,dynamicChildren:_,shapeFlag:P,patchFlag:A,dirs:E,cacheIndex:O}=c;if(A===-2&&(g=!1),j!=null&&(Be(),Ln(j,null,y,c,!0),Ve()),O!=null&&(m.renderCache[O]=void 0),P&256){m.ctx.deactivate(c);return}const $=P&1&&E,V=!Un(c);let L;if(V&&(L=w&&w.onVnodeBeforeUnmount)&&Pe(L,m,c),P&6)zs(c.component,y,x);else{if(P&128){c.suspense.unmount(y,x);return}$&&sn(c,null,m,"beforeUnmount"),P&64?c.type.remove(c,m,y,Pn,x):_&&!_.hasOnce&&(b!==xe||A>0&&A&64)?En(_,m,y,!1,!0):(b===xe&&A&384||!g&&P&16)&&En(T,m,y),x&&Xr(c)}(V&&(L=w&&w.onVnodeUnmounted)||$)&&me(()=>{L&&Pe(L,m,c),$&&sn(c,null,m,"unmounted")},y)},Xr=c=>{const{type:m,el:y,anchor:x,transition:g}=c;if(m===xe){Ys(y,x);return}if(m===ht){q(c);return}const b=()=>{i(y),g&&!g.persisted&&g.afterLeave&&g.afterLeave()};if(c.shapeFlag&1&&g&&!g.persisted){const{leave:w,delayLeave:j}=g,T=()=>w(y,b);j?j(c.el,b,T):T()}else b()},Ys=(c,m)=>{let y;for(;c!==m;)y=h(c),i(c),c=y;i(m)},zs=(c,m,y)=>{const{bum:x,scope:g,job:b,subTree:w,um:j,m:T,a:_}=c;ui(T),ui(_),x&&mt(x),g.stop(),b&&(b.flags|=8,Se(w,c,m,y)),j&&me(j,m),me(()=>{c.isUnmounted=!0},m)},En=(c,m,y,x=!1,g=!1,b=0)=>{for(let w=b;w<c.length;w++)Se(c[w],m,y,x,g)},ct=c=>{if(c.shapeFlag&6)return ct(c.component.subTree);if(c.shapeFlag&128)return c.suspense.next();const m=h(c.anchor||c.el),y=m&&m[Ja];return y?h(y):m};let Ut=!1;const Yr=(c,m,y)=>{let x;c==null?m._vnode&&(Se(m._vnode,null,null,!0),x=m._vnode.component):v(m._vnode||null,c,m,null,null,null,y),m._vnode=c,Ut||(Ut=!0,ri(x),xo(),Ut=!1)},Pn={p:v,um:Se,m:on,r:Xr,mt:Lt,mc:Ye,pc:B,pbc:tn,n:ct,o:e};return{render:Yr,hydrate:void 0,createApp:_p(Yr)}}function Yt({type:e,props:n},t){return t==="svg"&&e==="foreignObject"||t==="mathml"&&e==="annotation-xml"&&n&&n.encoding&&n.encoding.includes("html")?void 0:t}function an({effect:e,job:n},t){t?(e.flags|=32,n.flags|=4):(e.flags&=-33,n.flags&=-5)}function Np(e,n){return(!e||e&&!e.pendingBranch)&&n&&!n.persisted}function Vo(e,n,t=!1){const r=e.children,i=n.children;if(R(r)&&R(i))for(let o=0;o<r.length;o++){const s=r[o];let a=i[o];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[o]=Ge(i[o]),a.el=s.el),!t&&a.patchFlag!==-2&&Vo(s,a)),a.type===Dt&&(a.patchFlag===-1&&(a=i[o]=Ge(a)),a.el=s.el),a.type===Qe&&!a.el&&(a.el=s.el)}}function Fp(e){const n=e.slice(),t=[0];let r,i,o,s,a;const p=e.length;for(r=0;r<p;r++){const d=e[r];if(d!==0){if(i=t[t.length-1],e[i]<d){n[r]=i,t.push(r);continue}for(o=0,s=t.length-1;o<s;)a=o+s>>1,e[t[a]]<d?o=a+1:s=a;d<e[t[o]]&&(o>0&&(n[r]=t[o-1]),t[o]=r)}}for(o=t.length,s=t[o-1];o-- >0;)t[o]=s,s=n[s];return t}function Ko(e){const n=e.subTree.component;if(n)return n.asyncDep&&!n.asyncResolved?n:Ko(n)}function ui(e){if(e)for(let n=0;n<e.length;n++)e[n].flags|=8}function Ho(e){if(e.placeholder)return e.placeholder;const n=e.component;return n?Ho(n.subTree):null}const Wo=e=>e.__isSuspense;function $p(e,n){n&&n.pendingBranch?R(e)?n.effects.push(...e):n.effects.push(e):Ba(e)}const xe=Symbol.for("v-fgt"),Dt=Symbol.for("v-txt"),Qe=Symbol.for("v-cmt"),ht=Symbol.for("v-stc"),Vn=[];let _e=null;function te(e=!1){Vn.push(_e=e?null:[])}function Dp(){Vn.pop(),_e=Vn[Vn.length-1]||null}let zn=1;function mi(e,n=!1){zn+=e,e<0&&_e&&n&&(_e.hasOnce=!0)}function Xo(e){return e.dynamicChildren=zn>0?_e||_n:null,Dp(),zn>0&&_e&&_e.push(e),e}function fe(e,n,t,r,i,o){return Xo(Z(e,n,t,r,i,o,!0))}function Yo(e,n,t,r,i){return Xo(le(e,n,t,r,i,!0))}function zo(e){return e?e.__v_isVNode===!0:!1}function On(e,n){return e.type===n.type&&e.key===n.key}const Jo=({key:e})=>e??null,ft=({ref:e,ref_key:n,ref_for:t})=>(typeof e=="number"&&(e=""+e),e!=null?Y(e)||re(e)||N(e)?{i:Te,r:e,k:n,f:!!t}:e:null);function Z(e,n=null,t=null,r=0,i=null,o=e===xe?0:1,s=!1,a=!1){const p={__v_isVNode:!0,__v_skip:!0,type:e,props:n,key:n&&Jo(n),ref:n&&ft(n),scopeId:vo,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:r,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:Te};return a?(Mr(p,t),o&128&&e.normalize(p)):t&&(p.shapeFlag|=Y(t)?8:16),zn>0&&!s&&_e&&(p.patchFlag>0||o&6)&&p.patchFlag!==32&&_e.push(p),p}const le=Gp;function Gp(e,n=null,t=null,r=0,i=null,o=!1){if((!e||e===lp)&&(e=Qe),zo(e)){const a=An(e,n,!0);return t&&Mr(a,t),zn>0&&!o&&_e&&(a.shapeFlag&6?_e[_e.indexOf(e)]=a:_e.push(a)),a.patchFlag=-2,a}if(Yp(e)&&(e=e.__vccOpts),n){n=Mp(n);let{class:a,style:p}=n;a&&!Y(a)&&(n.class=Kn(a)),U(p)&&(Or(p)&&!R(p)&&(p=ee({},p)),n.style=Ar(p))}const s=Y(e)?1:Wo(e)?128:Za(e)?64:U(e)?4:N(e)?2:0;return Z(e,n,t,r,i,s,o,!0)}function Mp(e){return e?Or(e)||Do(e)?ee({},e):e:null}function An(e,n,t=!1,r=!1){const{props:i,ref:o,patchFlag:s,children:a,transition:p}=e,d=n?Lp(i||{},n):i,l={__v_isVNode:!0,__v_skip:!0,type:e.type,props:d,key:d&&Jo(d),ref:n&&n.ref?t&&o?R(o)?o.concat(ft(n)):[o,ft(n)]:ft(n):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:a,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:n&&e.type!==xe?s===-1?16:s|16:s,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:p,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&An(e.ssContent),ssFallback:e.ssFallback&&An(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return p&&r&&Fr(l,p.clone(l)),l}function Zo(e=" ",n=0){return le(Dt,null,e,n)}function Qo(e,n){const t=le(ht,null,e);return t.staticCount=n,t}function es(e="",n=!1){return n?(te(),Yo(Qe,null,e)):le(Qe,null,e)}function qe(e){return e==null||typeof e=="boolean"?le(Qe):R(e)?le(xe,null,e.slice()):zo(e)?Ge(e):le(Dt,null,String(e))}function Ge(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:An(e)}function Mr(e,n){let t=0;const{shapeFlag:r}=e;if(n==null)n=null;else if(R(n))t=16;else if(typeof n=="object")if(r&65){const i=n.default;i&&(i._c&&(i._d=!1),Mr(e,i()),i._c&&(i._d=!0));return}else{t=32;const i=n._;!i&&!Do(n)?n._ctx=Te:i===3&&Te&&(Te.slots._===1?n._=1:(n._=2,e.patchFlag|=1024))}else N(n)?(n={default:n,_ctx:Te},t=32):(n=String(n),r&64?(t=16,n=[Zo(n)]):t=8);e.children=n,e.shapeFlag|=t}function Lp(...e){const n={};for(let t=0;t<e.length;t++){const r=e[t];for(const i in r)if(i==="class")n.class!==r.class&&(n.class=Kn([n.class,r.class]));else if(i==="style")n.style=Ar([n.style,r.style]);else if(Pt(i)){const o=n[i],s=r[i];s&&o!==s&&!(R(o)&&o.includes(s))&&(n[i]=o?[].concat(o,s):s)}else i!==""&&(n[i]=r[i])}return n}function Pe(e,n,t,r=null){Fe(e,n,7,[t,r])}const Up=qo();let Bp=0;function Vp(e,n,t){const r=e.type,i=(n?n.appContext:e.appContext)||Up,o={uid:Bp++,vnode:e,type:r,parent:n,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new ca(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:n?n.provides:Object.create(i.provides),ids:n?n.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Mo(r,i),emitsOptions:ko(r,i),emit:null,emitted:null,propsDefaults:D,inheritAttrs:r.inheritAttrs,ctx:D,data:D,props:D,attrs:D,slots:D,refs:D,setupState:D,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=n?n.root:o,o.emit=Tp.bind(null,o),e.ce&&e.ce(o),o}let pe=null;const ns=()=>pe||Te;let wt,mr;{const e=qt(),n=(t,r)=>{let i;return(i=e[t])||(i=e[t]=[]),i.push(r),o=>{i.length>1?i.forEach(s=>s(o)):i[0](o)}};wt=n("__VUE_INSTANCE_SETTERS__",t=>pe=t),mr=n("__VUE_SSR_SETTERS__",t=>Jn=t)}const it=e=>{const n=pe;return wt(e),e.scope.on(),()=>{e.scope.off(),wt(n)}},yi=()=>{pe&&pe.scope.off(),wt(null)};function ts(e){return e.vnode.shapeFlag&4}let Jn=!1;function Kp(e,n=!1,t=!1){n&&mr(n);const{props:r,children:i}=e.vnode,o=ts(e);Ip(e,r,o,n),Rp(e,i,t||n);const s=o?Hp(e,n):void 0;return n&&mr(!1),s}function Hp(e,n){const t=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,dp);const{setup:r}=t;if(r){Be();const i=e.setupContext=r.length>1?Xp(e):null,o=it(e),s=rt(r,e,0,[e.props,i]),a=Xi(s);if(Ve(),o(),(a||e.sp)&&!Un(e)&&wo(e),a){if(s.then(yi,yi),n)return s.then(p=>{hi(e,p)}).catch(p=>{Nt(p,e,0)});e.asyncDep=s}else hi(e,s)}else rs(e)}function hi(e,n,t){N(n)?e.type.__ssrInlineRender?e.ssrRender=n:e.render=n:U(n)&&(e.setupState=go(n)),rs(e)}function rs(e,n,t){const r=e.type;e.render||(e.render=r.render||Oe);{const i=it(e);Be();try{mp(e)}finally{Ve(),i()}}}const Wp={get(e,n){return ne(e,"get",""),e[n]}};function Xp(e){const n=t=>{e.exposed=t||{}};return{attrs:new Proxy(e.attrs,Wp),slots:e.slots,emit:e.emit,expose:n}}function Gt(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(go(Pa(e.exposed)),{get(n,t){if(t in n)return n[t];if(t in Bn)return Bn[t](e)},has(n,t){return t in n||t in Bn}})):e.proxy}function Yp(e){return N(e)&&"__vccOpts"in e}const is=(e,n)=>$a(e,n,Jn),zp="3.5.28";let yr;const fi=typeof window<"u"&&window.trustedTypes;if(fi)try{yr=fi.createPolicy("vue",{createHTML:e=>e})}catch{}const os=yr?e=>yr.createHTML(e):e=>e,Jp="http://www.w3.org/2000/svg",Zp="http://www.w3.org/1998/Math/MathML",De=typeof document<"u"?document:null,gi=De&&De.createElement("template"),Qp={insert:(e,n,t)=>{n.insertBefore(e,t||null)},remove:e=>{const n=e.parentNode;n&&n.removeChild(e)},createElement:(e,n,t,r)=>{const i=n==="svg"?De.createElementNS(Jp,e):n==="mathml"?De.createElementNS(Zp,e):t?De.createElement(e,{is:t}):De.createElement(e);return e==="select"&&r&&r.multiple!=null&&i.setAttribute("multiple",r.multiple),i},createText:e=>De.createTextNode(e),createComment:e=>De.createComment(e),setText:(e,n)=>{e.nodeValue=n},setElementText:(e,n)=>{e.textContent=n},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>De.querySelector(e),setScopeId(e,n){e.setAttribute(n,"")},insertStaticContent(e,n,t,r,i,o){const s=t?t.previousSibling:n.lastChild;if(i&&(i===o||i.nextSibling))for(;n.insertBefore(i.cloneNode(!0),t),!(i===o||!(i=i.nextSibling)););else{gi.innerHTML=os(r==="svg"?`<svg>${e}</svg>`:r==="mathml"?`<math>${e}</math>`:e);const a=gi.content;if(r==="svg"||r==="mathml"){const p=a.firstChild;for(;p.firstChild;)a.appendChild(p.firstChild);a.removeChild(p)}n.insertBefore(a,t)}return[s?s.nextSibling:n.firstChild,t?t.previousSibling:n.lastChild]}},ec=Symbol("_vtc");function nc(e,n,t){const r=e[ec];r&&(n=(n?[n,...r]:[...r]).join(" ")),n==null?e.removeAttribute("class"):t?e.setAttribute("class",n):e.className=n}const bi=Symbol("_vod"),tc=Symbol("_vsh"),rc=Symbol(""),ic=/(?:^|;)\s*display\s*:/;function oc(e,n,t){const r=e.style,i=Y(t);let o=!1;if(t&&!i){if(n)if(Y(n))for(const s of n.split(";")){const a=s.slice(0,s.indexOf(":")).trim();t[a]==null&&gt(r,a,"")}else for(const s in n)t[s]==null&&gt(r,s,"");for(const s in t)s==="display"&&(o=!0),gt(r,s,t[s])}else if(i){if(n!==t){const s=r[rc];s&&(t+=";"+s),r.cssText=t,o=ic.test(t)}}else n&&e.removeAttribute("style");bi in e&&(e[bi]=o?r.display:"",e[tc]&&(r.display="none"))}const _i=/\s*!important$/;function gt(e,n,t){if(R(t))t.forEach(r=>gt(e,n,r));else if(t==null&&(t=""),n.startsWith("--"))e.setProperty(n,t);else{const r=sc(e,n);_i.test(t)?e.setProperty(nn(r),t.replace(_i,""),"important"):e[r]=t}}const xi=["Webkit","Moz","ms"],zt={};function sc(e,n){const t=zt[n];if(t)return t;let r=Ue(n);if(r!=="filter"&&r in e)return zt[n]=r;r=Ji(r);for(let i=0;i<xi.length;i++){const o=xi[i]+r;if(o in e)return zt[n]=o}return n}const Ti="http://www.w3.org/1999/xlink";function vi(e,n,t,r,i,o=aa(n)){r&&n.startsWith("xlink:")?t==null?e.removeAttributeNS(Ti,n.slice(6,n.length)):e.setAttributeNS(Ti,n,t):t==null||o&&!Qi(t)?e.removeAttribute(n):e.setAttribute(n,o?"":Ne(t)?String(t):t)}function ji(e,n,t,r,i){if(n==="innerHTML"||n==="textContent"){t!=null&&(e[n]=n==="innerHTML"?os(t):t);return}const o=e.tagName;if(n==="value"&&o!=="PROGRESS"&&!o.includes("-")){const a=o==="OPTION"?e.getAttribute("value")||"":e.value,p=t==null?e.type==="checkbox"?"on":"":String(t);(a!==p||!("_value"in e))&&(e.value=p),t==null&&e.removeAttribute(n),e._value=t;return}let s=!1;if(t===""||t==null){const a=typeof e[n];a==="boolean"?t=Qi(t):t==null&&a==="string"?(t="",s=!0):a==="number"&&(t=0,s=!0)}try{e[n]=t}catch{}s&&e.removeAttribute(i||n)}function hn(e,n,t,r){e.addEventListener(n,t,r)}function ac(e,n,t,r){e.removeEventListener(n,t,r)}const wi=Symbol("_vei");function pc(e,n,t,r,i=null){const o=e[wi]||(e[wi]={}),s=o[n];if(r&&s)s.value=r;else{const[a,p]=cc(n);if(r){const d=o[n]=uc(r,i);hn(e,a,d,p)}else s&&(ac(e,a,s,p),o[n]=void 0)}}const Ai=/(?:Once|Passive|Capture)$/;function cc(e){let n;if(Ai.test(e)){n={};let r;for(;r=e.match(Ai);)e=e.slice(0,e.length-r[0].length),n[r[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):nn(e.slice(2)),n]}let Jt=0;const lc=Promise.resolve(),dc=()=>Jt||(lc.then(()=>Jt=0),Jt=Date.now());function uc(e,n){const t=r=>{if(!r._vts)r._vts=Date.now();else if(r._vts<=t.attached)return;Fe(mc(r,t.value),n,5,[r])};return t.value=e,t.attached=dc(),t}function mc(e,n){if(R(n)){const t=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{t.call(e),e._stopped=!0},n.map(r=>i=>!i._stopped&&r&&r(i))}else return n}const Si=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,yc=(e,n,t,r,i,o)=>{const s=i==="svg";n==="class"?nc(e,r,s):n==="style"?oc(e,t,r):Pt(n)?Tr(n)||pc(e,n,t,r,o):(n[0]==="."?(n=n.slice(1),!0):n[0]==="^"?(n=n.slice(1),!1):hc(e,n,r,s))?(ji(e,n,r),!e.tagName.includes("-")&&(n==="value"||n==="checked"||n==="selected")&&vi(e,n,r,s,o,n!=="value")):e._isVueCE&&(/[A-Z]/.test(n)||!Y(r))?ji(e,Ue(n),r,o,n):(n==="true-value"?e._trueValue=r:n==="false-value"&&(e._falseValue=r),vi(e,n,r,s))};function hc(e,n,t,r){if(r)return!!(n==="innerHTML"||n==="textContent"||n in e&&Si(n)&&N(t));if(n==="spellcheck"||n==="draggable"||n==="translate"||n==="autocorrect"||n==="sandbox"&&e.tagName==="IFRAME"||n==="form"||n==="list"&&e.tagName==="INPUT"||n==="type"&&e.tagName==="TEXTAREA")return!1;if(n==="width"||n==="height"){const i=e.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return Si(n)&&Y(t)?!1:n in e}const Ii=e=>{const n=e.props["onUpdate:modelValue"]||!1;return R(n)?t=>mt(n,t):n};function fc(e){e.target.composing=!0}function Ci(e){const n=e.target;n.composing&&(n.composing=!1,n.dispatchEvent(new Event("input")))}const Zt=Symbol("_assign");function Ei(e,n,t){return n&&(e=e.trim()),t&&(e=wr(e)),e}const gc={created(e,{modifiers:{lazy:n,trim:t,number:r}},i){e[Zt]=Ii(i);const o=r||i.props&&i.props.type==="number";hn(e,n?"change":"input",s=>{s.target.composing||e[Zt](Ei(e.value,t,o))}),(t||o)&&hn(e,"change",()=>{e.value=Ei(e.value,t,o)}),n||(hn(e,"compositionstart",fc),hn(e,"compositionend",Ci),hn(e,"change",Ci))},mounted(e,{value:n}){e.value=n??""},beforeUpdate(e,{value:n,oldValue:t,modifiers:{lazy:r,trim:i,number:o}},s){if(e[Zt]=Ii(s),e.composing)return;const a=(o||e.type==="number")&&!/^0\d/.test(e.value)?wr(e.value):e.value,p=n??"";a!==p&&(document.activeElement===e&&e.type!=="range"&&(r&&n===t||i&&e.value.trim()===p)||(e.value=p))}},bc=ee({patchProp:yc},Qp);let Pi;function _c(){return Pi||(Pi=Op(bc))}const xc=((...e)=>{const n=_c().createApp(...e),{mount:t}=n;return n.mount=r=>{const i=vc(r);if(!i)return;const o=n._component;!N(o)&&!o.render&&!o.template&&(o.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const s=t(i,!1,Tc(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),s},n});function Tc(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function vc(e){return Y(e)?document.querySelector(e):e}const In=(e,n)=>{const t=e.__vccOpts||e;for(const[r,i]of n)t[r]=i;return t},jc={},wc={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 1103.52 200",fill:"currentColor"};function Ac(e,n){return te(),fe("svg",wc,[...n[0]||(n[0]=[Qo('<title>TaxonWorks</title><path d="M14.2,63.07C24.26,63.07,28,76.31,28,76.31s5.05,15.47,15.35,15.47c7.71,0,9.42-6.32,9.8-9.09,0-.13,0-0.25,0-0.38s0-.5.07-0.76c0-.05,0-0.1,0-0.15a4.56,4.56,0,0,0-2.71-4.82h0a18.22,18.22,0,0,1-8-5.55c-6.4-7.4-3-17,4.5-23.62-3.5-4-8.05-8.66-12-10.77C26.3,32,19.32,39.25,18.79,39.82L18.69,40q-0.9,1.23-1.76,2.48l-0.07.1Q16,43.88,15.09,45.24L15,45.39c-0.5.8-1,1.59-1.47,2.4l-0.3.5q-1.57,2.68-3,5.47L10,54.27q-0.65,1.32-1.26,2.65l-0.06.13Q8,58.47,7.45,59.91l-0.22.55c-0.32.77-.63,1.55-0.92,2.33l-0.24.63q-0.54,1.44-1,2.91l-0.12.37c-0.08.26-.16,0.52-0.24,0.77A12.6,12.6,0,0,1,14.2,63.07Z"></path><path d="M36.15,33c5.35,1.76,11.4,6.83,15.72,11,0.53-.31,1.06-0.61,1.61-0.9a31.06,31.06,0,0,1,7.24-2.67c-2.39-4.94-5.58-12.81-4.88-18.31,1.43-11.17,13.65-12,13.65-12S58.27,12.47,59,22.89c0.35,5,4.67,12.45,7.49,16.79,7-.1,13,2.69,15.75,8a12.48,12.48,0,0,1,.7,1.64h0a5.1,5.1,0,0,0,2.34,2.4c3.64,1.17,7.56,2.55,11.65,4.19a148.81,148.81,0,0,1,17,8.06,0.89,0.89,0,0,0,1-1.42c-27.24-26.14-8-36.35-8-36.35-9.84,14.24,6.6,24.52,25.49,35.14,16.64,9.35,28.42,19.49,41.3,12.67,6.42-3.4,1.94-11-1-15.16a53.74,53.74,0,0,1-5.6-9.24,10.41,10.41,0,0,1-.8-6.61c0.68-3.11-.39-6.78-2.75-10.49-1.75-2.76-5.12-5.68-7.62-7.63a21.18,21.18,0,0,1-4.26-4.42c-9-12.61-32.18-17.89-32.18-17.89h0A97.63,97.63,0,0,0,54,10.16h0A97.4,97.4,0,0,0,34.61,22.89l-0.75.63q-2.16,1.82-4.17,3.81l0,0q-1.17,1.13-2.31,2.31l0,0Q25.07,32,23,34.5l-0.17.2-0.38.46C25.21,32.8,29.65,30.85,36.15,33Zm109.64,0.94A7.74,7.74,0,0,1,156.55,42a7.22,7.22,0,0,1-7.73-.9A7.22,7.22,0,0,1,145.79,33.93Z"></path><path d="M53.17,106.91c-0.2-2-.36-4-0.44-6.3a18.44,18.44,0,0,1-7.22,1.47c-19,0-19.52-18.78-26.22-29.15-7-10.84-16.79.92-17.76,7.24,0,0.3-.09.54-0.13,0.72-0.11.64-.22,1.29-0.32,1.94C1,83.1,1,83.37,1,83.64c-0.12.78-.21,1.56-0.3,2.35,0,0.27-.06.54-0.09,0.81-0.11,1-.21,2.07-0.29,3.11,0,0.11,0,.22,0,0.33Q0.16,91.65.1,93.07q0,0.43,0,.87Q0,95.32,0,96.7c0,0.12,0,.23,0,0.35s0,0.08,0,.12,0,0.08,0,.13c0,0.4,0,.81,0,1.21s0,0.76,0,1.15c0,0.58,0,1.16.06,1.73,0,0.23,0,.47,0,0.7a97.2,97.2,0,0,0,43,76c-7.95-7.83-12.7-17.75-12.7-28.55,0-13.43,7.35-26,19.06-34.44A9,9,0,0,0,53.17,106.91Z"></path><path d="M128.31,170a59.45,59.45,0,0,1-18.3,4.43c-1.07.07-2.19,0.12-3.33,0.12-12.32,0-28.36-4.8-40.71-25.28l-1.62-2.67a16.61,16.61,0,0,0-2.91,9.33c0,13.89,16.65,26.49,36.65,26.49a58.48,58.48,0,0,0,15.89-2c-4.59,2.87-13.84,5.55-21.86,5.55C69.17,186,50,170.76,50,152.72a31.42,31.42,0,0,1,5.75-17.61,8.26,8.26,0,0,0,1.08-7.19h0c-10.55,6.11-17,15.44-17,26.6,0,17.19,15.31,31.89,37,37.89,1.23,0.26,2.46.5,3.7,0.71C96.15,195.74,110,193,119.45,184A35.12,35.12,0,0,0,128.31,170Z"></path><path d="M171,33.85A87.33,87.33,0,0,1,143,160.4l-0.19.17a6.35,6.35,0,0,1,.14-1.3,26.75,26.75,0,0,1,4.37-10.79c7.46-10.69,12.43-27-.29-48.1-7-11.63-21.68-28-51.73-40.11-4.13-1.66-8.12-3.06-11.81-4.23l-1.54-.48-0.18-.06q-1.59-.49-3.1-0.92l-0.15,0-2.93-.81-0.08,0-1.34-.35-0.07,0-2.58-.64-0.14,0-2.27-.53-0.17,0-1-.21h0L67,51.67l-0.18,0-0.71-.15-0.18,0-0.75-.15-0.15,0-0.55-.11-0.18,0L63.68,51l-0.12.42,0,0.14-0.09.32-0.05.18-0.09.31-0.06.22-0.09.32-0.06.23-0.1.35-0.07.24-0.1.39-0.06.24-0.12.47-0.08.31-0.14.56L62.33,56l-0.11.45-0.08.32L62,57.2l-0.09.36-0.1.42-0.09.38-0.1.45-0.09.39-0.11.48-0.09.38-0.13.56-0.11.51L61,61.86l-0.08.4-0.11.55-0.1.46-0.1.51-0.1.49-0.1.52-0.1.5-0.1.54-0.09.5L60,66.9l-0.09.51-0.11.65-0.09.51-0.17,1-0.08.5-0.1.64-0.08.54-0.1.63-0.08.56L59,73.06l-0.08.58-0.09.64-0.08.57-0.09.68-0.07.56-0.09.76-0.06.5q-0.32,2.66-.56,5.48V83q-0.07.84-.13,1.71v0q-0.06.84-.11,1.71v0.08q-0.05.85-.09,1.73v0c-0.15,3-.21,6.22-0.15,9.54a127.22,127.22,0,0,0,.85,12.72c0,0.35.08,0.7,0.13,1.06a103,103,0,0,0,3.61,17,114.36,114.36,0,0,0,5.25,13.18c0.86,1.71,1.78,3.4,2.79,5.07,9.23,15.29,21.52,23,36.58,23,1,0,2.09,0,3.15-.11a55.64,55.64,0,0,0,20.21-5.6c4.93-24.48-8.37-59.28-36.07-88.3A163.2,163.2,0,0,0,81.71,64.4c9.22,6.92,13.87,10.66,19.22,16.27,37.83,39.64,49.7,89.72,26.51,111.86A35.67,35.67,0,0,1,115.52,200a36.48,36.48,0,0,0,15.42-8.64,34.66,34.66,0,0,0,3.76-4.24A97.3,97.3,0,0,0,171,33.85Z"></path><path d="M331.33,44.3H257v14h28.71v95.91h6.22a10.58,10.58,0,0,0,10.58-10.58V58.33h28.87v-14Z"></path><path d="M363,70.23q-15.82,0-25.45,5.55v15.5a41.61,41.61,0,0,1,24-7.34q9.46,0,13.54,4.32t4.08,12.8v4.73h-13.7q-16.15,0-25.12,6.61t-9,18.51a22.75,22.75,0,0,0,7.1,17.21q7.1,6.77,18.84,6.77,16,0,22.35-10.44v9.79h5.24a10.58,10.58,0,0,0,10.58-10.58V101.72Q395.44,70.24,363,70.23Zm16.15,56.44A15,15,0,0,1,374.64,138q-4.49,4.32-12.32,4.32-6.85,0-10.44-3.26a11.51,11.51,0,0,1-3.59-9,11.07,11.07,0,0,1,4.65-9.13q4.65-3.59,13.78-3.59h12.4v9.3Z"></path><path d="M534.45,70.4q-17.62,0-28.38,12.32T495.3,113.62q0,18.27,10.44,30.18t28.71,11.91q18.43,0,29-12.07T573.92,113q0-18.6-10.28-30.58T534.45,70.4ZM551.33,134q-5.79,8.16-16.88,8.16a19.21,19.21,0,0,1-16.47-8.4q-6-8.4-6-20.63,0-12.39,5.87-20.8t16.47-8.4q11.74,0,17.29,8.24t5.55,21.12Q557.12,125.86,551.33,134Z"></path><path d="M638,70.4q-18.43,0-25.77,15.33V82.12a10.58,10.58,0,0,0-10.58-10.58h-5.4v82.7h5.4a10.58,10.58,0,0,0,10.58-10.58V109.38q0-11.9,6-18.51a19,19,0,0,1,14.52-6.61q7.18,0,11.5,4.57T648.63,102v41.62a10.58,10.58,0,0,0,10.58,10.58h5.4V98.29q0-12.88-7.18-20.39T638,70.4Z"></path><path d="M854.92,70.4q-17.62,0-28.38,12.32t-10.77,30.91q0,18.27,10.44,30.18t28.71,11.91q18.43,0,29-12.07T894.39,113q0-18.6-10.28-30.58T854.92,70.4ZM871.8,134q-5.79,8.16-16.88,8.16a19.21,19.21,0,0,1-16.47-8.4q-6-8.4-6-20.63,0-12.39,5.87-20.8t16.47-8.4q11.74,0,17.29,8.24t5.55,21.12Q877.59,125.86,871.8,134Z"></path><path d="M930.53,86.06V82.12a10.58,10.58,0,0,0-10.58-10.58h-5.4v82.7h5.4a10.58,10.58,0,0,0,10.58-10.58V110.2a28.71,28.71,0,0,1,5.38-17.45q5.38-7.34,13.7-7.34a19.28,19.28,0,0,1,7.67,1.47V70.72h-5.06Q936.56,70.72,930.53,86.06Z"></path><path d="M1098.05,117.36q-5.47-5.3-15.09-9.54-0.82-.32-2.85-1.22t-2.85-1.31l-2.53-1.22a14.1,14.1,0,0,1-2.45-1.39q-0.73-.57-2-1.39a7.19,7.19,0,0,1-1.88-1.55,19.29,19.29,0,0,1-1.22-1.79,7.05,7.05,0,0,1-.9-2.12,9.75,9.75,0,0,1-.24-2.2,8.28,8.28,0,0,1,3.34-6.85q3.34-2.61,9.05-2.61,12.56,0,20.55,4.73V74.38q-7.5-3.59-20.88-3.59-12.23,0-20.39,6.2t-8.16,17.13q0,15.5,19.41,23.49,6.85,2.94,9.71,4.32a20.51,20.51,0,0,1,5.63,4.24,9,9,0,0,1,2.77,6.44,8.14,8.14,0,0,1-3.51,6.85q-3.51,2.61-9.87,2.61a44.58,44.58,0,0,1-23.65-7v15.17q9.79,4.89,24.47,4.89,13.37,0,21.21-6.28t7.83-17.37Q1103.52,122.66,1098.05,117.36Z"></path><path d="M475.53,71.38a14.11,14.11,0,0,0-11.65,6.16l-15,22-15-22a14.11,14.11,0,0,0-11.65-6.16H411.54l28.27,41.43-28.27,41.43h10.65a14.11,14.11,0,0,0,11.65-6.16l15-22,15,22a14.11,14.11,0,0,0,11.65,6.16h10.65l-28.27-41.43,28.27-41.43H475.53Z"></path><path d="M1025.71,71.38a14.11,14.11,0,0,0-11.65,6.16l-23.63,34.63V54.88A10.58,10.58,0,0,0,979.85,44.3h-5.51V154.24h5.51a10.58,10.58,0,0,0,10.58-10.58v-30.2l23.63,34.63a14.11,14.11,0,0,0,11.65,6.16h10.65l-28.27-41.43,28.27-41.43h-10.65Z"></path><path d="M792,52.2L773.51,123,755,52.2a10.58,10.58,0,0,0-10.24-7.9h0a10.58,10.58,0,0,0-10.24,7.9L716,123,697.48,52.2a10.58,10.58,0,0,0-10.24-7.9h-8.17l28.76,109.94H716a10.58,10.58,0,0,0,10.24-7.9l18.52-70.8,18.52,70.8a10.58,10.58,0,0,0,10.24,7.9h8.17L810.44,44.3h-8.17A10.58,10.58,0,0,0,792,52.2Z"></path>',16)])])}const Sc=In(jc,[["render",Ac]]),Ic={class:"btn-submenu"},Cc={key:0,class:"submenu"},Ec=["href"],Pc={__name:"AppHeaderSubmenu",props:{label:{type:String,required:!0},submenu:{type:Array,default:()=>[]}},setup(e){const n=wn(!1);return(t,r)=>(te(),fe("div",{class:"menu-wrapper",onMouseenter:r[0]||(r[0]=i=>n.value=!0),onMouseleave:r[1]||(r[1]=i=>n.value=!1)},[Z("button",Ic,[Zo(Hn(e.label)+" ",1),r[2]||(r[2]=Z("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:""},[Z("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"m19.5 8.25-7.5 7.5-7.5-7.5"})],-1))]),n.value?(te(),fe("ul",Cc,[(te(!0),fe(xe,null,Eo(e.submenu,({label:i,href:o})=>(te(),fe("li",{key:o},[Z("a",{href:o,target:"_blank",rel:"noopener noreferrer"},Hn(i),9,Ec)]))),128))])):es("",!0)],32))}},Rc=In(Pc,[["__scopeId","data-v-6d4a3c28"]]),qc={class:"app-header"},Oc={class:"app-header__left"},kc={class:"app-header__links"},Nc={__name:"AppHeader",setup(e){const n=[{label:"Code",href:"https://github.com/SpeciesFileGroup/taxonworks"},{label:"Docs",href:"https://github.com/SpeciesFileGroup/taxonworks_docs"},{label:"API",href:"https://github.com/SpeciesFileGroup/taxonworks_api"}];return(t,r)=>(te(),fe("header",qc,[Z("div",Oc,[le(Sc,{alt:"TaxonWorks",class:"app-header__logo"}),r[0]||(r[0]=Z("div",{class:"app-header__title"},"API Documentation",-1))]),Z("div",kc,[r[1]||(r[1]=Z("a",{href:"http://www.speciesfilegroup.org/"},"Species File Group",-1)),le(Rc,{label:"GitHub",submenu:n})])]))}},Fc=In(Nc,[["__scopeId","data-v-dfb139de"]]),$c={class:"resource-selector"},Dc={class:"resource-selector__overview"},Gc={class:"resource-selector__search"},Mc={class:"resource-selector__list"},Lc=["onClick"],Uc={__name:"ResourceSelector",props:up({resources:{type:Array,required:!0}},{modelValue:{type:String,default:null},modelModifiers:{}}),emits:["update:modelValue"],setup(e){const n=e,t=xp(e,"modelValue"),r=wn(""),i=is(()=>{const o=r.value.toLowerCase();return o?n.resources.filter(s=>s.label.toLowerCase().includes(o)):n.resources});return(o,s)=>(te(),fe("aside",$c,[Z("div",Dc,[Z("button",{class:Kn(["resource-selector__item resource-selector__overview-btn",{"resource-selector__item--active":t.value==="overview"}]),onClick:s[0]||(s[0]=()=>t.value="overview")}," Overview ",2)]),Z("div",Gc,[Ka(Z("input",{"onUpdate:modelValue":s[1]||(s[1]=a=>r.value=a),type:"text",placeholder:"Filter resources...",class:"resource-selector__input"},null,512),[[gc,r.value]])]),Z("nav",Mc,[(te(!0),fe(xe,null,Eo(i.value,a=>(te(),fe("button",{key:a.id,class:Kn(["resource-selector__item",{"resource-selector__item--active":a.id===t.value}]),onClick:()=>t.value=a.id},Hn(a.label),11,Lc))),128))])]))}},Bc=In(Uc,[["__scopeId","data-v-5b560293"]]);var Qt=Js();const Vc={class:"swagger-viewer"},Kc={key:0,class:"swagger-viewer__error"},Hc={__name:"SwaggerViewer",props:{spec:{type:Object,default:null},error:{type:String,default:null}},setup(e){const n=e,t=wn(null);let r=null;function i(){r&&(t.value&&(t.value.innerHTML=""),r=null)}Mn(()=>n.spec,s=>{!s||!t.value||o(s)});function o(s){i(),r=Qt.SwaggerUIBundle({domNode:t.value,spec:s,layout:"BaseLayout",deepLinking:!0,presets:[Qt.SwaggerUIBundle.presets.apis],plugins:[Qt.SwaggerUIBundle.plugins.DownloadUrl]})}return $r(()=>{n.spec&&o(n.spec)}),Io(i),(s,a)=>(te(),fe("div",Vc,[e.error?(te(),fe("div",Kc,Hn(e.error),1)):es("",!0),Z("div",{ref_key:"swaggerEl",ref:t,class:"swagger-viewer__container"},null,512)]))}},Wc=In(Hc,[["__scopeId","data-v-f6ed4568"]]),Xc={class:"markdown-body"},Yc={__name:"overview",setup(e,{expose:n}){return n({frontmatter:{}}),(r,i)=>(te(),fe("div",Xc,[...i[0]||(i[0]=[Qo('<h1>TaxonWorks API</h1><p>A RESTful JSON-backed API for accessing and managing biodiversity data in <a href="https://taxonworks.org">TaxonWorks</a>.</p><p><em>Select a resource from the sidebar to explore its endpoints.</em></p><hr><h2>Authentication</h2><p>All API requests require authentication. Include <strong>one</strong> of the following combinations as query parameters or HTTP headers:</p><table><thead><tr><th>Method</th><th>Parameters</th><th>Use case</th></tr></thead><tbody><tr><td>Project token</td><td><code>project_token</code></td><td>Public/read-only access scoped to a project</td></tr><tr><td>User token</td><td><code>token</code> + <code>project_id</code></td><td>Full read access on behalf of a user</td></tr></tbody></table><p>Tokens are generated inside the TaxonWorks application under <em>Account &gt; API access</em> and <em>Project &gt; API access</em>.</p><h2>Pagination</h2><p>List endpoints are paginated. Control pagination with these query parameters:</p><table><thead><tr><th>Parameter</th><th>Default</th><th>Description</th></tr></thead><tbody><tr><td><code>page</code></td><td>1</td><td>Page number</td></tr><tr><td><code>per</code></td><td>50</td><td>Items per page (max 250)</td></tr></tbody></table><p>Pagination metadata is returned in the response headers: <code>Pagination-Total</code>, <code>Pagination-Total-Pages</code>, <code>Pagination-Page</code>, and <code>Pagination-Per-Page</code>.</p><h2>Servers</h2><ul><li><a href="https://sfg.taxonworks.org">sfg.taxonworks.org</a> — Species File Group production instance</li><li><a href="https://sandbox.taxonworks.org">sandbox.taxonworks.org</a> — Public sandbox for testing</li></ul><h2>Resources</h2><ul><li><a href="https://taxonworks.org">TaxonWorks project site</a></li><li><a href="https://docs.taxonworks.org">Documentation</a></li><li><a href="https://github.com/SpeciesFileGroup/taxonworks">Source code (GitHub)</a></li><li><a href="https://github.com/SpeciesFileGroup/taxonworks_api">API docs source (GitHub)</a></li></ul>',16)])]))}},zc=`openapi: 3.0.3
info:
...
`;function ss(e){return typeof e>"u"||e===null}function Pl(e){return typeof e=="object"&&e!==null}function Rl(e){return Array.isArray(e)?e:ss(e)?[]:[e]}function ql(e,n){var t,r,i,o;if(n)for(o=Object.keys(n),t=0,r=o.length;t<r;t+=1)i=o[t],e[i]=n[i];return e}function Ol(e,n){var t="",r;for(r=0;r<n;r+=1)t+=e;return t}function kl(e){return e===0&&Number.NEGATIVE_INFINITY===1/e}var Nl=ss,Fl=Pl,$l=Rl,Dl=Ol,Gl=kl,Ml=ql,J={isNothing:Nl,isObject:Fl,toArray:$l,repeat:Dl,isNegativeZero:Gl,extend:Ml};function as(e,n){var t="",r=e.reason||"(unknown reason)";return e.mark?(e.mark.name&&(t+='in "'+e.mark.name+'" '),t+="("+(e.mark.line+1)+":"+(e.mark.column+1)+")",!n&&e.mark.snippet&&(t+=`

`+e.mark.snippet),r+" "+t):r}function Zn(e,n){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=n,this.message=as(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}Zn.prototype=Object.create(Error.prototype);Zn.prototype.constructor=Zn;Zn.prototype.toString=function(n){return this.name+": "+as(this,n)};var ce=Zn;function er(e,n,t,r,i){var o="",s="",a=Math.floor(i/2)-1;return r-n>a&&(o=" ... ",n=r-a+o.length),t-r>a&&(s=" ...",t=r+a-s.length),{str:o+e.slice(n,t).replace(/\t/g,"→")+s,pos:r-n+o.length}}function nr(e,n){return J.repeat(" ",n-e.length)+e}function Ll(e,n){if(n=Object.create(n||null),!e.buffer)return null;n.maxLength||(n.maxLength=79),typeof n.indent!="number"&&(n.indent=1),typeof n.linesBefore!="number"&&(n.linesBefore=3),typeof n.linesAfter!="number"&&(n.linesAfter=2);for(var t=/\r?\n|\r|\0/g,r=[0],i=[],o,s=-1;o=t.exec(e.buffer);)i.push(o.index),r.push(o.index+o[0].length),e.position<=o.index&&s<0&&(s=r.length-2);s<0&&(s=r.length-1);var a="",p,d,l=Math.min(e.line+n.linesAfter,i.length).toString().length,u=n.maxLength-(n.indent+l+3);for(p=1;p<=n.linesBefore&&!(s-p<0);p++)d=er(e.buffer,r[s-p],i[s-p],e.position-(r[s]-r[s-p]),u),a=J.repeat(" ",n.indent)+nr((e.line-p+1).toString(),l)+" | "+d.str+`
`+a;for(d=er(e.buffer,r[s],i[s],e.position,u),a+=J.repeat(" ",n.indent)+nr((e.line+1).toString(),l)+" | "+d.str+`
`,a+=J.repeat("-",n.indent+l+3+d.pos)+`^
`,p=1;p<=n.linesAfter&&!(s+p>=i.length);p++)d=er(e.buffer,r[s+p],i[s+p],e.position-(r[s]-r[s+p]),u),a+=J.repeat(" ",n.indent)+nr((e.line+p+1).toString(),l)+" | "+d.str+`
`;return a.replace(/\n$/,"")}var Ul=Ll,Bl=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],Vl=["scalar","sequence","mapping"];function Kl(e){var n={};return e!==null&&Object.keys(e).forEach(function(t){e[t].forEach(function(r){n[String(r)]=t})}),n}function Hl(e,n){if(n=n||{},Object.keys(n).forEach(function(t){if(Bl.indexOf(t)===-1)throw new ce('Unknown option "'+t+'" is met in definition of "'+e+'" YAML type.')}),this.options=n,this.tag=e,this.kind=n.kind||null,this.resolve=n.resolve||function(){return!0},this.construct=n.construct||function(t){return t},this.instanceOf=n.instanceOf||null,this.predicate=n.predicate||null,this.represent=n.represent||null,this.representName=n.representName||null,this.defaultStyle=n.defaultStyle||null,this.multi=n.multi||!1,this.styleAliases=Kl(n.styleAliases||null),Vl.indexOf(this.kind)===-1)throw new ce('Unknown kind "'+this.kind+'" is specified for "'+e+'" YAML type.')}var Q=Hl;function Ri(e,n){var t=[];return e[n].forEach(function(r){var i=t.length;t.forEach(function(o,s){o.tag===r.tag&&o.kind===r.kind&&o.multi===r.multi&&(i=s)}),t[i]=r}),t}function Wl(){var e={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},n,t;function r(i){i.multi?(e.multi[i.kind].push(i),e.multi.fallback.push(i)):e[i.kind][i.tag]=e.fallback[i.tag]=i}for(n=0,t=arguments.length;n<t;n+=1)arguments[n].forEach(r);return e}function hr(e){return this.extend(e)}hr.prototype.extend=function(n){var t=[],r=[];if(n instanceof Q)r.push(n);else if(Array.isArray(n))r=r.concat(n);else if(n&&(Array.isArray(n.implicit)||Array.isArray(n.explicit)))n.implicit&&(t=t.concat(n.implicit)),n.explicit&&(r=r.concat(n.explicit));else throw new ce("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");t.forEach(function(o){if(!(o instanceof Q))throw new ce("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(o.loadKind&&o.loadKind!=="scalar")throw new ce("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(o.multi)throw new ce("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),r.forEach(function(o){if(!(o instanceof Q))throw new ce("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var i=Object.create(hr.prototype);return i.implicit=(this.implicit||[]).concat(t),i.explicit=(this.explicit||[]).concat(r),i.compiledImplicit=Ri(i,"implicit"),i.compiledExplicit=Ri(i,"explicit"),i.compiledTypeMap=Wl(i.compiledImplicit,i.compiledExplicit),i};var ps=hr,cs=new Q("tag:yaml.org,2002:str",{kind:"scalar",construct:function(e){return e!==null?e:""}}),ls=new Q("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(e){return e!==null?e:[]}}),ds=new Q("tag:yaml.org,2002:map",{kind:"mapping",construct:function(e){return e!==null?e:{}}}),us=new ps({explicit:[cs,ls,ds]});function Xl(e){if(e===null)return!0;var n=e.length;return n===1&&e==="~"||n===4&&(e==="null"||e==="Null"||e==="NULL")}function Yl(){return null}function zl(e){return e===null}var ms=new Q("tag:yaml.org,2002:null",{kind:"scalar",resolve:Xl,construct:Yl,predicate:zl,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function Jl(e){if(e===null)return!1;var n=e.length;return n===4&&(e==="true"||e==="True"||e==="TRUE")||n===5&&(e==="false"||e==="False"||e==="FALSE")}function Zl(e){return e==="true"||e==="True"||e==="TRUE"}function Ql(e){return Object.prototype.toString.call(e)==="[object Boolean]"}var ys=new Q("tag:yaml.org,2002:bool",{kind:"scalar",resolve:Jl,construct:Zl,predicate:Ql,represent:{lowercase:function(e){return e?"true":"false"},uppercase:function(e){return e?"TRUE":"FALSE"},camelcase:function(e){return e?"True":"False"}},defaultStyle:"lowercase"});function ed(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function nd(e){return 48<=e&&e<=55}function td(e){return 48<=e&&e<=57}function rd(e){if(e===null)return!1;var n=e.length,t=0,r=!1,i;if(!n)return!1;if(i=e[t],(i==="-"||i==="+")&&(i=e[++t]),i==="0"){if(t+1===n)return!0;if(i=e[++t],i==="b"){for(t++;t<n;t++)if(i=e[t],i!=="_"){if(i!=="0"&&i!=="1")return!1;r=!0}return r&&i!=="_"}if(i==="x"){for(t++;t<n;t++)if(i=e[t],i!=="_"){if(!ed(e.charCodeAt(t)))return!1;r=!0}return r&&i!=="_"}if(i==="o"){for(t++;t<n;t++)if(i=e[t],i!=="_"){if(!nd(e.charCodeAt(t)))return!1;r=!0}return r&&i!=="_"}}if(i==="_")return!1;for(;t<n;t++)if(i=e[t],i!=="_"){if(!td(e.charCodeAt(t)))return!1;r=!0}return!(!r||i==="_")}function id(e){var n=e,t=1,r;if(n.indexOf("_")!==-1&&(n=n.replace(/_/g,"")),r=n[0],(r==="-"||r==="+")&&(r==="-"&&(t=-1),n=n.slice(1),r=n[0]),n==="0")return 0;if(r==="0"){if(n[1]==="b")return t*parseInt(n.slice(2),2);if(n[1]==="x")return t*parseInt(n.slice(2),16);if(n[1]==="o")return t*parseInt(n.slice(2),8)}return t*parseInt(n,10)}function od(e){return Object.prototype.toString.call(e)==="[object Number]"&&e%1===0&&!J.isNegativeZero(e)}var hs=new Q("tag:yaml.org,2002:int",{kind:"scalar",resolve:rd,construct:id,predicate:od,represent:{binary:function(e){return e>=0?"0b"+e.toString(2):"-0b"+e.toString(2).slice(1)},octal:function(e){return e>=0?"0o"+e.toString(8):"-0o"+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?"0x"+e.toString(16).toUpperCase():"-0x"+e.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),sd=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function ad(e){return!(e===null||!sd.test(e)||e[e.length-1]==="_")}function pd(e){var n,t;return n=e.replace(/_/g,"").toLowerCase(),t=n[0]==="-"?-1:1,"+-".indexOf(n[0])>=0&&(n=n.slice(1)),n===".inf"?t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:n===".nan"?NaN:t*parseFloat(n,10)}var cd=/^[-+]?[0-9]+e/;function ld(e,n){var t;if(isNaN(e))switch(n){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===e)switch(n){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===e)switch(n){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(J.isNegativeZero(e))return"-0.0";return t=e.toString(10),cd.test(t)?t.replace("e",".e"):t}function dd(e){return Object.prototype.toString.call(e)==="[object Number]"&&(e%1!==0||J.isNegativeZero(e))}var fs=new Q("tag:yaml.org,2002:float",{kind:"scalar",resolve:ad,construct:pd,predicate:dd,represent:ld,defaultStyle:"lowercase"}),gs=us.extend({implicit:[ms,ys,hs,fs]}),bs=gs,_s=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),xs=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function ud(e){return e===null?!1:_s.exec(e)!==null||xs.exec(e)!==null}function md(e){var n,t,r,i,o,s,a,p=0,d=null,l,u,h;if(n=_s.exec(e),n===null&&(n=xs.exec(e)),n===null)throw new Error("Date resolve error");if(t=+n[1],r=+n[2]-1,i=+n[3],!n[4])return new Date(Date.UTC(t,r,i));if(o=+n[4],s=+n[5],a=+n[6],n[7]){for(p=n[7].slice(0,3);p.length<3;)p+="0";p=+p}return n[9]&&(l=+n[10],u=+(n[11]||0),d=(l*60+u)*6e4,n[9]==="-"&&(d=-d)),h=new Date(Date.UTC(t,r,i,o,s,a,p)),d&&h.setTime(h.getTime()-d),h}function yd(e){return e.toISOString()}var Ts=new Q("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:ud,construct:md,instanceOf:Date,represent:yd});function hd(e){return e==="<<"||e===null}var vs=new Q("tag:yaml.org,2002:merge",{kind:"scalar",resolve:hd}),Lr=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function fd(e){if(e===null)return!1;var n,t,r=0,i=e.length,o=Lr;for(t=0;t<i;t++)if(n=o.indexOf(e.charAt(t)),!(n>64)){if(n<0)return!1;r+=6}return r%8===0}function gd(e){var n,t,r=e.replace(/[\r\n=]/g,""),i=r.length,o=Lr,s=0,a=[];for(n=0;n<i;n++)n%4===0&&n&&(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)),s=s<<6|o.indexOf(r.charAt(n));return t=i%4*6,t===0?(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)):t===18?(a.push(s>>10&255),a.push(s>>2&255)):t===12&&a.push(s>>4&255),new Uint8Array(a)}function bd(e){var n="",t=0,r,i,o=e.length,s=Lr;for(r=0;r<o;r++)r%3===0&&r&&(n+=s[t>>18&63],n+=s[t>>12&63],n+=s[t>>6&63],n+=s[t&63]),t=(t<<8)+e[r];return i=o%3,i===0?(n+=s[t>>18&63],n+=s[t>>12&63],n+=s[t>>6&63],n+=s[t&63]):i===2?(n+=s[t>>10&63],n+=s[t>>4&63],n+=s[t<<2&63],n+=s[64]):i===1&&(n+=s[t>>2&63],n+=s[t<<4&63],n+=s[64],n+=s[64]),n}function _d(e){return Object.prototype.toString.call(e)==="[object Uint8Array]"}var js=new Q("tag:yaml.org,2002:binary",{kind:"scalar",resolve:fd,construct:gd,predicate:_d,represent:bd}),xd=Object.prototype.hasOwnProperty,Td=Object.prototype.toString;function vd(e){if(e===null)return!0;var n=[],t,r,i,o,s,a=e;for(t=0,r=a.length;t<r;t+=1){if(i=a[t],s=!1,Td.call(i)!=="[object Object]")return!1;for(o in i)if(xd.call(i,o))if(!s)s=!0;else return!1;if(!s)return!1;if(n.indexOf(o)===-1)n.push(o);else return!1}return!0}function jd(e){return e!==null?e:[]}var ws=new Q("tag:yaml.org,2002:omap",{kind:"sequence",resolve:vd,construct:jd}),wd=Object.prototype.toString;function Ad(e){if(e===null)return!0;var n,t,r,i,o,s=e;for(o=new Array(s.length),n=0,t=s.length;n<t;n+=1){if(r=s[n],wd.call(r)!=="[object Object]"||(i=Object.keys(r),i.length!==1))return!1;o[n]=[i[0],r[i[0]]]}return!0}function Sd(e){if(e===null)return[];var n,t,r,i,o,s=e;for(o=new Array(s.length),n=0,t=s.length;n<t;n+=1)r=s[n],i=Object.keys(r),o[n]=[i[0],r[i[0]]];return o}var As=new Q("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:Ad,construct:Sd}),Id=Object.prototype.hasOwnProperty;function Cd(e){if(e===null)return!0;var n,t=e;for(n in t)if(Id.call(t,n)&&t[n]!==null)return!1;return!0}function Ed(e){return e!==null?e:{}}var Ss=new Q("tag:yaml.org,2002:set",{kind:"mapping",resolve:Cd,construct:Ed}),Ur=bs.extend({implicit:[Ts,vs],explicit:[js,ws,As,Ss]}),en=Object.prototype.hasOwnProperty,At=1,Is=2,Cs=3,St=4,tr=1,Pd=2,qi=3,Rd=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,qd=/[\x85\u2028\u2029]/,Od=/[,\[\]\{\}]/,Es=/^(?:!|!!|![a-z\-]+!)$/i,Ps=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Oi(e){return Object.prototype.toString.call(e)}function ke(e){return e===10||e===13}function dn(e){return e===9||e===32}function ge(e){return e===9||e===32||e===10||e===13}function gn(e){return e===44||e===91||e===93||e===123||e===125}function kd(e){var n;return 48<=e&&e<=57?e-48:(n=e|32,97<=n&&n<=102?n-97+10:-1)}function Nd(e){return e===120?2:e===117?4:e===85?8:0}function Fd(e){return 48<=e&&e<=57?e-48:-1}function ki(e){return e===48?"\0":e===97?"\x07":e===98?"\b":e===116||e===9?"	":e===110?`
`:e===118?"\v":e===102?"\f":e===114?"\r":e===101?"\x1B":e===32?" ":e===34?'"':e===47?"/":e===92?"\\":e===78?"":e===95?" ":e===76?"\u2028":e===80?"\u2029":""}function $d(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function Rs(e,n,t){n==="__proto__"?Object.defineProperty(e,n,{configurable:!0,enumerable:!0,writable:!0,value:t}):e[n]=t}var qs=new Array(256),Os=new Array(256);for(var mn=0;mn<256;mn++)qs[mn]=ki(mn)?1:0,Os[mn]=ki(mn);function Dd(e,n){this.input=e,this.filename=n.filename||null,this.schema=n.schema||Ur,this.onWarning=n.onWarning||null,this.legacy=n.legacy||!1,this.json=n.json||!1,this.listener=n.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.firstTabInLine=-1,this.documents=[]}function ks(e,n){var t={name:e.filename,buffer:e.input.slice(0,-1),position:e.position,line:e.line,column:e.position-e.lineStart};return t.snippet=Ul(t),new ce(n,t)}function C(e,n){throw ks(e,n)}function It(e,n){e.onWarning&&e.onWarning.call(null,ks(e,n))}var Ni={YAML:function(n,t,r){var i,o,s;n.version!==null&&C(n,"duplication of %YAML directive"),r.length!==1&&C(n,"YAML directive accepts exactly one argument"),i=/^([0-9]+)\.([0-9]+)$/.exec(r[0]),i===null&&C(n,"ill-formed argument of the YAML directive"),o=parseInt(i[1],10),s=parseInt(i[2],10),o!==1&&C(n,"unacceptable YAML version of the document"),n.version=r[0],n.checkLineBreaks=s<2,s!==1&&s!==2&&It(n,"unsupported YAML version of the document")},TAG:function(n,t,r){var i,o;r.length!==2&&C(n,"TAG directive accepts exactly two arguments"),i=r[0],o=r[1],Es.test(i)||C(n,"ill-formed tag handle (first argument) of the TAG directive"),en.call(n.tagMap,i)&&C(n,'there is a previously declared suffix for "'+i+'" tag handle'),Ps.test(o)||C(n,"ill-formed tag prefix (second argument) of the TAG directive");try{o=decodeURIComponent(o)}catch{C(n,"tag prefix is malformed: "+o)}n.tagMap[i]=o}};function Ze(e,n,t,r){var i,o,s,a;if(n<t){if(a=e.input.slice(n,t),r)for(i=0,o=a.length;i<o;i+=1)s=a.charCodeAt(i),s===9||32<=s&&s<=1114111||C(e,"expected valid JSON character");else Rd.test(a)&&C(e,"the stream contains non-printable characters");e.result+=a}}function Fi(e,n,t,r){var i,o,s,a;for(J.isObject(t)||C(e,"cannot merge mappings; the provided source object is unacceptable"),i=Object.keys(t),s=0,a=i.length;s<a;s+=1)o=i[s],en.call(n,o)||(Rs(n,o,t[o]),r[o]=!0)}function bn(e,n,t,r,i,o,s,a,p){var d,l;if(Array.isArray(i))for(i=Array.prototype.slice.call(i),d=0,l=i.length;d<l;d+=1)Array.isArray(i[d])&&C(e,"nested arrays are not supported inside keys"),typeof i=="object"&&Oi(i[d])==="[object Object]"&&(i[d]="[object Object]");if(typeof i=="object"&&Oi(i)==="[object Object]"&&(i="[object Object]"),i=String(i),n===null&&(n={}),r==="tag:yaml.org,2002:merge")if(Array.isArray(o))for(d=0,l=o.length;d<l;d+=1)Fi(e,n,o[d],t);else Fi(e,n,o,t);else!e.json&&!en.call(t,i)&&en.call(n,i)&&(e.line=s||e.line,e.lineStart=a||e.lineStart,e.position=p||e.position,C(e,"duplicated mapping key")),Rs(n,i,o),delete t[i];return n}function Br(e){var n;n=e.input.charCodeAt(e.position),n===10?e.position++:n===13?(e.position++,e.input.charCodeAt(e.position)===10&&e.position++):C(e,"a line break is expected"),e.line+=1,e.lineStart=e.position,e.firstTabInLine=-1}function X(e,n,t){for(var r=0,i=e.input.charCodeAt(e.position);i!==0;){for(;dn(i);)i===9&&e.firstTabInLine===-1&&(e.firstTabInLine=e.position),i=e.input.charCodeAt(++e.position);if(n&&i===35)do i=e.input.charCodeAt(++e.position);while(i!==10&&i!==13&&i!==0);if(ke(i))for(Br(e),i=e.input.charCodeAt(e.position),r++,e.lineIndent=0;i===32;)e.lineIndent++,i=e.input.charCodeAt(++e.position);else break}return t!==-1&&r!==0&&e.lineIndent<t&&It(e,"deficient indentation"),r}function Mt(e){var n=e.position,t;return t=e.input.charCodeAt(n),!!((t===45||t===46)&&t===e.input.charCodeAt(n+1)&&t===e.input.charCodeAt(n+2)&&(n+=3,t=e.input.charCodeAt(n),t===0||ge(t)))}function Vr(e,n){n===1?e.result+=" ":n>1&&(e.result+=J.repeat(`
`,n-1))}function Gd(e,n,t){var r,i,o,s,a,p,d,l,u=e.kind,h=e.result,f;if(f=e.input.charCodeAt(e.position),ge(f)||gn(f)||f===35||f===38||f===42||f===33||f===124||f===62||f===39||f===34||f===37||f===64||f===96||(f===63||f===45)&&(i=e.input.charCodeAt(e.position+1),ge(i)||t&&gn(i)))return!1;for(e.kind="scalar",e.result="",o=s=e.position,a=!1;f!==0;){if(f===58){if(i=e.input.charCodeAt(e.position+1),ge(i)||t&&gn(i))break}else if(f===35){if(r=e.input.charCodeAt(e.position-1),ge(r))break}else{if(e.position===e.lineStart&&Mt(e)||t&&gn(f))break;if(ke(f))if(p=e.line,d=e.lineStart,l=e.lineIndent,X(e,!1,-1),e.lineIndent>=n){a=!0,f=e.input.charCodeAt(e.position);continue}else{e.position=s,e.line=p,e.lineStart=d,e.lineIndent=l;break}}a&&(Ze(e,o,s,!1),Vr(e,e.line-p),o=s=e.position,a=!1),dn(f)||(s=e.position+1),f=e.input.charCodeAt(++e.position)}return Ze(e,o,s,!1),e.result?!0:(e.kind=u,e.result=h,!1)}function Md(e,n){var t,r,i;if(t=e.input.charCodeAt(e.position),t!==39)return!1;for(e.kind="scalar",e.result="",e.position++,r=i=e.position;(t=e.input.charCodeAt(e.position))!==0;)if(t===39)if(Ze(e,r,e.position,!0),t=e.input.charCodeAt(++e.position),t===39)r=e.position,e.position++,i=e.position;else return!0;else ke(t)?(Ze(e,r,i,!0),Vr(e,X(e,!1,n)),r=i=e.position):e.position===e.lineStart&&Mt(e)?C(e,"unexpected end of the document within a single quoted scalar"):(e.position++,i=e.position);C(e,"unexpected end of the stream within a single quoted scalar")}function Ld(e,n){var t,r,i,o,s,a;if(a=e.input.charCodeAt(e.position),a!==34)return!1;for(e.kind="scalar",e.result="",e.position++,t=r=e.position;(a=e.input.charCodeAt(e.position))!==0;){if(a===34)return Ze(e,t,e.position,!0),e.position++,!0;if(a===92){if(Ze(e,t,e.position,!0),a=e.input.charCodeAt(++e.position),ke(a))X(e,!1,n);else if(a<256&&qs[a])e.result+=Os[a],e.position++;else if((s=Nd(a))>0){for(i=s,o=0;i>0;i--)a=e.input.charCodeAt(++e.position),(s=kd(a))>=0?o=(o<<4)+s:C(e,"expected hexadecimal character");e.result+=$d(o),e.position++}else C(e,"unknown escape sequence");t=r=e.position}else ke(a)?(Ze(e,t,r,!0),Vr(e,X(e,!1,n)),t=r=e.position):e.position===e.lineStart&&Mt(e)?C(e,"unexpected end of the document within a double quoted scalar"):(e.position++,r=e.position)}C(e,"unexpected end of the stream within a double quoted scalar")}function Ud(e,n){var t=!0,r,i,o,s=e.tag,a,p=e.anchor,d,l,u,h,f,S=Object.create(null),v,k,F,I;if(I=e.input.charCodeAt(e.position),I===91)l=93,f=!1,a=[];else if(I===123)l=125,f=!0,a={};else return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=a),I=e.input.charCodeAt(++e.position);I!==0;){if(X(e,!0,n),I=e.input.charCodeAt(e.position),I===l)return e.position++,e.tag=s,e.anchor=p,e.kind=f?"mapping":"sequence",e.result=a,!0;t?I===44&&C(e,"expected the node content, but found ','"):C(e,"missed comma between flow collection entries"),k=v=F=null,u=h=!1,I===63&&(d=e.input.charCodeAt(e.position+1),ge(d)&&(u=h=!0,e.position++,X(e,!0,n))),r=e.line,i=e.lineStart,o=e.position,Sn(e,n,At,!1,!0),k=e.tag,v=e.result,X(e,!0,n),I=e.input.charCodeAt(e.position),(h||e.line===r)&&I===58&&(u=!0,I=e.input.charCodeAt(++e.position),X(e,!0,n),Sn(e,n,At,!1,!0),F=e.result),f?bn(e,a,S,k,v,F,r,i,o):u?a.push(bn(e,null,S,k,v,F,r,i,o)):a.push(v),X(e,!0,n),I=e.input.charCodeAt(e.position),I===44?(t=!0,I=e.input.charCodeAt(++e.position)):t=!1}C(e,"unexpected end of the stream within a flow collection")}function Bd(e,n){var t,r,i=tr,o=!1,s=!1,a=n,p=0,d=!1,l,u;if(u=e.input.charCodeAt(e.position),u===124)r=!1;else if(u===62)r=!0;else return!1;for(e.kind="scalar",e.result="";u!==0;)if(u=e.input.charCodeAt(++e.position),u===43||u===45)tr===i?i=u===43?qi:Pd:C(e,"repeat of a chomping mode identifier");else if((l=Fd(u))>=0)l===0?C(e,"bad explicit indentation width of a block scalar; it cannot be less than one"):s?C(e,"repeat of an indentation width identifier"):(a=n+l-1,s=!0);else break;if(dn(u)){do u=e.input.charCodeAt(++e.position);while(dn(u));if(u===35)do u=e.input.charCodeAt(++e.position);while(!ke(u)&&u!==0)}for(;u!==0;){for(Br(e),e.lineIndent=0,u=e.input.charCodeAt(e.position);(!s||e.lineIndent<a)&&u===32;)e.lineIndent++,u=e.input.charCodeAt(++e.position);if(!s&&e.lineIndent>a&&(a=e.lineIndent),ke(u)){p++;continue}if(e.lineIndent<a){i===qi?e.result+=J.repeat(`
`,o?1+p:p):i===tr&&o&&(e.result+=`
`);break}for(r?dn(u)?(d=!0,e.result+=J.repeat(`
`,o?1+p:p)):d?(d=!1,e.result+=J.repeat(`
`,p+1)):p===0?o&&(e.result+=" "):e.result+=J.repeat(`
`,p):e.result+=J.repeat(`
`,o?1+p:p),o=!0,s=!0,p=0,t=e.position;!ke(u)&&u!==0;)u=e.input.charCodeAt(++e.position);Ze(e,t,e.position,!1)}return!0}function $i(e,n){var t,r=e.tag,i=e.anchor,o=[],s,a=!1,p;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),p=e.input.charCodeAt(e.position);p!==0&&(e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,C(e,"tab characters must not be used in indentation")),!(p!==45||(s=e.input.charCodeAt(e.position+1),!ge(s))));){if(a=!0,e.position++,X(e,!0,-1)&&e.lineIndent<=n){o.push(null),p=e.input.charCodeAt(e.position);continue}if(t=e.line,Sn(e,n,Cs,!1,!0),o.push(e.result),X(e,!0,-1),p=e.input.charCodeAt(e.position),(e.line===t||e.lineIndent>n)&&p!==0)C(e,"bad indentation of a sequence entry");else if(e.lineIndent<n)break}return a?(e.tag=r,e.anchor=i,e.kind="sequence",e.result=o,!0):!1}function Vd(e,n,t){var r,i,o,s,a,p,d=e.tag,l=e.anchor,u={},h=Object.create(null),f=null,S=null,v=null,k=!1,F=!1,I;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=u),I=e.input.charCodeAt(e.position);I!==0;){if(!k&&e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,C(e,"tab characters must not be used in indentation")),r=e.input.charCodeAt(e.position+1),o=e.line,(I===63||I===58)&&ge(r))I===63?(k&&(bn(e,u,h,f,S,null,s,a,p),f=S=v=null),F=!0,k=!0,i=!0):k?(k=!1,i=!0):C(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,I=r;else{if(s=e.line,a=e.lineStart,p=e.position,!Sn(e,t,Is,!1,!0))break;if(e.line===o){for(I=e.input.charCodeAt(e.position);dn(I);)I=e.input.charCodeAt(++e.position);if(I===58)I=e.input.charCodeAt(++e.position),ge(I)||C(e,"a whitespace character is expected after the key-value separator within a block mapping"),k&&(bn(e,u,h,f,S,null,s,a,p),f=S=v=null),F=!0,k=!1,i=!1,f=e.tag,S=e.result;else if(F)C(e,"can not read an implicit mapping pair; a colon is missed");else return e.tag=d,e.anchor=l,!0}else if(F)C(e,"can not read a block mapping entry; a multiline key may not be an implicit key");else return e.tag=d,e.anchor=l,!0}if((e.line===o||e.lineIndent>n)&&(k&&(s=e.line,a=e.lineStart,p=e.position),Sn(e,n,St,!0,i)&&(k?S=e.result:v=e.result),k||(bn(e,u,h,f,S,v,s,a,p),f=S=v=null),X(e,!0,-1),I=e.input.charCodeAt(e.position)),(e.line===o||e.lineIndent>n)&&I!==0)C(e,"bad indentation of a mapping entry");else if(e.lineIndent<n)break}return k&&bn(e,u,h,f,S,null,s,a,p),F&&(e.tag=d,e.anchor=l,e.kind="mapping",e.result=u),F}function Kd(e){var n,t=!1,r=!1,i,o,s;if(s=e.input.charCodeAt(e.position),s!==33)return!1;if(e.tag!==null&&C(e,"duplication of a tag property"),s=e.input.charCodeAt(++e.position),s===60?(t=!0,s=e.input.charCodeAt(++e.position)):s===33?(r=!0,i="!!",s=e.input.charCodeAt(++e.position)):i="!",n=e.position,t){do s=e.input.charCodeAt(++e.position);while(s!==0&&s!==62);e.position<e.length?(o=e.input.slice(n,e.position),s=e.input.charCodeAt(++e.position)):C(e,"unexpected end of the stream within a verbatim tag")}else{for(;s!==0&&!ge(s);)s===33&&(r?C(e,"tag suffix cannot contain exclamation marks"):(i=e.input.slice(n-1,e.position+1),Es.test(i)||C(e,"named tag handle cannot contain such characters"),r=!0,n=e.position+1)),s=e.input.charCodeAt(++e.position);o=e.input.slice(n,e.position),Od.test(o)&&C(e,"tag suffix cannot contain flow indicator characters")}o&&!Ps.test(o)&&C(e,"tag name cannot contain such characters: "+o);try{o=decodeURIComponent(o)}catch{C(e,"tag name is malformed: "+o)}return t?e.tag=o:en.call(e.tagMap,i)?e.tag=e.tagMap[i]+o:i==="!"?e.tag="!"+o:i==="!!"?e.tag="tag:yaml.org,2002:"+o:C(e,'undeclared tag handle "'+i+'"'),!0}function Hd(e){var n,t;if(t=e.input.charCodeAt(e.position),t!==38)return!1;for(e.anchor!==null&&C(e,"duplication of an anchor property"),t=e.input.charCodeAt(++e.position),n=e.position;t!==0&&!ge(t)&&!gn(t);)t=e.input.charCodeAt(++e.position);return e.position===n&&C(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(n,e.position),!0}function Wd(e){var n,t,r;if(r=e.input.charCodeAt(e.position),r!==42)return!1;for(r=e.input.charCodeAt(++e.position),n=e.position;r!==0&&!ge(r)&&!gn(r);)r=e.input.charCodeAt(++e.position);return e.position===n&&C(e,"name of an alias node must contain at least one character"),t=e.input.slice(n,e.position),en.call(e.anchorMap,t)||C(e,'unidentified alias "'+t+'"'),e.result=e.anchorMap[t],X(e,!0,-1),!0}function Sn(e,n,t,r,i){var o,s,a,p=1,d=!1,l=!1,u,h,f,S,v,k;if(e.listener!==null&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,o=s=a=St===t||Cs===t,r&&X(e,!0,-1)&&(d=!0,e.lineIndent>n?p=1:e.lineIndent===n?p=0:e.lineIndent<n&&(p=-1)),p===1)for(;Kd(e)||Hd(e);)X(e,!0,-1)?(d=!0,a=o,e.lineIndent>n?p=1:e.lineIndent===n?p=0:e.lineIndent<n&&(p=-1)):a=!1;if(a&&(a=d||i),(p===1||St===t)&&(At===t||Is===t?v=n:v=n+1,k=e.position-e.lineStart,p===1?a&&($i(e,k)||Vd(e,k,v))||Ud(e,v)?l=!0:(s&&Bd(e,v)||Md(e,v)||Ld(e,v)?l=!0:Wd(e)?(l=!0,(e.tag!==null||e.anchor!==null)&&C(e,"alias node should not have any properties")):Gd(e,v,At===t)&&(l=!0,e.tag===null&&(e.tag="?")),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):p===0&&(l=a&&$i(e,k))),e.tag===null)e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);else if(e.tag==="?"){for(e.result!==null&&e.kind!=="scalar"&&C(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"'),u=0,h=e.implicitTypes.length;u<h;u+=1)if(S=e.implicitTypes[u],S.resolve(e.result)){e.result=S.construct(e.result),e.tag=S.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else if(e.tag!=="!"){if(en.call(e.typeMap[e.kind||"fallback"],e.tag))S=e.typeMap[e.kind||"fallback"][e.tag];else for(S=null,f=e.typeMap.multi[e.kind||"fallback"],u=0,h=f.length;u<h;u+=1)if(e.tag.slice(0,f[u].tag.length)===f[u].tag){S=f[u];break}S||C(e,"unknown tag !<"+e.tag+">"),e.result!==null&&S.kind!==e.kind&&C(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+S.kind+'", not "'+e.kind+'"'),S.resolve(e.result,e.tag)?(e.result=S.construct(e.result,e.tag),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):C(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")}return e.listener!==null&&e.listener("close",e),e.tag!==null||e.anchor!==null||l}function Xd(e){var n=e.position,t,r,i,o=!1,s;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap=Object.create(null),e.anchorMap=Object.create(null);(s=e.input.charCodeAt(e.position))!==0&&(X(e,!0,-1),s=e.input.charCodeAt(e.position),!(e.lineIndent>0||s!==37));){for(o=!0,s=e.input.charCodeAt(++e.position),t=e.position;s!==0&&!ge(s);)s=e.input.charCodeAt(++e.position);for(r=e.input.slice(t,e.position),i=[],r.length<1&&C(e,"directive name must not be less than one character in length");s!==0;){for(;dn(s);)s=e.input.charCodeAt(++e.position);if(s===35){do s=e.input.charCodeAt(++e.position);while(s!==0&&!ke(s));break}if(ke(s))break;for(t=e.position;s!==0&&!ge(s);)s=e.input.charCodeAt(++e.position);i.push(e.input.slice(t,e.position))}s!==0&&Br(e),en.call(Ni,r)?Ni[r](e,r,i):It(e,'unknown document directive "'+r+'"')}if(X(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,X(e,!0,-1)):o&&C(e,"directives end mark is expected"),Sn(e,e.lineIndent-1,St,!1,!0),X(e,!0,-1),e.checkLineBreaks&&qd.test(e.input.slice(n,e.position))&&It(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&Mt(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,X(e,!0,-1));return}if(e.position<e.length-1)C(e,"end of the stream or a document separator is expected");else return}function Ns(e,n){e=String(e),n=n||{},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
`),e.charCodeAt(0)===65279&&(e=e.slice(1)));var t=new Dd(e,n),r=e.indexOf("\0");for(r!==-1&&(t.position=r,C(t,"null byte is not allowed in input")),t.input+="\0";t.input.charCodeAt(t.position)===32;)t.lineIndent+=1,t.position+=1;for(;t.position<t.length-1;)Xd(t);return t.documents}function Yd(e,n,t){n!==null&&typeof n=="object"&&typeof t>"u"&&(t=n,n=null);var r=Ns(e,t);if(typeof n!="function")return r;for(var i=0,o=r.length;i<o;i+=1)n(r[i])}function zd(e,n){var t=Ns(e,n);if(t.length!==0){if(t.length===1)return t[0];throw new ce("expected a single document in the stream, but found more")}}var Jd=Yd,Zd=zd,Fs={loadAll:Jd,load:Zd},$s=Object.prototype.toString,Ds=Object.prototype.hasOwnProperty,Kr=65279,Qd=9,Qn=10,eu=13,nu=32,tu=33,ru=34,fr=35,iu=37,ou=38,su=39,au=42,Gs=44,pu=45,Ct=58,cu=61,lu=62,du=63,uu=64,Ms=91,Ls=93,mu=96,Us=123,yu=124,Bs=125,ie={};ie[0]="\\0";ie[7]="\\a";ie[8]="\\b";ie[9]="\\t";ie[10]="\\n";ie[11]="\\v";ie[12]="\\f";ie[13]="\\r";ie[27]="\\e";ie[34]='\\"';ie[92]="\\\\";ie[133]="\\N";ie[160]="\\_";ie[8232]="\\L";ie[8233]="\\P";var hu=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],fu=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function gu(e,n){var t,r,i,o,s,a,p;if(n===null)return{};for(t={},r=Object.keys(n),i=0,o=r.length;i<o;i+=1)s=r[i],a=String(n[s]),s.slice(0,2)==="!!"&&(s="tag:yaml.org,2002:"+s.slice(2)),p=e.compiledTypeMap.fallback[s],p&&Ds.call(p.styleAliases,a)&&(a=p.styleAliases[a]),t[s]=a;return t}function bu(e){var n,t,r;if(n=e.toString(16).toUpperCase(),e<=255)t="x",r=2;else if(e<=65535)t="u",r=4;else if(e<=4294967295)t="U",r=8;else throw new ce("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+t+J.repeat("0",r-n.length)+n}var _u=1,et=2;function xu(e){this.schema=e.schema||Ur,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=J.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=gu(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.quotingType=e.quotingType==='"'?et:_u,this.forceQuotes=e.forceQuotes||!1,this.replacer=typeof e.replacer=="function"?e.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Di(e,n){for(var t=J.repeat(" ",n),r=0,i=-1,o="",s,a=e.length;r<a;)i=e.indexOf(`
`,r),i===-1?(s=e.slice(r),r=a):(s=e.slice(r,i+1),r=i+1),s.length&&s!==`
`&&(o+=t),o+=s;return o}function gr(e,n){return`
`+J.repeat(" ",e.indent*n)}function Tu(e,n){var t,r,i;for(t=0,r=e.implicitTypes.length;t<r;t+=1)if(i=e.implicitTypes[t],i.resolve(n))return!0;return!1}function Et(e){return e===nu||e===Qd}function nt(e){return 32<=e&&e<=126||161<=e&&e<=55295&&e!==8232&&e!==8233||57344<=e&&e<=65533&&e!==Kr||65536<=e&&e<=1114111}function Gi(e){return nt(e)&&e!==Kr&&e!==eu&&e!==Qn}function Mi(e,n,t){var r=Gi(e),i=r&&!Et(e);return(t?r:r&&e!==Gs&&e!==Ms&&e!==Ls&&e!==Us&&e!==Bs)&&e!==fr&&!(n===Ct&&!i)||Gi(n)&&!Et(n)&&e===fr||n===Ct&&i}function vu(e){return nt(e)&&e!==Kr&&!Et(e)&&e!==pu&&e!==du&&e!==Ct&&e!==Gs&&e!==Ms&&e!==Ls&&e!==Us&&e!==Bs&&e!==fr&&e!==ou&&e!==au&&e!==tu&&e!==yu&&e!==cu&&e!==lu&&e!==su&&e!==ru&&e!==iu&&e!==uu&&e!==mu}function ju(e){return!Et(e)&&e!==Ct}function Fn(e,n){var t=e.charCodeAt(n),r;return t>=55296&&t<=56319&&n+1<e.length&&(r=e.charCodeAt(n+1),r>=56320&&r<=57343)?(t-55296)*1024+r-56320+65536:t}function Vs(e){var n=/^\n* /;return n.test(e)}var Ks=1,br=2,Hs=3,Ws=4,fn=5;function wu(e,n,t,r,i,o,s,a){var p,d=0,l=null,u=!1,h=!1,f=r!==-1,S=-1,v=vu(Fn(e,0))&&ju(Fn(e,e.length-1));if(n||s)for(p=0;p<e.length;d>=65536?p+=2:p++){if(d=Fn(e,p),!nt(d))return fn;v=v&&Mi(d,l,a),l=d}else{for(p=0;p<e.length;d>=65536?p+=2:p++){if(d=Fn(e,p),d===Qn)u=!0,f&&(h=h||p-S-1>r&&e[S+1]!==" ",S=p);else if(!nt(d))return fn;v=v&&Mi(d,l,a),l=d}h=h||f&&p-S-1>r&&e[S+1]!==" "}return!u&&!h?v&&!s&&!i(e)?Ks:o===et?fn:br:t>9&&Vs(e)?fn:s?o===et?fn:br:h?Ws:Hs}function Au(e,n,t,r,i){e.dump=(function(){if(n.length===0)return e.quotingType===et?'""':"''";if(!e.noCompatMode&&(hu.indexOf(n)!==-1||fu.test(n)))return e.quotingType===et?'"'+n+'"':"'"+n+"'";var o=e.indent*Math.max(1,t),s=e.lineWidth===-1?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-o),a=r||e.flowLevel>-1&&t>=e.flowLevel;function p(d){return Tu(e,d)}switch(wu(n,a,e.indent,s,p,e.quotingType,e.forceQuotes&&!r,i)){case Ks:return n;case br:return"'"+n.replace(/'/g,"''")+"'";case Hs:return"|"+Li(n,e.indent)+Ui(Di(n,o));case Ws:return">"+Li(n,e.indent)+Ui(Di(Su(n,s),o));case fn:return'"'+Iu(n)+'"';default:throw new ce("impossible error: invalid scalar style")}})()}function Li(e,n){var t=Vs(e)?String(n):"",r=e[e.length-1]===`
`,i=r&&(e[e.length-2]===`
`||e===`
`),o=i?"+":r?"":"-";return t+o+`
`}function Ui(e){return e[e.length-1]===`
`?e.slice(0,-1):e}function Su(e,n){for(var t=/(\n+)([^\n]*)/g,r=(function(){var d=e.indexOf(`
...
`+e.slice(s+1):p+=e.slice(i),p.slice(1)}function Iu(e){for(var n="",t=0,r,i=0;i<e.length;t>=65536?i+=2:i++)t=Fn(e,i),r=ie[t],!r&&nt(t)?(n+=e[i],t>=65536&&(n+=e[i+1])):n+=r||bu(t);return n}function Cu(e,n,t){var r="",i=e.tag,o,s,a;for(o=0,s=t.length;o<s;o+=1)a=t[o],e.replacer&&(a=e.replacer.call(t,String(o),a)),(He(e,n,a,!1,!1)||typeof a>"u"&&He(e,n,null,!1,!1))&&(r!==""&&(r+=","+(e.condenseFlow?"":" ")),r+=e.dump);e.tag=i,e.dump="["+r+"]"}function Vi(e,n,t,r){var i="",o=e.tag,s,a,p;for(s=0,a=t.length;s<a;s+=1)p=t[s],e.replacer&&(p=e.replacer.call(t,String(s),p)),(He(e,n+1,p,!0,!0,!1,!0)||typeof p>"u"&&He(e,n+1,null,!0,!0,!1,!0))&&((!r||i!=="")&&(i+=gr(e,n)),e.dump&&Qn===e.dump.charCodeAt(0)?i+="-":i+="- ",i+=e.dump);e.tag=o,e.dump=i||"[]"}function Eu(e,n,t){var r="",i=e.tag,o=Object.keys(t),s,a,p,d,l;for(s=0,a=o.length;s<a;s+=1)l="",r!==""&&(l+=", "),e.condenseFlow&&(l+='"'),p=o[s],d=t[p],e.replacer&&(d=e.replacer.call(t,p,d)),He(e,n,p,!1,!1)&&(e.dump.length>1024&&(l+="? "),l+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),He(e,n,d,!1,!1)&&(l+=e.dump,r+=l));e.tag=i,e.dump="{"+r+"}"}function Pu(e,n,t,r){var i="",o=e.tag,s=Object.keys(t),a,p,d,l,u,h;if(e.sortKeys===!0)s.sort();else if(typeof e.sortKeys=="function")s.sort(e.sortKeys);else if(e.sortKeys)throw new ce("sortKeys must be a boolean or a function");for(a=0,p=s.length;a<p;a+=1)h="",(!r||i!=="")&&(h+=gr(e,n)),d=s[a],l=t[d],e.replacer&&(l=e.replacer.call(t,d,l)),He(e,n+1,d,!0,!0,!0)&&(u=e.tag!==null&&e.tag!=="?"||e.dump&&e.dump.length>1024,u&&(e.dump&&Qn===e.dump.charCodeAt(0)?h+="?":h+="? "),h+=e.dump,u&&(h+=gr(e,n)),He(e,n+1,l,!0,u)&&(e.dump&&Qn===e.dump.charCodeAt(0)?h+=":":h+=": ",h+=e.dump,i+=h));e.tag=o,e.dump=i||"{}"}function Ki(e,n,t){var r,i,o,s,a,p;for(i=t?e.explicitTypes:e.implicitTypes,o=0,s=i.length;o<s;o+=1)if(a=i[o],(a.instanceOf||a.predicate)&&(!a.instanceOf||typeof n=="object"&&n instanceof a.instanceOf)&&(!a.predicate||a.predicate(n))){if(t?a.multi&&a.representName?e.tag=a.representName(n):e.tag=a.tag:e.tag="?",a.represent){if(p=e.styleMap[a.tag]||a.defaultStyle,$s.call(a.represent)==="[object Function]")r=a.represent(n,p);else if(Ds.call(a.represent,p))r=a.represent[p](n,p);else throw new ce("!<"+a.tag+'> tag resolver accepts not "'+p+'" style');e.dump=r}return!0}return!1}function He(e,n,t,r,i,o,s){e.tag=null,e.dump=t,Ki(e,t,!1)||Ki(e,t,!0);var a=$s.call(e.dump),p=r,d;r&&(r=e.flowLevel<0||e.flowLevel>n);var l=a==="[object Object]"||a==="[object Array]",u,h;if(l&&(u=e.duplicates.indexOf(t),h=u!==-1),(e.tag!==null&&e.tag!=="?"||h||e.indent!==2&&n>0)&&(i=!1),h&&e.usedDuplicates[u])e.dump="*ref_"+u;else{if(l&&h&&!e.usedDuplicates[u]&&(e.usedDuplicates[u]=!0),a==="[object Object]")r&&Object.keys(e.dump).length!==0?(Pu(e,n,e.dump,i),h&&(e.dump="&ref_"+u+e.dump)):(Eu(e,n,e.dump),h&&(e.dump="&ref_"+u+" "+e.dump));else if(a==="[object Array]")r&&e.dump.length!==0?(e.noArrayIndent&&!s&&n>0?Vi(e,n-1,e.dump,i):Vi(e,n,e.dump,i),h&&(e.dump="&ref_"+u+e.dump)):(Cu(e,n,e.dump),h&&(e.dump="&ref_"+u+" "+e.dump));else if(a==="[object String]")e.tag!=="?"&&Au(e,e.dump,n,o,p);else{if(a==="[object Undefined]")return!1;if(e.skipInvalid)return!1;throw new ce("unacceptable kind of an object to dump "+a)}e.tag!==null&&e.tag!=="?"&&(d=encodeURI(e.tag[0]==="!"?e.tag.slice(1):e.tag).replace(/!/g,"%21"),e.tag[0]==="!"?d="!"+d:d.slice(0,18)==="tag:yaml.org,2002:"?d="!!"+d.slice(18):d="!<"+d+">",e.dump=d+" "+e.dump)}return!0}function Ru(e,n){var t=[],r=[],i,o;for(_r(e,t,r),i=0,o=r.length;i<o;i+=1)n.duplicates.push(t[r[i]]);n.usedDuplicates=new Array(o)}function _r(e,n,t){var r,i,o;if(e!==null&&typeof e=="object")if(i=n.indexOf(e),i!==-1)t.indexOf(i)===-1&&t.push(i);else if(n.push(e),Array.isArray(e))for(i=0,o=e.length;i<o;i+=1)_r(e[i],n,t);else for(r=Object.keys(e),i=0,o=r.length;i<o;i+=1)_r(e[r[i]],n,t)}function qu(e,n){n=n||{};var t=new xu(n);t.noRefs||Ru(e,t);var r=e;return t.replacer&&(r=t.replacer.call({"":r},"",r)),He(t,0,r,!0,!0)?t.dump+`
`:""}var Ou=qu,ku={dump:Ou};function Hr(e,n){return function(){throw new Error("Function yaml."+e+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Nu=Q,Fu=ps,$u=us,Du=gs,Gu=bs,Mu=Ur,Lu=Fs.load,Uu=Fs.loadAll,Bu=ku.dump,Vu=ce,Ku={binary:js,float:fs,map:ds,null:ms,pairs:As,set:Ss,timestamp:Ts,bool:ys,int:hs,merge:vs,omap:ws,seq:ls,str:cs},Hu=Hr("safeLoad","load"),Wu=Hr("safeLoadAll","loadAll"),Xu=Hr("safeDump","dump"),Yu={Type:Nu,Schema:Fu,FAILSAFE_SCHEMA:$u,JSON_SCHEMA:Du,CORE_SCHEMA:Gu,DEFAULT_SCHEMA:Mu,load:Lu,loadAll:Uu,dump:Bu,YAMLException:Vu,types:Ku,safeLoad:Hu,safeLoadAll:Wu,safeDump:Xu};const Xs=Object.assign({"/docs/openapi/asserted_distribution.yaml":zc,"/docs/openapi/biological_association.yaml":Jc,"/docs/openapi/biological_associations_graph.yaml":Zc,"/docs/openapi/biological_relationship.yaml":Qc,"/docs/openapi/cached_map.yaml":el,"/docs/openapi/citation.yaml":nl,"/docs/openapi/collecting_event.yaml":tl,"/docs/openapi/collection_object.yaml":rl,"/docs/openapi/common_name.yaml":il,"/docs/openapi/content.yaml":ol,"/docs/openapi/controlled_vocabulary_term.yaml":sl,"/docs/openapi/conveyance.yaml":al,"/docs/openapi/data_attribute.yaml":pl,"/docs/openapi/depiction.yaml":cl,"/docs/openapi/download.yaml":ll,"/docs/openapi/dwc_occurrence.yaml":dl,"/docs/openapi/field_occurrence.yaml":ul,"/docs/openapi/identifier.yaml":ml,"/docs/openapi/image.yaml":yl,"/docs/openapi/lead.yaml":hl,"/docs/openapi/news.yaml":fl,"/docs/openapi/note.yaml":gl,"/docs/openapi/observation.yaml":bl,"/docs/openapi/observation_matrix.yaml":_l,"/docs/openapi/otu.yaml":xl,"/docs/openapi/person.yaml":Tl,"/docs/openapi/sound.yaml":vl,"/docs/openapi/source.yaml":jl,"/docs/openapi/tag.yaml":wl,"/docs/openapi/taxon_determination.yaml":Al,"/docs/openapi/taxon_name.yaml":Sl,"/docs/openapi/taxon_name_classification.yaml":Il,"/docs/openapi/taxon_name_relationship.yaml":Cl,"/docs/openapi/utility.yaml":El}),rr=new Map;function zu(e){return e.replace(/_/g," ").replace(/\bdwc\b/gi,"DWC").replace(/\b\w/g,n=>n.toUpperCase())}const Ju=Object.keys(Xs).map(e=>{const n=e.split("/").pop(),t=n.replace(".yaml","");return{id:t,filename:n,label:zu(t)}}).sort((e,n)=>e.label.localeCompare(n.label));function Zu(){const e=wn(null),n=wn(null);function t(r){n.value=null;const i=`/docs/openapi/${r}`;if(rr.has(i)){e.value=rr.get(i);return}const o=Xs[i];if(!o){n.value=`Spec file not found: ${r}`,e.value=null;return}try{const s=Yu.load(o);if(!s.externalDocs){const a=r.replace(".yaml","").replaceAll("_","-");s.externalDocs={description:"Data Model Documentation",url:`https://docs.taxonworks.org/develop/Data/models.html#${a}`}}rr.set(i,s),e.value=s}catch(s){n.value=`Failed to parse ${r}: ${s.message}`,e.value=null}}return{spec:e,error:n,loadSpec:t,resources:Ju}}const Qu={class:"app-body"},em={key:0,class:"markdown-page"},nm={__name:"App",setup(e){const{spec:n,error:t,resources:r,loadSpec:i}=Zu();function o(){const p=new URLSearchParams(window.location.search).get("resource");return p==="overview"?"overview":p&&r.find(d=>d.id===p)?p:"overview"}const s=wn(o());return Mn(s,a=>{const p=new URL(window.location);if(a==="overview"){n.value=null,t.value=null,p.searchParams.delete("resource"),window.history.replaceState({},"",p);return}const d=r.find(l=>l.id===a);d&&(i(d.filename),p.searchParams.set("resource",a),window.history.replaceState({},"",p))}),$r(()=>{const a=r.find(p=>p.id===s.value);a&&i(a.filename)}),(a,p)=>(te(),fe(xe,null,[le(Fc),Z("div",Qu,[le(Bc,{modelValue:s.value,"onUpdate:modelValue":p[0]||(p[0]=d=>s.value=d),resources:kn(r)},null,8,["modelValue","resources"]),s.value==="overview"?(te(),fe("div",em,[le(kn(Yc))])):(te(),Yo(Wc,{key:1,spec:kn(n),error:kn(t)},null,8,["spec","error"]))])],64))}},tm=In(nm,[["__scopeId","data-v-dcb031e9"]]);xc(tm).mount("#app");
