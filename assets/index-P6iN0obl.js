...
`,U=Symbol(`NOT_RESOLVED`);function W(e,t){return{tagName:e,nodeKind:`scalar`,implicit:t.implicit??!1,matchByTagPrefix:t.matchByTagPrefix??!1,implicitFirstChars:t.implicitFirstChars??null,resolve:t.resolve,identify:t.identify,represent:t.represent??(e=>String(e)),representTagName:t.representTagName??(()=>e)}}function ac(e,t){let n=t.finalize===void 0;return{tagName:e,nodeKind:`sequence`,implicit:!1,matchByTagPrefix:t.matchByTagPrefix??!1,create:t.create,addItem:t.addItem,finalize:t.finalize??(e=>e),carrierIsResult:n,identify:t.identify,represent:t.represent??(e=>e),representTagName:t.representTagName??(()=>e)}}function oc(e,t){let n=t.finalize===void 0;return{tagName:e,nodeKind:`mapping`,implicit:!1,matchByTagPrefix:t.matchByTagPrefix??!1,create:t.create,addPair:t.addPair,has:t.has,keys:t.keys,get:t.get,finalize:t.finalize??(e=>e),carrierIsResult:n,identify:t.identify,represent:t.represent??(e=>e),representTagName:t.representTagName??(()=>e)}}var sc=W(`tag:yaml.org,2002:str`,{resolve:e=>e,identify:e=>typeof e==`string`}),cc=[``,`~`,`null`,`Null`,`NULL`],lc=W(`tag:yaml.org,2002:null`,{implicit:!0,implicitFirstChars:[``,`~`,`n`,`N`],resolve:e=>cc.indexOf(e)===-1?U:null,identify:e=>e===null,represent:()=>`null`}),uc=W(`tag:yaml.org,2002:null`,{implicit:!0,implicitFirstChars:[`n`],resolve:(e,t)=>e===`null`||t&&e===``?null:U,identify:e=>e===null,represent:()=>`null`}),dc=[``,`~`,`null`,`Null`,`NULL`],fc=W(`tag:yaml.org,2002:null`,{implicit:!0,implicitFirstChars:[``,`~`,`n`,`N`],resolve:e=>dc.indexOf(e)===-1?U:null,identify:e=>e===null,represent:()=>`null`}),pc=[`true`,`True`,`TRUE`],mc=[`false`,`False`,`FALSE`],hc=W(`tag:yaml.org,2002:bool`,{implicit:!0,implicitFirstChars:[`t`,`T`,`f`,`F`],resolve:e=>pc.indexOf(e)!==-1||mc.indexOf(e)===-1&&U,identify:e=>Object.prototype.toString.call(e)===`[object Boolean]`,represent:e=>e?`true`:`false`}),gc=[`true`],_c=[`false`],vc=W(`tag:yaml.org,2002:bool`,{implicit:!0,implicitFirstChars:[`t`,`f`],resolve:e=>gc.indexOf(e)!==-1||_c.indexOf(e)===-1&&U,identify:e=>Object.prototype.toString.call(e)===`[object Boolean]`,represent:e=>e?`true`:`false`}),yc=[`true`,`True`,`TRUE`,`y`,`Y`,`yes`,`Yes`,`YES`,`on`,`On`,`ON`],bc=[`false`,`False`,`FALSE`,`n`,`N`,`no`,`No`,`NO`,`off`,`Off`,`OFF`],xc=W(`tag:yaml.org,2002:bool`,{implicit:!0,implicitFirstChars:[`y`,`Y`,`n`,`N`,`t`,`T`,`f`,`F`,`o`,`O`],resolve:e=>yc.indexOf(e)!==-1||bc.indexOf(e)===-1&&U,identify:e=>Object.prototype.toString.call(e)===`[object Boolean]`,represent:e=>e?`true`:`false`}),Sc=RegExp(`^(?:0o[0-7]+|0x[0-9a-fA-F]+|[-+]?[0-9]+)$`),Cc=RegExp(`^(?:[-+]?0b[0-1]+|[-+]?0o[0-7]+|[-+]?0x[0-9a-fA-F]+|[-+]?[0-9]+)$`);function wc(e){let t=e,n=1;return(t[0]===`-`||t[0]===`+`)&&(t[0]===`-`&&(n=-1),t=t.slice(1)),t.startsWith(`0b`)?n*parseInt(t.slice(2),2):t.startsWith(`0o`)?n*parseInt(t.slice(2),8):t.startsWith(`0x`)?n*parseInt(t.slice(2),16):n*parseInt(t,10)}function Tc(e,t){if(t){if(!Cc.test(e))return U}else if(!Sc.test(e))return U;let n=wc(e);return Number.isFinite(n)?n:U}var Ec=W(`tag:yaml.org,2002:int`,{implicit:!0,implicitFirstChars:[`-`,`+`,...`0123456789`],resolve:Tc,identify:e=>Number.isInteger(e)&&!Object.is(e,-0)&&e.toString(10).indexOf(`e`)<0,represent:e=>e.toString(10)}),Dc=RegExp(`^-?(?:0|[1-9][0-9]*)$`),Oc=RegExp(`^(?:[-+]?0b[0-1]+|[-+]?0o[0-7]+|[-+]?0x[0-9a-fA-F]+|[-+]?[0-9]+)$`);function kc(e){let t=e,n=1;return(t[0]===`-`||t[0]===`+`)&&(t[0]===`-`&&(n=-1),t=t.slice(1)),t.startsWith(`0b`)?n*parseInt(t.slice(2),2):t.startsWith(`0o`)?n*parseInt(t.slice(2),8):t.startsWith(`0x`)?n*parseInt(t.slice(2),16):n*parseInt(t,10)}function Ac(e,t){if(t){if(!Oc.test(e))return U}else if(!Dc.test(e))return U;let n=kc(e);return Number.isFinite(n)?n:U}var jc=W(`tag:yaml.org,2002:int`,{implicit:!0,implicitFirstChars:[`-`,...`0123456789`],resolve:Ac,identify:e=>Number.isInteger(e)&&!Object.is(e,-0)&&e.toString(10).indexOf(`e`)<0,represent:e=>e.toString(10)}),Mc=RegExp(`^(?:[-+]?0b[0-1_]+|[-+]?0[0-7_]+|[-+]?0x[0-9a-fA-F_]+|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+|[-+]?(?:0|[1-9][0-9_]*))$`);function Nc(e){let t=e.replace(/_/g,``),n=1;if((t[0]===`-`||t[0]===`+`)&&(t[0]===`-`&&(n=-1),t=t.slice(1)),t.startsWith(`0b`))return n*parseInt(t.slice(2),2);if(t.startsWith(`0x`))return n*parseInt(t.slice(2),16);if(t.includes(`:`)){let e=0;for(let n of t.split(`:`))e=e*60+Number(n);return n*e}return t!==`0`&&t[0]===`0`?n*parseInt(t,8):n*parseInt(t,10)}function Pc(e){if(!Mc.test(e))return U;let t=Nc(e);return Number.isFinite(t)?t:U}var Fc=W(`tag:yaml.org,2002:int`,{implicit:!0,implicitFirstChars:[`-`,`+`,...`0123456789`],resolve:Pc,identify:e=>Number.isInteger(e)&&!Object.is(e,-0)&&e.toString(10).indexOf(`e`)<0,represent:e=>e.toString(10)}),Ic=RegExp(`^(?:[-+]?[0-9]+(?:\\.[0-9]*)?(?:[eE][-+]?[0-9]+)?|[-+]?\\.[0-9]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$`),Lc=RegExp(`^(?:[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$`);function Rc(e){if(!Ic.test(e))return U;let t=e.toLowerCase(),n=t[0]===`-`?-1:1;if(`+-`.includes(t[0])&&(t=t.slice(1)),t===`.inf`)return n===1?1/0:-1/0;if(t===`.nan`)return NaN;let r=n*parseFloat(t);return Number.isFinite(r)||Lc.test(e)?r:U}function zc(e){if(isNaN(e))return`.nan`;if(e===1/0)return`.inf`;if(e===-1/0)return`-.inf`;if(Object.is(e,-0))return`-0.0`;let t=e.toString(10);return/^[-+]?[0-9]+e/.test(t)?t.replace(`e`,`.e`):t}var Bc=W(`tag:yaml.org,2002:float`,{implicit:!0,implicitFirstChars:[`-`,`+`,`.`,...`0123456789`],resolve:Rc,identify:e=>typeof e==`number`&&(!Number.isInteger(e)||Object.is(e,-0)||e.toString(10).indexOf(`e`)>=0),represent:zc}),Vc=RegExp(`^-?(?:0|[1-9][0-9]*)(?:\\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$`),Hc=RegExp(`^(?:[-+]?[0-9]+(?:\\.[0-9]*)?(?:[eE][-+]?[0-9]+)?|[-+]?\\.[0-9]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$`);function Uc(e,t){if(t){if(!Hc.test(e))return U;let t=e.toLowerCase(),n=t[0]===`-`?-1:1;if(`+-`.includes(t[0])&&(t=t.slice(1)),t===`.inf`)return n===1?1/0:-1/0;if(t===`.nan`)return NaN;let r=n*parseFloat(t);return Number.isFinite(r)?r:U}if(!Vc.test(e))return U;let n=Number(e);return Number.isFinite(n)?n:U}function Wc(e){if(isNaN(e))return`.nan`;if(e===1/0)return`.inf`;if(e===-1/0)return`-.inf`;if(Object.is(e,-0))return`-0.0`;let t=e.toString(10);return/^[-+]?[0-9]+e/.test(t)?t.replace(`e`,`.e`):t}var Gc=W(`tag:yaml.org,2002:float`,{implicit:!0,implicitFirstChars:[`-`,...`0123456789`],resolve:Uc,identify:e=>typeof e==`number`&&(!Number.isInteger(e)||Object.is(e,-0)||e.toString(10).indexOf(`e`)>=0),represent:Wc}),Kc=RegExp(`^(?:[-+]?(?:(?:[0-9][0-9_]*)?\\.[0-9_]*)(?:[eE][-+][0-9]+)?|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\\.[0-9_]*|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$`),qc=RegExp(`^(?:[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$`);function Jc(e){if(!Kc.test(e))return U;let t=e.toLowerCase().replace(/_/g,``),n=t[0]===`-`?-1:1;if(`+-`.includes(t[0])&&(t=t.slice(1)),t===`.inf`)return n===1?1/0:-1/0;if(t===`.nan`)return NaN;let r=0;if(t.includes(`:`)){for(let e of t.split(`:`))r=r*60+Number(e);r*=n}else r=n*parseFloat(t);return Number.isFinite(r)||qc.test(e)?r:U}function Yc(e){if(isNaN(e))return`.nan`;if(e===1/0)return`.inf`;if(e===-1/0)return`-.inf`;if(Object.is(e,-0))return`-0.0`;let t=e.toString(10);return/^[-+]?[0-9]+e/.test(t)?t.replace(`e`,`.e`):t}var Xc=W(`tag:yaml.org,2002:float`,{implicit:!0,implicitFirstChars:[`-`,`+`,`.`,...`0123456789`],resolve:Jc,identify:e=>typeof e==`number`&&(!Number.isInteger(e)||Object.is(e,-0)||e.toString(10).indexOf(`e`)>=0),represent:Yc}),Zc=W(`tag:yaml.org,2002:merge`,{implicit:!0,implicitFirstChars:[`<`],resolve:(e,t)=>e===`<<`||t&&e===``?`<<`:U,identify:()=>!1}),Qc=/^[A-Za-z0-9+/]*={0,2}$/;function $c(e){let t=e.replace(/\s/g,``);if(t.length%4!=0||!Qc.test(t))return U;let n=atob(t),r=new Uint8Array(n.length);for(let e=0;e<n.length;e++)r[e]=n.charCodeAt(e);return r}function el(e){let t=``;for(let n=0;n<e.length;n++)t+=String.fromCharCode(e[n]);return btoa(t)}var tl=W(`tag:yaml.org,2002:binary`,{resolve:$c,identify:e=>Object.prototype.toString.call(e)===`[object Uint8Array]`,represent:el}),nl=RegExp(`^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$`),rl=RegExp(`^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$`);function il(e,t,n,r=0,i=0,a=0,o=0){let s=new Date(Date.UTC(e,t,n,r,i,a,o));return s.setUTCFullYear(e,t,n),s}function al(e){let t=nl.exec(e);if(t===null&&(t=rl.exec(e)),t===null)return U;let n=+t[1],r=t[2]-1,i=+t[3];if(!t[4]){let e=il(n,r,i);return e.getUTCFullYear()!==n||e.getUTCMonth()!==r||e.getUTCDate()!==i?U:e}let a=+t[4],o=+t[5],s=+t[6],c=0;if(a>23||o>59||s>59)return U;if(t[7]){let e=t[7].slice(0,3);for(;e.length<3;)e+=`0`;c=+e}let l=il(n,r,i,a,o,s,c);if(l.getUTCFullYear()!==n||l.getUTCMonth()!==r||l.getUTCDate()!==i)return U;if(t[9]){let e=+t[10],n=+(t[11]||0);if(e>23||n>59)return U;let r=(e*60+n)*6e4;l.setTime(l.getTime()-(t[9]===`-`?-r:r))}return l}var ol=W(`tag:yaml.org,2002:timestamp`,{implicit:!0,implicitFirstChars:[...`0123456789`],resolve:al,identify:e=>e instanceof Date,represent:e=>e.toISOString()}),sl=ac(`tag:yaml.org,2002:seq`,{create:()=>[],addItem:(e,t)=>{e.push(t)},identify:Array.isArray});function cl(e){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let t=Object.getPrototypeOf(e);return t===null||t===Object.prototype}function ll(e,t){let n={};for(let r of t)e[r]!==void 0&&(n[r]=e[r]);return n}var ul=ac(`tag:yaml.org,2002:omap`,{create:()=>({list:[],seen:new Set}),addItem:(e,t)=>{let n;if(t instanceof Map){if(t.size!==1)return`cannot resolve an ordered map item`;n=t.keys().next().value}else if(cl(t)){let e=Object.keys(t);if(e.length!==1)return`cannot resolve an ordered map item`;n=e[0]}else return`cannot resolve an ordered map item`;return e.seen.has(n)?`duplicate key in ordered map`:(e.seen.add(n),e.list.push(t),``)},finalize:e=>e.list,identify:()=>!1}),dl=ac(`tag:yaml.org,2002:pairs`,{create:()=>[],addItem:(e,t)=>{if(t instanceof Map)return t.size===1?(e.push(t.entries().next().value),``):`cannot resolve a pairs item`;if(Object.prototype.toString.call(t)!==`[object Object]`)return`cannot resolve a pairs item`;let n=t,r=Object.keys(n);return r.length===1?(e.push([r[0],n[r[0]]]),``):`cannot resolve a pairs item`},identify:()=>!1}),fl=oc(`tag:yaml.org,2002:map`,{create:()=>({}),identify:cl,represent:e=>{let t=new Map;for(let n of Object.keys(e))t.set(n,e[n]);return t},addPair:(e,t,n)=>{if(typeof t==`object`&&t)return`object-based map does not support complex keys`;let r=String(t);return r===`__proto__`?Object.defineProperty(e,r,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[r]=n,``},has:(e,t)=>typeof t==`object`&&t?!1:Object.prototype.hasOwnProperty.call(e,String(t)),keys:e=>Object.keys(e),get:(e,t)=>{let n=String(t);return Object.prototype.hasOwnProperty.call(e,n)?e[n]:null}}),pl=oc(`tag:yaml.org,2002:set`,{create:()=>new Set,identify:e=>e instanceof Set,represent:e=>{let t=new Map;for(let n of e)t.set(n,null);return t},addPair:(e,t,n)=>n===null?(e.add(t),``):`cannot resolve a set item`,has:(e,t)=>e.has(t),keys:e=>e.keys(),get:()=>null});function ml(){return{scalar:Object.create(null),sequence:Object.create(null),mapping:Object.create(null)}}function hl(){return{scalar:[],sequence:[],mapping:[]}}function gl(e){let t=[];for(let n of e){let e=t.length;for(let r=0;r<t.length;r++){let i=t[r];if(i.nodeKind===n.nodeKind&&i.tagName===n.tagName&&i.matchByTagPrefix===n.matchByTagPrefix){e=r;break}}t[e]=n}return t}var _l=class e{tags;implicitScalarTags;implicitScalarByFirstChar;implicitScalarAnyFirstChar;defaultScalarTag;defaultSequenceTag;defaultMappingTag;exact;prefix;constructor(e){let t=gl(e),n=[],r=ml(),i=hl();for(let e of t){if(e.nodeKind===`scalar`&&e.implicit){if(e.matchByTagPrefix)throw Error(`Implicit scalar tags cannot match by tag prefix`);n.push(e)}switch(e.nodeKind){case`scalar`:e.matchByTagPrefix?i.scalar.push(e):r.scalar[e.tagName]=e;break;case`sequence`:e.matchByTagPrefix?i.sequence.push(e):r.sequence[e.tagName]=e;break;case`mapping`:e.matchByTagPrefix?i.mapping.push(e):r.mapping[e.tagName]=e}}let a=n.filter(e=>e.implicitFirstChars===null),o=new Set;for(let e of n)if(e.implicitFirstChars!==null)for(let t of e.implicitFirstChars)o.add(t);let s=new Map;for(let e of o)s.set(e,n.filter(t=>t.implicitFirstChars===null||t.implicitFirstChars.indexOf(e)!==-1));let c=r.scalar[`tag:yaml.org,2002:str`];if(!c)throw Error(`schema does not define the default scalar tag (tag:yaml.org,2002:str)`);this.tags=t,this.implicitScalarTags=n,this.implicitScalarByFirstChar=s,this.implicitScalarAnyFirstChar=a,this.defaultScalarTag=c,this.defaultSequenceTag=r.sequence[`tag:yaml.org,2002:seq`],this.defaultMappingTag=r.mapping[`tag:yaml.org,2002:map`],this.exact=r,this.prefix=i}lookupScalarTag(e){let t=this.exact.scalar[e];if(t)return t;for(let t of this.prefix.scalar)if(e.startsWith(t.tagName))return t}lookupSequenceTag(e){let t=this.exact.sequence[e];if(t)return t;for(let t of this.prefix.sequence)if(e.startsWith(t.tagName))return t}lookupMappingTag(e){let t=this.exact.mapping[e];if(t)return t;for(let t of this.prefix.mapping)if(e.startsWith(t.tagName))return t}resolveImplicitScalarTag(e){let t=this.implicitScalarByFirstChar.get(e.charAt(0))??this.implicitScalarAnyFirstChar;for(let n of t){let t=n.resolve(e,!1,n.tagName);if(t!==U)return{value:t,tag:n}}let n=this.defaultScalarTag;return{value:n.resolve(e,!1,n.tagName),tag:n}}withTags(...t){let n=[];for(let e of t)n=n.concat(e);return new e([...this.tags,...n])}},vl=new _l([sc,sl,fl]);new _l([...vl.tags,uc,vc,jc,Gc]);var yl=new _l([...vl.tags,lc,hc,Ec,Bc]);new _l([...vl.tags,fc,xc,Fc,Xc,ol,Zc,tl,ul,dl,pl]).withTags({...Fc,resolve:(e,t,n)=>{let r=Fc.resolve(e,t,n);return r===U?Ec.resolve(e,t,n):r}},{...Xc,resolve:(e,t,n)=>{let r=Xc.resolve(e,t,n);return r===U?Bc.resolve(e,t,n):r}}),oc(`tag:yaml.org,2002:map`,{create:()=>new Map,addPair:(e,t,n)=>(e.set(t,n),``),has:(e,t)=>e.has(t),keys:e=>e.keys(),get:(e,t)=>e.get(t),identify:e=>e instanceof Map||cl(e),represent:e=>{if(e instanceof Map)return e;let t=new Map,n=e;for(let e of Object.keys(n))t.set(e,n[e]);return t}});function bl(e){if(Array.isArray(e)){let t=Array.prototype.slice.call(e);for(let e=0;e<t.length;e++){if(Array.isArray(t[e]))return null;typeof t[e]==`object`&&Object.prototype.toString.call(t[e])===`[object Object]`&&(t[e]=`[object Object]`)}return String(t)}return typeof e==`object`&&Object.prototype.toString.call(e)===`[object Object]`?`[object Object]`:String(e)}oc(`tag:yaml.org,2002:map`,{create:()=>({}),identify:cl,represent:e=>{let t=new Map;for(let n of Object.keys(e))t.set(n,e[n]);return t},addPair:(e,t,n)=>{let r=bl(t);return r===null?`nested arrays are not supported inside keys`:(r===`__proto__`?Object.defineProperty(e,r,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[r]=n,``)},has:(e,t)=>{let n=bl(t);return n!==null&&Object.prototype.hasOwnProperty.call(e,n)},keys:e=>Object.keys(e),get:(e,t)=>{let n=String(t);return Object.prototype.hasOwnProperty.call(e,n)?e[n]:null}});var xl={maxLength:79,indent:1,linesBefore:3,linesAfter:2};function Sl(e,t,n,r,i){let a=``,o=``,s=Math.floor(i/2)-1;return r-t>s&&(a=` ... `,t=r-s+a.length),n-r>s&&(o=` ...`,n=r+s-o.length),{str:a+e.slice(t,n).replace(/\t/g,`→`)+o,pos:r-t+a.length}}function Cl(e,t){return` `.repeat(Math.max(t-e.length,0))+e}function wl(e,t){if(!e.buffer)return null;let n={...xl,...t},r=/\r?\n|\r|\0/g,i=[0],a=[],o,s=-1;for(;o=r.exec(e.buffer);)a.push(o.index),i.push(o.index+o[0].length),e.position<=o.index&&s<0&&(s=i.length-2);s<0&&(s=i.length-1);let c=``,l=Math.min(e.line+n.linesAfter,a.length).toString().length,u=n.maxLength-(n.indent+l+3);for(let t=1;t<=n.linesBefore&&!(s-t<0);t++){let r=Sl(e.buffer,i[s-t],a[s-t],e.position-(i[s]-i[s-t]),u);c=`${` `.repeat(n.indent)}${Cl((e.line-t+1).toString(),l)} | ${r.str}\n${c}`}let d=Sl(e.buffer,i[s],a[s],e.position,u);c+=`${` `.repeat(n.indent)}${Cl((e.line+1).toString(),l)} | ${d.str}\n`,c+=`${`-`.repeat(n.indent+l+3+d.pos)}^\n`;for(let t=1;t<=n.linesAfter&&!(s+t>=a.length);t++){let r=Sl(e.buffer,i[s+t],a[s+t],e.position-(i[s]-i[s+t]),u);c+=`${` `.repeat(n.indent)}${Cl((e.line+t+1).toString(),l)} | ${r.str}\n`}return c.replace(/\n$/,``)}function Tl(e,t){let n=``;return e.mark?(e.mark.name&&(n+=`in "${e.mark.name}" `),n+=`(${e.mark.line+1}:${e.mark.column+1})`,!t&&e.mark.snippet&&(n+=`\n\n${e.mark.snippet}`),`${e.reason} ${n}`):e.reason}var El=class e extends Error{reason;mark;constructor(e,t){super(),this.name=`YAMLException`,this.reason=e,this.mark=t,this.message=Tl(this,!1),Error.captureStackTrace&&Error.captureStackTrace(this,this.constructor)}toString(e){return`${this.name}: ${Tl(this,e)}`}static throwAt(t,n,r,i=``){let a=0,o=0;for(let e=0;e<n;e++){let n=t.charCodeAt(e);n===10?(a++,o=e+1):n===13&&(a++,t.charCodeAt(e+1)===10&&e++,o=e+1)}let s={name:i,buffer:t,position:n,line:a,column:n-o};throw s.snippet=wl(s),new e(r,s)}},G={DOCUMENT:1,SEQUENCE:2,MAPPING:3,SCALAR:4,ALIAS:5,POP:6},K={PLAIN:1,SINGLE_QUOTED:2,DOUBLE_QUOTED:3,LITERAL_BLOCK:4,FOLDED_BLOCK:5},Dl={BLOCK:1,FLOW:2},q={CLIP:1,STRIP:2,KEEP:3},Ol=-1;function kl(e){switch(e){case 48:return`\0`;case 97:return`\x07`;case 98:return`\b`;case 116:return`	`;case 9:return`	`;case 110:return`
`;case 118:return`\v`;case 102:return`\f`;case 114:return`\r`;case 101:return`\x1B`;case 32:return` `;case 34:return`"`;case 47:return`/`;case 92:return`\\`;case 78:return``;case 95:return`\xA0`;case 76:return`\u2028`;case 80:return`\u2029`;default:return``}}var Al=Array(256),jl=Array(256);for(let e=0;e<256;e++)Al[e]=+!!kl(e),jl[e]=kl(e);function Ml(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function Nl(e){return e>=48&&e<=57?e-48:(e|32)-97+10}function Pl(e){return e===120?2:e===117?4:8}function Fl(e,t,n){let r=0;for(;t<n;){let n=e.charCodeAt(t);if(n===10)r++,t++;else if(n===13)r++,t++,e.charCodeAt(t)===10&&t++;else if(n===32||n===9)t++;else break}return{position:t,breaks:r}}function Il(e){return e===1?` `:`
`.repeat(e-1)}function Ll(e,t,n){let r=``,i=t,a=t,o=t;for(;i<n;){let t=e.charCodeAt(i);if(t===10||t===13){r+=e.slice(a,o);let t=Fl(e,i,n);r+=Il(t.breaks),i=a=o=t.position}else i++,t!==32&&t!==9&&(o=i)}return r+e.slice(a,o)}function Rl(e,t,n){let r=``,i=t,a=t,o=t;for(;i<n;){let t=e.charCodeAt(i);if(t===39)r+=e.slice(a,i)+`'`,i+=2,a=o=i;else if(t===10||t===13){r+=e.slice(a,o);let t=Fl(e,i,n);r+=Il(t.breaks),i=a=o=t.position}else i++,t!==32&&t!==9&&(o=i)}return r+e.slice(a,n)}function zl(e,t,n){let r=``,i=t,a=t,o=t;for(;i<n;){let t=e.charCodeAt(i);if(t===92){r+=e.slice(a,i),i++;let t=e.charCodeAt(i);if(t===10||t===13)i=Fl(e,i,n).position;else if(t<256&&Al[t])r+=jl[t],i++;else{let n=Pl(t),a=0;for(;n>0;n--){i++;let t=Nl(e.charCodeAt(i));a=(a<<4)+t}r+=Ml(a),i++}a=o=i}else if(t===10||t===13){r+=e.slice(a,o);let t=Fl(e,i,n);r+=Il(t.breaks),i=a=o=t.position}else i++,t!==32&&t!==9&&(o=i)}return r+e.slice(a,n)}function Bl(e,t,n,r,i,a){let o=r<0?0:r,s=e.slice(t,n).replace(/\r\n?/g,`
`),c=s===``?[]:(s.endsWith(`
`)?s.slice(0,-1):s).split(`
...
`),l}function Vl(e,t){if(t.valueStart===Ol)return``;let{valueStart:n,valueEnd:r}=t;if(t.fast)return e.slice(n,r);switch(t.style){case K.SINGLE_QUOTED:return Rl(e,n,r);case K.DOUBLE_QUOTED:return zl(e,n,r);case K.LITERAL_BLOCK:return Bl(e,n,r,t.indent,t.chomping,!1);case K.FOLDED_BLOCK:return Bl(e,n,r,t.indent,t.chomping,!0);default:return Ll(e,n,r)}}var Hl=Object.assign(Object.create(null),{"!":`!`,"!!":`tag:yaml.org,2002:`});function Ul(e,t){if(e.startsWith(`!<`)&&e.endsWith(`>`))return decodeURIComponent(e.slice(2,-1));let n=e.indexOf(`!`,1),r=n===-1?`!`:e.slice(0,n+1),i=t?.[r]??Hl[r]??r;return decodeURIComponent(i)+decodeURIComponent(e.slice(r.length))}var Wl=-1,Gl=`tag:yaml.org,2002:merge`,Kl={filename:``,schema:yl,json:!1,maxTotalMergeKeys:1e4,maxAliases:-1};function ql(e){return`tagStart`in e&&e.tagStart!==Wl?e.tagStart:`anchorStart`in e&&e.anchorStart!==Wl?e.anchorStart:`valueStart`in e&&e.valueStart!==Wl?e.valueStart:`start`in e?e.start:0}function J(e,t){El.throwAt(e.source,e.position,t,e.filename)}function Jl(e,t,n,r){try{return n.finalize(r)}catch(n){if(n instanceof El)throw n;El.throwAt(e.source,t,n instanceof Error?n.message:String(n),e.filename)}}function Yl(e,t){let n=Vl(e.source,t),r=t.tagStart===Wl?``:e.source.slice(t.tagStart,t.tagEnd),i=e.schema.defaultScalarTag;if(r!==``){if(r===`!`)return{value:n,tag:i};let t=Ul(r,e.tagHandlers),a=e.schema.lookupScalarTag(t);if(a){let r=a.resolve(n,!0,t);return r===U&&J(e,`cannot resolve a node with !<${t}> explicit tag`),{value:r,tag:a}}let o=e.schema.lookupMappingTag(t)??e.schema.lookupSequenceTag(t);if(o){n!==``&&J(e,`cannot resolve a node with !<${t}> explicit tag`);let r=o.create(t);return{value:o.carrierIsResult?r:Jl(e,e.position,o,r),tag:o}}J(e,`unknown scalar tag !<${t}>`)}return t.style===K.PLAIN?e.schema.resolveImplicitScalarTag(n):{value:i.resolve(n,!1,i.tagName),tag:i}}function Xl(e,t,n){let r=t.tagStart===Wl?``:e.source.slice(t.tagStart,t.tagEnd);return r===``||r===`!`?n:Ul(r,e.tagHandlers)}function Zl(e){return e.nodeKind===`mapping`}function Ql(e){e.totalMergeKeys++,e.maxTotalMergeKeys!==-1&&e.totalMergeKeys>e.maxTotalMergeKeys&&J(e,`merge keys exceeded maxTotalMergeKeys (${e.maxTotalMergeKeys})`)}function $l(e,t,n,r){Ql(e);for(let i of r.keys(n)){if(Ql(e),t.tag.has(t.value,i))continue;let a=t.tag.addPair(t.value,i,r.get(n,i));a&&J(e,a),t.overridable??=new Set,t.overridable.add(i)}}function eu(e,t,n,r){if(e.position=t.keyPosition,Zl(r))$l(e,t,n,r);else if(r.nodeKind===`sequence`&&Array.isArray(n)){n.length>100&&J(e,`abnormal merge sequence size`);for(let r of n){let n=e.nodeTags.get(r);n||J(e,`cannot merge mappings; the provided source object is unacceptable`),$l(e,t,r,n)}}else J(e,`cannot merge mappings; the provided source object is unacceptable`)}function tu(e,t,n,r,i){if(e.position=t.keyPosition,t.keyIsMerge){eu(e,t,r,i);return}!e.json&&t.tag.has(t.value,n)&&!t.overridable?.has(n)&&J(e,`duplicated mapping key`);let a=t.tag.addPair(t.value,n,r);a&&J(e,a),t.overridable?.delete(n)}function nu(e,t,n){let r=e.frames[e.frames.length-1];if(r.kind===`document`)r.value=t,r.hasValue=!0;else if(r.kind===`sequence`){Zl(n)&&e.nodeTags.set(t,n);let i=r.tag.addItem(r.value,t,r.index++);i&&J(e,i)}else if(r.hasKey){let i=r.key;r.key=void 0,r.hasKey=!1,tu(e,r,i,t,n)}else r.key=t,r.keyPosition=e.position,r.hasKey=!0,r.keyIsMerge=n.tagName===Gl}function ru(e,t,n,r,i){if(t.anchorStart!==Wl){let a={value:n,tag:r,isValueFinal:i};return e.anchors.set(e.source.slice(t.anchorStart,t.anchorEnd),a),a}return null}function iu(e,t){let n={...Kl,...t,events:e,documents:[],eventIndex:0,position:0,frames:[],anchors:new Map,nodeTags:new Map,tagHandlers:Object.create(null),totalMergeKeys:0,aliasCount:0};for(;n.eventIndex<n.events.length;){let e=n.events[n.eventIndex++];switch(n.position=ql(e),e.type){case G.DOCUMENT:n.anchors=new Map,n.nodeTags=new Map,n.aliasCount=0,n.tagHandlers=Object.create(null);for(let t of e.directives)t.kind===`tag`&&(n.tagHandlers[t.handle]=t.prefix);n.frames.push({kind:`document`,position:n.position,value:void 0,hasValue:!1});break;case G.SCALAR:{let{value:t,tag:r}=Yl(n,e);ru(n,e,t,r,!0),nu(n,t,r);break}case G.SEQUENCE:{let t=Xl(n,e,`tag:yaml.org,2002:seq`),r=n.schema.lookupSequenceTag(t);r||J(n,`unknown sequence tag !<${t}>`);let i=r.create(t),a=ru(n,e,i,r,r.carrierIsResult);n.frames.push({kind:`sequence`,position:n.position,value:i,tag:r,anchor:a,index:0});break}case G.MAPPING:{let t=Xl(n,e,`tag:yaml.org,2002:map`),r=n.schema.lookupMappingTag(t);r||J(n,`unknown mapping tag !<${t}>`);let i=r.create(t),a=ru(n,e,i,r,r.carrierIsResult);n.frames.push({kind:`mapping`,position:n.position,value:i,tag:r,anchor:a,key:void 0,keyPosition:n.position,hasKey:!1,keyIsMerge:!1,overridable:null});break}case G.ALIAS:{n.maxAliases!==-1&&++n.aliasCount>n.maxAliases&&J(n,`aliases exceeded maxAliases (${n.maxAliases})`);let t=n.source.slice(e.anchorStart,e.anchorEnd),r=n.anchors.get(t);r||J(n,`unidentified alias "${t}"`),r.isValueFinal||J(n,`recursive alias "${t}" is not supported for tag ${r.tag.tagName} because it uses finalize()`),nu(n,r.value,r.tag);break}case G.POP:{let e=n.frames.pop();if(e.kind===`mapping`&&e.hasKey&&(n.position=e.keyPosition,J(n,`incomplete mapping pair in event stream`)),e.kind===`document`)n.documents.push(e.value);else{let t=e.tag.carrierIsResult?e.value:Jl(n,e.position,e.tag,e.value);e.anchor&&(e.anchor.value=t,e.anchor.isValueFinal=!0),nu(n,t,e.tag)}break}}}return n.documents}var Y=-1,au=Object.prototype.hasOwnProperty,ou=1,su=2,cu=3,lu=4,uu=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,du=/[,\[\]{}]/,fu=/^(?:!|!!|![0-9A-Za-z-]+!)$/,pu=String.raw`(?:%[0-9A-Fa-f]{2}|[0-9A-Za-z\-#;/?:@&=+$,_.!~*'()\[\]])`,mu=String.raw`(?:%[0-9A-Fa-f]{2}|[0-9A-Za-z\-#;/?:@&=+$.~*'()_])`,hu=RegExp(`^(?:${pu})*$`),gu=RegExp(`^(?:${mu})+$`),_u=RegExp(`^(?:!(?:${pu})*|${mu}(?:${pu})*)$`),vu={filename:``,maxDepth:100};function yu(e,t,n){e.events.push({type:G.DOCUMENT,explicitStart:t,explicitEnd:n,directives:e.directives})}function bu(e,t,n,r,i,a,o){e.events.push({type:G.SEQUENCE,start:t,anchorStart:n,anchorEnd:r,tagStart:i,tagEnd:a,style:o})}function xu(e,t,n,r,i,a,o){e.events.push({type:G.MAPPING,start:t,anchorStart:n,anchorEnd:r,tagStart:i,tagEnd:a,style:o})}function Su(e,t){e.events.splice(t.eventsLength,0,{type:G.MAPPING,start:t.position,anchorStart:Y,anchorEnd:Y,tagStart:Y,tagEnd:Y,style:Dl.FLOW})}function Cu(e,t,n,r,i,a,o,s,c=q.CLIP,l=-1,u=!1){e.events.push({type:G.SCALAR,valueStart:t,valueEnd:n,anchorStart:r,anchorEnd:i,tagStart:a,tagEnd:o,style:s,chomping:c,indent:l,fast:u})}function wu(e,t,n){e.events.push({type:G.ALIAS,anchorStart:t,anchorEnd:n})}function Tu(e){e.events.push({type:G.POP})}function X(e){Cu(e,Y,Y,Y,Y,Y,Y,K.PLAIN)}function Eu(){return{anchorStart:Y,anchorEnd:Y,tagStart:Y,tagEnd:Y}}function Du(e){return{position:e.position,line:e.line,lineStart:e.lineStart,lineIndent:e.lineIndent,firstTabInLine:e.firstTabInLine,eventsLength:e.events.length}}function Ou(e,t){e.position=t.position,e.line=t.line,e.lineStart=t.lineStart,e.lineIndent=t.lineIndent,e.firstTabInLine=t.firstTabInLine,e.events.length=t.eventsLength}function Z(e,t){El.throwAt(e.input.slice(0,e.length),e.position,t,e.filename)}function Q(e){return e===10||e===13}function ku(e){return e===9||e===32}function Au(e){return ku(e)||Q(e)}function ju(e){return e===0||Au(e)}function Mu(e){return e===44||e===91||e===93||e===123||e===125}function Nu(e){return e>=48&&e<=57?e-48:-1}function Pu(e){if(e>=48&&e<=57)return e-48;let t=e|32;return t>=97&&t<=102?t-97+10:-1}function Fu(e){return e===120?2:e===117?4:e===85?8:0}function Iu(e){return e===48||e===97||e===98||e===116||e===9||e===110||e===118||e===102||e===114||e===101||e===32||e===34||e===47||e===92||e===78||e===95||e===76||e===80}function Lu(e){e.input.charCodeAt(e.position)===10?e.position++:(e.position++,e.input.charCodeAt(e.position)===10&&e.position++),e.line++,e.lineStart=e.position,e.lineIndent=0,e.firstTabInLine=-1}function $(e,t){let n=0,r=e.input.charCodeAt(e.position),i=e.position===e.lineStart||Au(e.input.charCodeAt(e.position-1));for(;r!==0;){for(;ku(r);)i=!0,r===9&&e.firstTabInLine===-1&&(e.firstTabInLine=e.position),r=e.input.charCodeAt(++e.position);if(t&&i&&r===35)do r=e.input.charCodeAt(++e.position);while(!Q(r)&&r!==0);if(!Q(r))break;for(Lu(e),n++,i=!0,r=e.input.charCodeAt(e.position);r===32;)e.lineIndent++,r=e.input.charCodeAt(++e.position)}return n}function Ru(e,t=e.position){let n=e.input.charCodeAt(t);if((n===45||n===46)&&n===e.input.charCodeAt(t+1)&&n===e.input.charCodeAt(t+2)){let n=e.input.charCodeAt(t+3);return n===0||Au(n)}return!1}function zu(e){e.position===e.lineStart&&e.input.charCodeAt(e.position)===65279&&(e.position++,e.lineStart=e.position)}function Bu(e){if(e.position!==e.lineStart)return!1;if(Ru(e))return!0;if(e.input.charCodeAt(e.position)!==65279)return!1;let t=Du(e);zu(e),$(e,!0);let n=e.input.charCodeAt(e.position),r=e.position===e.lineStart&&(n===37||n===45&&Ru(e));return Ou(e,t),r}function Vu(e){let t=e.input.charCodeAt(e.position);for(;t!==0&&!Q(t);)t=e.input.charCodeAt(++e.position)}function Hu(e,t,n){uu.test(e.input.slice(t,n))&&Z(e,`the stream contains non-printable characters`)}function Uu(e,t,n){if(e.input.charCodeAt(e.position)!==33)return!1;t.tagStart!==Y&&Z(e,`duplication of a tag property`);let r=e.position,i=!1,a=!1,o=`!`,s=e.input.charCodeAt(++e.position);s===60?(i=!0,s=e.input.charCodeAt(++e.position)):s===33&&(a=!0,o=`!!`,s=e.input.charCodeAt(++e.position));let c=e.position,l;if(i){for(;s!==0&&s!==62;)s=e.input.charCodeAt(++e.position);s!==62&&Z(e,`unexpected end of the stream within a verbatim tag`),l=e.input.slice(c,e.position),e.position++}else{for(;s!==0&&!Au(s)&&!(n&&Mu(s));)s===33&&(a?Z(e,`tag suffix cannot contain exclamation marks`):(o=e.input.slice(c-1,e.position+1),fu.test(o)||Z(e,`named tag handle cannot contain such characters`),a=!0,c=e.position+1)),s=e.input.charCodeAt(++e.position);l=e.input.slice(c,e.position),du.test(l)&&Z(e,`tag suffix cannot contain flow indicator characters`)}return l&&!(i?hu.test(l):gu.test(l))&&Z(e,`tag name cannot contain such characters: ${l}`),!i&&o!==`!`&&o!==`!!`&&!au.call(e.tagHandlers,o)&&Z(e,`undeclared tag handle "${o}"`),t.tagStart=r,t.tagEnd=e.position,!0}function Wu(e,t){if(e.input.charCodeAt(e.position)!==38)return!1;t.anchorStart!==Y&&Z(e,`duplication of an anchor property`),e.position++;let n=e.position;for(;e.input.charCodeAt(e.position)!==0&&!Au(e.input.charCodeAt(e.position))&&!Mu(e.input.charCodeAt(e.position));)e.position++;return e.position===n&&Z(e,`name of an anchor node must contain at least one character`),t.anchorStart=n,t.anchorEnd=e.position,!0}function Gu(e,t){if(e.input.charCodeAt(e.position)!==42)return!1;(t.anchorStart!==Y||t.tagStart!==Y)&&Z(e,`alias node should not have any properties`),e.position++;let n=e.position;for(;e.input.charCodeAt(e.position)!==0&&!Au(e.input.charCodeAt(e.position))&&!Mu(e.input.charCodeAt(e.position));)e.position++;return e.position===n&&Z(e,`name of an alias node must contain at least one character`),wu(e,n,e.position),!0}function Ku(e,t){$(e,!1),e.lineIndent<t&&Z(e,`deficient indentation`)}function qu(e,t,n){if(e.input.charCodeAt(e.position)!==39)return!1;e.position++;let r=e.position,i=!0;for(;e.input.charCodeAt(e.position)!==0;){let a=e.input.charCodeAt(e.position);if(a===39){if(e.input.charCodeAt(e.position+1)===39){i=!1,e.position+=2;continue}let t=e.position;return e.position++,Cu(e,r,t,n.anchorStart,n.anchorEnd,n.tagStart,n.tagEnd,K.SINGLE_QUOTED,q.CLIP,-1,i),!0}Q(a)?(i=!1,Ku(e,t)):e.position===e.lineStart&&Ru(e)?Z(e,`unexpected end of the document within a single quoted scalar`):a!==9&&a<32?Z(e,`expected valid JSON character`):e.position++}Z(e,`unexpected end of the stream within a single quoted scalar`)}function Ju(e,t,n){if(e.input.charCodeAt(e.position)!==34)return!1;e.position++;let r=e.position,i=!0;for(;e.input.charCodeAt(e.position)!==0;){let a=e.input.charCodeAt(e.position);if(a===34){let t=e.position;return e.position++,Cu(e,r,t,n.anchorStart,n.anchorEnd,n.tagStart,n.tagEnd,K.DOUBLE_QUOTED,q.CLIP,-1,i),!0}if(a===92){i=!1;let n=e.input.charCodeAt(++e.position);if(Q(n))Ku(e,t);else if(Iu(n))e.position++;else{let t=Fu(n);for(t===0&&Z(e,`unknown escape sequence`);t-->0;)e.position++,Pu(e.input.charCodeAt(e.position))<0&&Z(e,`expected hexadecimal character`);e.position++}}else Q(a)?(i=!1,Ku(e,t)):e.position===e.lineStart&&Ru(e)?Z(e,`unexpected end of the document within a double quoted scalar`):a!==9&&a<32?Z(e,`expected valid JSON character`):e.position++}Z(e,`unexpected end of the stream within a double quoted scalar`)}function Yu(e,t,n){let r=e.input.charCodeAt(e.position),i=q.CLIP,a=-1,o=!1;if(r!==124&&r!==62)return!1;let s=r===124?K.LITERAL_BLOCK:K.FOLDED_BLOCK;for(e.position++;e.input.charCodeAt(e.position)!==0;){let n=e.input.charCodeAt(e.position),r=Nu(n);if(n===43||n===45)i!==q.CLIP&&Z(e,`repeat of a chomping mode identifier`),i=n===43?q.KEEP:q.STRIP,e.position++;else if(r>=0)r===0&&Z(e,`bad explicit indentation width of a block scalar; it cannot be less than one`),o&&Z(e,`repeat of an indentation width identifier`),a=t+r-1,o=!0,e.position++;else break}let c=!1;for(;ku(e.input.charCodeAt(e.position));)c=!0,e.position++;c&&e.input.charCodeAt(e.position)===35&&Vu(e),Q(e.input.charCodeAt(e.position))?Lu(e):e.input.charCodeAt(e.position)!==0&&Z(e,`a line break is expected`);let l=o?a:-1,u=0,d=e.position,f=e.position;for(;e.input.charCodeAt(e.position)!==0;){let n=e.position,r=0;for(;e.input.charCodeAt(n+r)===32;)r++;let i=e.input.charCodeAt(n+r);if(i===0){l>=0?r>l&&(f=n+r):r>0&&(f=n+r);break}if(Bu(e))break;if(!o&&l===-1&&Q(i)&&(u=Math.max(u,r)),!o&&l===-1&&!Q(i)&&(i===9&&r<t&&(e.position=n+r,Z(e,`tab characters must not be used in indentation`)),r<u&&(e.position=n+r,Z(e,`bad indentation of a mapping entry`))),l===-1&&i!==0&&!Q(i)&&r<t){e.lineIndent=r,e.position=n+r;break}!o&&i!==0&&!Q(i)&&l===-1&&(l=r);let a=l===-1?t+1:l;if(i!==0&&!Q(i)&&r<a){e.lineIndent=r,e.position=n+r;break}Vu(e),f=e.position,Q(e.input.charCodeAt(e.position))&&(Lu(e),f=e.position)}return Hu(e,d,f),Cu(e,d,f,n.anchorStart,n.anchorEnd,n.tagStart,n.tagEnd,s,i,l),!0}function Xu(e,t){let n=e.input.charCodeAt(e.position),r=t===ou;if(n===0||Au(n)||n===35||n===38||n===42||n===33||n===124||n===62||n===39||n===34||n===37||n===64||n===96||r&&Mu(n))return!1;if(n===63||n===45){let t=e.input.charCodeAt(e.position+1);if(ju(t)||r&&Mu(t))return!1}return!0}function Zu(e,t,n,r){if(!Xu(e,n))return!1;let i=e.position,a=e.position,o=e.input.charCodeAt(e.position),s=n===ou,c=!1;for(;o!==0&&!Bu(e);){if(o===58){let t=e.input.charCodeAt(e.position+1);if(ju(t)||s&&Mu(t))break}else if(o===35){if(Au(e.input.charCodeAt(e.position-1)))break}else if(s&&Mu(o))break;else if(Q(o)){let n=e.position,r=e.line,i=e.lineStart,a=e.lineIndent;if($(e,!1),e.lineIndent>=t){c=!0,o=e.input.charCodeAt(e.position);continue}e.position=n,e.line=r,e.lineStart=i,e.lineIndent=a;break}ku(o)||(a=e.position+1),o=e.input.charCodeAt(++e.position)}return a!==i&&(Hu(e,i,a),Cu(e,i,a,r.anchorStart,r.anchorEnd,r.tagStart,r.tagEnd,K.PLAIN,q.CLIP,-1,!c),!0)}function Qu(e,t){let n=e.line;$(e,!0),(e.line>n&&e.lineIndent<t||e.firstTabInLine!==-1&&e.lineIndent<t)&&Z(e,`deficient indentation`)}function $u(e,t,n){let r=e.input.charCodeAt(e.position),i=r===123,a=e.position,o=!0;if(r!==91&&r!==123)return!1;let s=i?125:93;for(i?xu(e,a,n.anchorStart,n.anchorEnd,n.tagStart,n.tagEnd,Dl.FLOW):bu(e,a,n.anchorStart,n.anchorEnd,n.tagStart,n.tagEnd,Dl.FLOW),e.position++;e.input.charCodeAt(e.position)!==0;){Qu(e,t);let n=e.input.charCodeAt(e.position);if(n===s)return e.position++,Tu(e),!0;o?n===44&&Z(e,`expected the node content, but found ','`):Z(e,`missed comma between flow collection entries`);let r=!1,a=!1;n===63&&Au(e.input.charCodeAt(e.position+1))&&(r=a=!0,e.position+=1,Qu(e,t));let c=e.line,l=Du(e),u=nd(e,t,ou,!1,!0);Qu(e,t),n=e.input.charCodeAt(e.position),(i||a||e.line===c)&&n===58?(r=!0,e.position++,Qu(e,t),i||Su(e,l),u||X(e),nd(e,t,ou,!1,!0)||X(e),Qu(e,t),i||Tu(e)):i&&r?(u||X(e),X(e)):i?X(e):r&&(Su(e,l),u||X(e),X(e),Tu(e)),n=e.input.charCodeAt(e.position),n===44?(o=!0,e.position++):o=!1}Z(e,`unexpected end of the stream within a flow collection`)}function ed(e,t,n){if(e.firstTabInLine!==-1||e.input.charCodeAt(e.position)!==45||!ju(e.input.charCodeAt(e.position+1)))return!1;for(bu(e,e.position,n.anchorStart,n.anchorEnd,n.tagStart,n.tagEnd,Dl.BLOCK);e.input.charCodeAt(e.position)===45&&ju(e.input.charCodeAt(e.position+1));){e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,Z(e,`tab characters must not be used in indentation`));let n=e.line;e.position++;let r=$(e,!0)>0;if(e.firstTabInLine!==-1&&e.input.charCodeAt(e.position)===45&&ju(e.input.charCodeAt(e.position+1))&&Z(e,`bad indentation of a sequence entry`),r&&e.lineIndent<=t?X(e):nd(e,t,cu,!1,!0),$(e,!0),e.lineIndent<t||e.position>=e.length)break;e.lineIndent>t&&Z(e,`bad indentation of a sequence entry`),e.line===n&&e.input.charCodeAt(e.position)===45&&ju(e.input.charCodeAt(e.position+1))&&Z(e,`bad indentation of a sequence entry`)}return Tu(e),!0}function td(e,t,n,r){let i=!1,a=!1,o=!1,s=!1;if(e.firstTabInLine!==-1)return!1;let c=e.input.charCodeAt(e.position);for(;c!==0;){!i&&e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,Z(e,`tab characters must not be used in indentation`));let l=e.input.charCodeAt(e.position+1),u=e.line;if((c===63||c===58)&&ju(l))o||=(xu(e,e.position,r.anchorStart,r.anchorEnd,r.tagStart,r.tagEnd,Dl.BLOCK),!0),c===63?(i&&X(e),a=!0,i=!0):i?i=!1:(X(e),a=!0,i=!1),e.position+=1,s=!0;else{i&&=(X(e),!1);let t=Du(e);if(!nd(e,n,su,!1,!0))break;if(e.line===u){for(c=e.input.charCodeAt(e.position);ku(c);)c=e.input.charCodeAt(++e.position);if(c===58){if(c=e.input.charCodeAt(++e.position),ju(c)||Z(e,`a whitespace character is expected after the key-value separator within a block mapping`),!o){for(Ou(e,t),xu(e,t.position,r.anchorStart,r.anchorEnd,r.tagStart,r.tagEnd,Dl.BLOCK),o=!0,nd(e,n,su,!1,!0),c=e.input.charCodeAt(e.position);ku(c);)c=e.input.charCodeAt(++e.position);e.position++}a=!0,i=!1,s=!1}else if(a)Z(e,`expected ':' after a mapping key`);else return r.anchorStart!==Y||r.tagStart!==Y?(Ou(e,t),!1):!0}else if(a)Z(e,`can not read a block mapping entry; a multiline key may not be an implicit key`);else return r.anchorStart!==Y||r.tagStart!==Y?(Ou(e,t),!1):!0}if(nd(e,t,lu,!0,s)&&(s=!1),i||(s&&=(X(e),!1)),$(e,!0),c=e.input.charCodeAt(e.position),(e.line===u||e.lineIndent>t)&&c!==0)Z(e,`bad indentation of a mapping entry`);else if(e.lineIndent<t)break}return a?(i&&X(e),o&&Tu(e),!0):!1}function nd(e,t,n,r,i,a=!0){e.depth>=e.maxDepth&&Z(e,`nesting exceeded maxDepth (${e.maxDepth})`),e.depth++;let o=1,s=!1,c=!1,l=null,u=Eu(),d=n===lu||n===cu,f=d,p=d;if(r&&$(e,!0)&&(s=!0,o=e.lineIndent>t?1:e.lineIndent===t?0:-1),o===1)for(;;){let r=e.input.charCodeAt(e.position),i=Du(e);if(s&&o!==1&&(r===33||r===38))break;if(s&&p&&(u.tagStart!==Y||u.anchorStart!==Y)&&(r===33||r===38)){let n=Du(e),r=t+1;if(td(e,e.position-e.lineStart,r,u)&&e.events[n.eventsLength]?.type===G.MAPPING)return e.depth--,!0;Ou(e,n)}if(s&&(r===33&&u.tagStart!==Y||r===38&&u.anchorStart!==Y)||!Uu(e,u,n===ou)&&!Wu(e,u))break;l===null&&(l=i),$(e,!0)?(s=!0,f=p,o=e.lineIndent>t?1:e.lineIndent===t?0:-1):f=!1}if(f&&=s||i,o===1||n===lu){let r=n===ou||n===su?t:t+1,i=e.position-e.lineStart;if(o===1){if(f&&(ed(e,i,u)||td(e,i,r,u))||$u(e,r,u))c=!0;else{let t=e.input.charCodeAt(e.position);if(l!==null&&a&&p&&!f&&t!==124&&t!==62){let t=Du(e),n=l.position-l.lineStart;Ou(e,l),td(e,n,r,Eu())&&e.events[t.eventsLength]?.type===G.MAPPING?c=!0:Ou(e,t)}!c&&(d&&Yu(e,r,u)||qu(e,r,u)||Ju(e,r,u)||Gu(e,u)||Zu(e,r,n,u))&&(c=!0)}}else o===0&&(c=f&&ed(e,i,u))}return d&&=!c,!c&&(u.anchorStart!==Y||u.tagStart!==Y||d)&&(Cu(e,Y,Y,u.anchorStart,u.anchorEnd,u.tagStart,u.tagEnd,K.PLAIN),c=!0),e.depth--,c||u.anchorStart!==Y||u.tagStart!==Y}function rd(e){if(e.lineIndent>0||e.input.charCodeAt(e.position)!==37)return!1;e.position++;let t=e.position;for(;e.input.charCodeAt(e.position)!==0&&!Au(e.input.charCodeAt(e.position));)e.position++;let n=e.input.slice(t,e.position),r=[];for(n.length===0&&Z(e,`directive name must not be less than one character in length`);e.input.charCodeAt(e.position)!==0&&!Q(e.input.charCodeAt(e.position));){for(;ku(e.input.charCodeAt(e.position));)e.position++;if(e.input.charCodeAt(e.position)===35||Q(e.input.charCodeAt(e.position))||e.input.charCodeAt(e.position)===0)break;let t=e.position;for(;e.input.charCodeAt(e.position)!==0&&!Au(e.input.charCodeAt(e.position));)e.position++;r.push(e.input.slice(t,e.position))}if(Q(e.input.charCodeAt(e.position))&&Lu(e),n===`YAML`){e.directives.some(e=>e.kind===`yaml`)&&Z(e,`duplication of %YAML directive`),r.length!==1&&Z(e,`YAML directive accepts exactly one argument`);let t=/^([0-9]+)\.([0-9]+)$/.exec(r[0]);t===null&&Z(e,`ill-formed argument of the YAML directive`),parseInt(t[1],10)!==1&&Z(e,`unacceptable YAML version of the document`),e.directives.push({kind:`yaml`,version:r[0]})}else if(n===`TAG`){r.length!==2&&Z(e,`TAG directive accepts exactly two arguments`);let[t,n]=r;fu.test(t)||Z(e,`ill-formed tag handle (first argument) of the TAG directive`),au.call(e.tagHandlers,t)&&Z(e,`there is a previously declared suffix for "${t}" tag handle`),_u.test(n)||Z(e,`ill-formed tag prefix (second argument) of the TAG directive`),e.tagHandlers[t]=n,e.directives.push({kind:`tag`,handle:t,prefix:n})}return!0}function id(e){e.directives=[],e.tagHandlers=Object.create(null);let t=!1;for($(e,!0);rd(e);)t=!0,$(e,!0);let n=!1,r=!1,i=!0;if(e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45&&ju(e.input.charCodeAt(e.position+3))){n=!0;let t=e.line;e.position+=3,$(e,!0),i=e.line>t}else t&&Z(e,`directives end mark is expected`);let a=e.events.length;if(!n&&e.position===e.lineStart&&e.input.charCodeAt(e.position)===46&&Ru(e)){e.position+=3,$(e,!0);return}if(yu(e,n,!1),nd(e,e.lineIndent-1,lu,!1,i,i)||X(e),$(e,!0),e.position===e.lineStart&&Ru(e)&&(r=e.input.charCodeAt(e.position)===46,r)){let t=e.line;e.position+=3,$(e,!0),e.line===t&&e.position<e.length&&Z(e,`end of the stream or a document separator is expected`)}let o=e.events[a];o?.type===G.DOCUMENT&&(o.explicitEnd=r),Tu(e),!r&&e.position<e.length&&!Bu(e)&&Z(e,`end of the stream or a document separator is expected`)}function ad(e,t){let n=e.length,r={...vu,...t,input:`${e}\0`,length:n,position:0,line:0,lineStart:0,lineIndent:0,firstTabInLine:-1,depth:0,directives:[],tagHandlers:Object.create(null),events:[]},i=e.indexOf(`\0`);for(i!==-1&&El.throwAt(e,i,`null byte is not allowed in input`,r.filename);r.position<r.length&&(zu(r),$(r,!0),!(r.position>=r.length));){let e=r.position;id(r),r.position===e&&Z(r,`can not read a document`)}return r.events}var od={...vu,...Kl};function sd(e,t={}){let n={...od,...t},r=String(e),i=Object.keys(vu),a=Object.keys(Kl);return iu(ad(r,ll(n,i)),{...ll(n,a),source:r})}function cd(e,t){let n=sd(e,t);if(n.length===0)throw new El(`expected a document, but the input is empty`);if(n.length===1)return n[0];throw new El(`expected a single document in the stream, but found more`)}function ld(e,t){return!!(e&1<<t)}var ud={applyQuoteFlowKeysOption:fd,doubleQuoteForInvisibles:pd,doubleQuoteWhitespaceOnly:md,applyForceQuotesOption:hd,tryLongOrMultilineAsBlock:gd,quoteInvalidPlain:_d,fallbackToDoubleQuoted:vd};function dd(e){return e.presenterOptions.quoteStyle===`single`&&ld(e.allowedStylesMask,K.SINGLE_QUOTED)?K.SINGLE_QUOTED:K.DOUBLE_QUOTED}function fd(e){e.presenterOptions.quoteFlowKeys&&e.isKey&&e.flowOnly&&e.style===K.PLAIN&&(e.style=K.DOUBLE_QUOTED)}function pd(e){e.style===K.PLAIN&&/[\t\x7F-\xA0\u2028\u2029\uFEFF\uFFFE\uFFFF]/.test(e.node.value)&&(e.style=K.DOUBLE_QUOTED)}function md(e){e.style===K.PLAIN&&/^\s+$/.test(e.node.value)&&(e.style=K.DOUBLE_QUOTED)}function hd(e){e.presenterOptions.forceQuotes&&(e.isKey||e.style!==K.PLAIN||e.node.tag===e.presenterOptions.schema.defaultScalarTag.tagName&&(e.style=e.node.value.includes(`
`)?K.DOUBLE_QUOTED:dd(e)))}function gd(e){if(e.style!==K.PLAIN||e.isKey)return;let t=e.node.value,n=t.indexOf(`
`)!==-1;if(!ld(e.allowedStylesMask,K.LITERAL_BLOCK)){n&&(e.style=K.DOUBLE_QUOTED);return}let r=e.presenterOptions.lineWidth;if(r===-1){n&&(e.style=K.LITERAL_BLOCK);return}let i=Math.max(Math.min(r,40),r-e.shiftOfContent),a=0,o=!1;for(;a<=t.length;){let e=t.length,n=t.indexOf(`
`,a);n!==-1&&(e=n);let r=t.slice(a,e);if(r.length>i&&r[0]!==` `&&/ [^ \t]/.test(r)&&(o=!0),n===-1)break;a=n+1}o?e.style=K.FOLDED_BLOCK:n&&(e.style=K.LITERAL_BLOCK)}function _d(e){e.style===K.PLAIN&&!ld(e.allowedStylesMask,K.PLAIN)&&(e.style=dd(e))}function vd(e){ld(e.allowedStylesMask,e.style)||(e.style=K.DOUBLE_QUOTED)}var yd=`[\\x09\\x0A\\x0D\\x20-\\x7E\\x85\\xA0-\\uD7FF\\uE000-\\uFFFD\\u{10000}-\\u{10FFFF}]`,bd=`[\\n\\r]`,xd=`\\uFEFF`,Sd=`[ \\t]`,Cd=`(?:(?!(?:${bd}|${xd}))${yd})`,wd=`(?:(?!${Sd})${Cd})`,Td=`[\\x09\\x20-\\uD7FF\\uE000-\\uFFFF\\u{10000}-\\u{10FFFF}]`,Ed=`[-?:,\\[\\]{}#&*!|>'"%@\`]`,Dd=`[,\\[\\]{}]`,Od=wd,kd=`(?:(?!${Dd})${wd})`,Ad=`(?:(?:(?!${Ed})${wd})|[?:-](?=${Od}))`,jd=`(?:(?:(?!${Ed})${wd})|[?:-](?=${kd}))`,Md=`(?:(?:(?![:#])${Od})|:(?=${Od}))#*`,Nd=`(?:(?:(?![:#])${kd})|:(?=${kd}))#*`,Pd=`(?:${Sd}*${Md})*`,Fd=`(?:${Sd}*${Nd})*`,Id=`${Ad}#*${Pd}`,Ld=`${jd}#*${Fd}`,Rd=Id,zd=Ld,Bd=`\\n+${Md}${Pd}`,Vd=`\\n+${Nd}${Fd}`,Hd=`${Id}(?:${Bd})*`,Ud=`${Ld}(?:${Vd})*`;RegExp(`^(?:${Hd})$`,`u`),RegExp(`^(?:${Ud})$`,`u`),RegExp(`^(?:${Rd})$`,`u`),RegExp(`^(?:${zd})$`,`u`),RegExp(`^(?:${Td})*$`,`u`),RegExp(`^(?:${Td}|\\n)*$`,`u`),RegExp(`^(?:${Cd}|\\n)*$`,`u`),Object.keys(ud).map(e=>Reflect.get(ud,e)),G.DOCUMENT,G.SEQUENCE,G.MAPPING,G.SCALAR,G.ALIAS,G.POP,K.PLAIN,K.SINGLE_QUOTED,K.DOUBLE_QUOTED,K.LITERAL_BLOCK,K.FOLDED_BLOCK,Dl.BLOCK,Dl.FLOW,q.CLIP,q.STRIP,q.KEEP;var Wd=Object.assign({"/docs/openapi/asserted_distribution.yaml":Ts,"/docs/openapi/biological_association.yaml":Es,"/docs/openapi/biological_associations_graph.yaml":Ds,"/docs/openapi/biological_relationship.yaml":Os,"/docs/openapi/cached_map.yaml":ks,"/docs/openapi/citation.yaml":As,"/docs/openapi/collecting_event.yaml":js,"/docs/openapi/collection_object.yaml":Ms,"/docs/openapi/common_name.yaml":Ns,"/docs/openapi/content.yaml":Ps,"/docs/openapi/controlled_vocabulary_term.yaml":Fs,"/docs/openapi/conveyance.yaml":Is,"/docs/openapi/data_attribute.yaml":Ls,"/docs/openapi/depiction.yaml":Rs,"/docs/openapi/download.yaml":zs,"/docs/openapi/dwc_occurrence.yaml":Bs,"/docs/openapi/field_occurrence.yaml":Vs,"/docs/openapi/identifier.yaml":Hs,"/docs/openapi/image.yaml":Us,"/docs/openapi/lead.yaml":Ws,"/docs/openapi/news.yaml":Gs,"/docs/openapi/note.yaml":Ks,"/docs/openapi/observation.yaml":qs,"/docs/openapi/observation_matrix.yaml":Js,"/docs/openapi/otu.yaml":Ys,"/docs/openapi/person.yaml":Xs,"/docs/openapi/sound.yaml":Zs,"/docs/openapi/source.yaml":Qs,"/docs/openapi/tag.yaml":$s,"/docs/openapi/taxon_determination.yaml":ec,"/docs/openapi/taxon_name.yaml":tc,"/docs/openapi/taxon_name_classification.yaml":nc,"/docs/openapi/taxon_name_relationship.yaml":rc,"/docs/openapi/utility.yaml":ic}),Gd=new Map;function Kd(e){return e.replace(/_/g,` `).replace(/\bdwc\b/gi,`DWC`).replace(/\b\w/g,e=>e.toUpperCase())}var qd=Object.keys(Wd).map(e=>{let t=e.split(`/`).pop(),n=t.replace(`.yaml`,``);return{id:n,filename:t,label:Kd(n)}}).sort((e,t)=>e.label.localeCompare(t.label));function Jd(){let e=M(null),t=M(null);function n(n){t.value=null;let r=`/docs/openapi/${n}`;if(Gd.has(r)){e.value=Gd.get(r);return}let i=Wd[r];if(!i){t.value=`Spec file not found: ${n}`,e.value=null;return}try{let t=cd(i);t.externalDocs||={description:`Data Model Documentation`,url:`https://docs.taxonworks.org/develop/Data/models.html#${n.replace(`.yaml`,``).replaceAll(`_`,`-`)}`},Gd.set(r,t),e.value=t}catch(r){t.value=`Failed to parse ${n}: ${r.message}`,e.value=null}}return{spec:e,error:t,loadSpec:n,resources:qd}}var Yd={class:`app-body`},Xd={key:0,class:`markdown-page`};Lo(Bo({__name:`App`,setup(e){let{spec:t,error:n,resources:r,loadSpec:i}=Jd();function a(){let e=new URLSearchParams(window.location.search).get(`resource`);return e===`overview`?`overview`:e&&r.find(t=>t.id===e)?e:`overview`}let o=M(a());return Hn(o,e=>{let a=new URL(window.location);if(e===`overview`){t.value=null,n.value=null,a.searchParams.delete(`resource`),window.history.replaceState({},``,a);return}let o=r.find(t=>t.id===e);o&&(i(o.filename),a.searchParams.set(`resource`,e),window.history.replaceState({},``,a))}),wr(()=>{let e=r.find(e=>e.id===o.value);e&&i(e.filename)}),(e,i)=>(R(),z(I,null,[V(Qo),B(`div`,Yd,[V(is,{modelValue:o.value,"onUpdate:modelValue":i[0]||=e=>o.value=e,resources:Qt(r)},null,8,[`modelValue`,`resources`]),o.value===`overview`?(R(),z(`div`,Xd,[V(Qt(ws))])):(R(),na(Ss,{key:1,spec:Qt(t),error:Qt(n)},null,8,[`spec`,`error`]))])],64))}},[[`__scopeId`,`data-v-dcb031e9`]])).mount(`#app`);